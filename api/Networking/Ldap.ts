...
export const LDAP_CONTROL_REFERRALS_W = `1.2.840.113556.1.4.616`;
export const LDAP_CONTROL_REFERRALS = `1.2.840.113556.1.4.616`;
...
export const LDAP_VENDOR_NAME = `Microsoft Corporation.`;
export const LDAP_VENDOR_NAME_W = `Microsoft Corporation.`;
export const LDAP_VENDOR_VERSION = 510;
export const LDAP_FEATURE_INFO_VERSION = 1;
export const LDAP_SERVER_SORT_OID = `1.2.840.113556.1.4.473`;
export const LDAP_SERVER_SORT_OID_W = `1.2.840.113556.1.4.473`;
export const LDAP_SERVER_RESP_SORT_OID = `1.2.840.113556.1.4.474`;
export const LDAP_SERVER_RESP_SORT_OID_W = `1.2.840.113556.1.4.474`;
export const LDAP_PAGED_RESULT_OID_STRING = `1.2.840.113556.1.4.319`;
export const LDAP_PAGED_RESULT_OID_STRING_W = `1.2.840.113556.1.4.319`;
export const LDAP_CONTROL_VLVREQUEST = `2.16.840.1.113730.3.4.9`;
export const LDAP_CONTROL_VLVREQUEST_W = `2.16.840.1.113730.3.4.9`;
export const LDAP_CONTROL_VLVRESPONSE = `2.16.840.1.113730.3.4.10`;
export const LDAP_CONTROL_VLVRESPONSE_W = `2.16.840.1.113730.3.4.10`;
export const LDAP_API_FEATURE_VIRTUAL_LIST_VIEW = 1001;
export const LDAP_VLVINFO_VERSION = 1;
export const LDAP_START_TLS_OID = `1.3.6.1.4.1.1466.20037`;
export const LDAP_START_TLS_OID_W = `1.3.6.1.4.1.1466.20037`;
export const LDAP_TTL_EXTENDED_OP_OID = `1.3.6.1.4.1.1466.101.119.1`;
export const LDAP_TTL_EXTENDED_OP_OID_W = `1.3.6.1.4.1.1466.101.119.1`;
...
export const LDAP_SERVER_FORCE_UPDATE_OID = `1.2.840.113556.1.4.1974`;
export const LDAP_SERVER_FORCE_UPDATE_OID_W = `1.2.840.113556.1.4.1974`;
export const LDAP_SERVER_PERMISSIVE_MODIFY_OID = `1.2.840.113556.1.4.1413`;
export const LDAP_SERVER_PERMISSIVE_MODIFY_OID_W = `1.2.840.113556.1.4.1413`;
export const LDAP_SERVER_SHOW_DELETED_OID = `1.2.840.113556.1.4.417`;
export const LDAP_SERVER_SHOW_DELETED_OID_W = `1.2.840.113556.1.4.417`;
export const LDAP_SERVER_SHOW_RECYCLED_OID = `1.2.840.113556.1.4.2064`;
export const LDAP_SERVER_SHOW_RECYCLED_OID_W = `1.2.840.113556.1.4.2064`;
export const LDAP_SERVER_EXPECTED_ENTRY_COUNT_OID = `1.2.840.113556.1.4.2211`;
export const LDAP_SERVER_EXPECTED_ENTRY_COUNT_OID_W = `1.2.840.113556.1.4.2211`;
export const LDAP_SERVER_SEARCH_HINTS_OID = `1.2.840.113556.1.4.2206`;
export const LDAP_SERVER_SEARCH_HINTS_OID_W = `1.2.840.113556.1.4.2206`;
export const LDAP_SEARCH_HINT_INDEX_ONLY_OID = `1.2.840.113556.1.4.2207`;
export const LDAP_SEARCH_HINT_INDEX_ONLY_OID_W = `1.2.840.113556.1.4.2207`;
export const LDAP_SEARCH_HINT_SOFT_SIZE_LIMIT_OID = `1.2.840.113556.1.4.2210`;
export const LDAP_SEARCH_HINT_SOFT_SIZE_LIMIT_OID_W = `1.2.840.113556.1.4.2210`;
export const LDAP_SEARCH_HINT_REQUIRED_INDEX_OID = `1.2.840.113556.1.4.2306`;
export const LDAP_SEARCH_HINT_REQUIRED_INDEX_OID_W = `1.2.840.113556.1.4.2306`;
export const LDAP_SERVER_UPDATE_STATS_OID = `1.2.840.113556.1.4.2205`;
export const LDAP_SERVER_UPDATE_STATS_OID_W = `1.2.840.113556.1.4.2205`;
export const LDAP_UPDATE_STATS_USN_OID = `1.2.840.113556.1.4.2208`;
export const LDAP_UPDATE_STATS_USN_OID_W = `1.2.840.113556.1.4.2208`;
export const LDAP_UPDATE_STATS_INVOCATIONID_OID = `1.2.840.113556.1.4.2209`;
export const LDAP_UPDATE_STATS_INVOCATIONID_OID_W = `1.2.840.113556.1.4.2209`;
export const LDAP_SERVER_GET_STATS_OID = `1.2.840.113556.1.4.970`;
export const LDAP_SERVER_GET_STATS_OID_W = `1.2.840.113556.1.4.970`;
export const LDAP_SERVER_SHOW_DEACTIVATED_LINK_OID = `1.2.840.113556.1.4.2065`;
export const LDAP_SERVER_SHOW_DEACTIVATED_LINK_OID_W = `1.2.840.113556.1.4.2065`;
export const LDAP_SERVER_POLICY_HINTS_DEPRECATED_OID = `1.2.840.113556.1.4.2066`;
export const LDAP_SERVER_POLICY_HINTS_DEPRECATED_OID_W = `1.2.840.113556.1.4.2066`;
export const LDAP_SERVER_POLICY_HINTS_OID = `1.2.840.113556.1.4.2239`;
export const LDAP_SERVER_POLICY_HINTS_OID_W = `1.2.840.113556.1.4.2239`;
export const LDAP_SERVER_RANGE_OPTION_OID = `1.2.840.113556.1.4.802`;
export const LDAP_SERVER_RANGE_OPTION_OID_W = `1.2.840.113556.1.4.802`;
export const LDAP_SERVER_CROSSDOM_MOVE_TARGET_OID = `1.2.840.113556.1.4.521`;
export const LDAP_SERVER_CROSSDOM_MOVE_TARGET_OID_W = `1.2.840.113556.1.4.521`;
export const LDAP_SERVER_NOTIFICATION_OID = `1.2.840.113556.1.4.528`;
export const LDAP_SERVER_NOTIFICATION_OID_W = `1.2.840.113556.1.4.528`;
export const LDAP_SERVER_SHUTDOWN_NOTIFY_OID = `1.2.840.113556.1.4.1907`;
export const LDAP_SERVER_SHUTDOWN_NOTIFY_OID_W = `1.2.840.113556.1.4.1907`;
export const LDAP_SERVER_LAZY_COMMIT_OID = `1.2.840.113556.1.4.619`;
export const LDAP_SERVER_LAZY_COMMIT_OID_W = `1.2.840.113556.1.4.619`;
export const LDAP_SERVER_SD_FLAGS_OID = `1.2.840.113556.1.4.801`;
export const LDAP_SERVER_SD_FLAGS_OID_W = `1.2.840.113556.1.4.801`;
export const LDAP_SERVER_TREE_DELETE_EX_OID = `1.2.840.113556.1.4.2204`;
export const LDAP_SERVER_TREE_DELETE_EX_OID_W = `1.2.840.113556.1.4.2204`;
export const LDAP_SERVER_TREE_DELETE_OID = `1.2.840.113556.1.4.805`;
export const LDAP_SERVER_TREE_DELETE_OID_W = `1.2.840.113556.1.4.805`;
export const LDAP_SERVER_ASQ_OID = `1.2.840.113556.1.4.1504`;
export const LDAP_SERVER_ASQ_OID_W = `1.2.840.113556.1.4.1504`;
export const LDAP_SERVER_DIRSYNC_OID = `1.2.840.113556.1.4.841`;
export const LDAP_SERVER_DIRSYNC_OID_W = `1.2.840.113556.1.4.841`;
export const LDAP_SERVER_DIRSYNC_EX_OID = `1.2.840.113556.1.4.2090`;
export const LDAP_SERVER_DIRSYNC_EX_OID_W = `1.2.840.113556.1.4.2090`;
export const LDAP_SERVER_EXTENDED_DN_OID = `1.2.840.113556.1.4.529`;
export const LDAP_SERVER_EXTENDED_DN_OID_W = `1.2.840.113556.1.4.529`;
export const LDAP_SERVER_VERIFY_NAME_OID = `1.2.840.113556.1.4.1338`;
export const LDAP_SERVER_VERIFY_NAME_OID_W = `1.2.840.113556.1.4.1338`;
export const LDAP_SERVER_DOMAIN_SCOPE_OID = `1.2.840.113556.1.4.1339`;
export const LDAP_SERVER_DOMAIN_SCOPE_OID_W = `1.2.840.113556.1.4.1339`;
export const LDAP_SERVER_SEARCH_OPTIONS_OID = `1.2.840.113556.1.4.1340`;
export const LDAP_SERVER_SEARCH_OPTIONS_OID_W = `1.2.840.113556.1.4.1340`;
export const SERVER_SEARCH_FLAG_DOMAIN_SCOPE = 1;
export const SERVER_SEARCH_FLAG_PHANTOM_ROOT = 2;
export const LDAP_SERVER_QUOTA_CONTROL_OID = `1.2.840.113556.1.4.1852`;
export const LDAP_SERVER_QUOTA_CONTROL_OID_W = `1.2.840.113556.1.4.1852`;
export const LDAP_SERVER_RANGE_RETRIEVAL_NOERR_OID = `1.2.840.113556.1.4.1948`;
export const LDAP_SERVER_RANGE_RETRIEVAL_NOERR_OID_W = `1.2.840.113556.1.4.1948`;
export const LDAP_SERVER_DN_INPUT_OID = `1.2.840.113556.1.4.2026`;
export const LDAP_SERVER_DN_INPUT_OID_W = `1.2.840.113556.1.4.2026`;
export const LDAP_SERVER_SET_OWNER_OID = `1.2.840.113556.1.4.2255`;
export const LDAP_SERVER_SET_OWNER_OID_W = `1.2.840.113556.1.4.2255`;
export const LDAP_SERVER_BYPASS_QUOTA_OID = `1.2.840.113556.1.4.2256`;
export const LDAP_SERVER_BYPASS_QUOTA_OID_W = `1.2.840.113556.1.4.2256`;
export const LDAP_SERVER_LINK_TTL_OID = `1.2.840.113556.1.4.2309`;
export const LDAP_SERVER_LINK_TTL_OID_W = `1.2.840.113556.1.4.2309`;
export const LDAP_OPATT_BECOME_DOM_MASTER = `becomeDomainMaster`;
export const LDAP_OPATT_BECOME_DOM_MASTER_W = `becomeDomainMaster`;
export const LDAP_OPATT_BECOME_RID_MASTER = `becomeRidMaster`;
export const LDAP_OPATT_BECOME_RID_MASTER_W = `becomeRidMaster`;
export const LDAP_OPATT_BECOME_SCHEMA_MASTER = `becomeSchemaMaster`;
export const LDAP_OPATT_BECOME_SCHEMA_MASTER_W = `becomeSchemaMaster`;
export const LDAP_OPATT_RECALC_HIERARCHY = `recalcHierarchy`;
export const LDAP_OPATT_RECALC_HIERARCHY_W = `recalcHierarchy`;
export const LDAP_OPATT_SCHEMA_UPDATE_NOW = `schemaUpdateNow`;
export const LDAP_OPATT_SCHEMA_UPDATE_NOW_W = `schemaUpdateNow`;
export const LDAP_OPATT_BECOME_PDC = `becomePdc`;
export const LDAP_OPATT_BECOME_PDC_W = `becomePdc`;
export const LDAP_OPATT_FIXUP_INHERITANCE = `fixupInheritance`;
export const LDAP_OPATT_FIXUP_INHERITANCE_W = `fixupInheritance`;
export const LDAP_OPATT_INVALIDATE_RID_POOL = `invalidateRidPool`;
export const LDAP_OPATT_INVALIDATE_RID_POOL_W = `invalidateRidPool`;
export const LDAP_OPATT_ABANDON_REPL = `abandonReplication`;
export const LDAP_OPATT_ABANDON_REPL_W = `abandonReplication`;
export const LDAP_OPATT_DO_GARBAGE_COLLECTION = `doGarbageCollection`;
export const LDAP_OPATT_DO_GARBAGE_COLLECTION_W = `doGarbageCollection`;
export const LDAP_OPATT_SUBSCHEMA_SUBENTRY = `subschemaSubentry`;
export const LDAP_OPATT_SUBSCHEMA_SUBENTRY_W = `subschemaSubentry`;
export const LDAP_OPATT_CURRENT_TIME = `currentTime`;
export const LDAP_OPATT_CURRENT_TIME_W = `currentTime`;
export const LDAP_OPATT_SERVER_NAME = `serverName`;
export const LDAP_OPATT_SERVER_NAME_W = `serverName`;
export const LDAP_OPATT_NAMING_CONTEXTS = `namingContexts`;
export const LDAP_OPATT_NAMING_CONTEXTS_W = `namingContexts`;
export const LDAP_OPATT_DEFAULT_NAMING_CONTEXT = `defaultNamingContext`;
export const LDAP_OPATT_DEFAULT_NAMING_CONTEXT_W = `defaultNamingContext`;
export const LDAP_OPATT_SUPPORTED_CONTROL = `supportedControl`;
export const LDAP_OPATT_SUPPORTED_CONTROL_W = `supportedControl`;
export const LDAP_OPATT_HIGHEST_COMMITTED_USN = `highestCommitedUSN`;
export const LDAP_OPATT_HIGHEST_COMMITTED_USN_W = `highestCommitedUSN`;
export const LDAP_OPATT_SUPPORTED_LDAP_VERSION = `supportedLDAPVersion`;
export const LDAP_OPATT_SUPPORTED_LDAP_VERSION_W = `supportedLDAPVersion`;
export const LDAP_OPATT_SUPPORTED_LDAP_POLICIES = `supportedLDAPPolicies`;
export const LDAP_OPATT_SUPPORTED_LDAP_POLICIES_W = `supportedLDAPPolicies`;
export const LDAP_OPATT_SCHEMA_NAMING_CONTEXT = `schemaNamingContext`;
export const LDAP_OPATT_SCHEMA_NAMING_CONTEXT_W = `schemaNamingContext`;
export const LDAP_OPATT_CONFIG_NAMING_CONTEXT = `configurationNamingContext`;
export const LDAP_OPATT_CONFIG_NAMING_CONTEXT_W = `configurationNamingContext`;
export const LDAP_OPATT_ROOT_DOMAIN_NAMING_CONTEXT = `rootDomainNamingContext`;
export const LDAP_OPATT_ROOT_DOMAIN_NAMING_CONTEXT_W = `rootDomainNamingContext`;
export const LDAP_OPATT_SUPPORTED_SASL_MECHANISM = `supportedSASLMechanisms`;
export const LDAP_OPATT_SUPPORTED_SASL_MECHANISM_W = `supportedSASLMechanisms`;
export const LDAP_OPATT_DNS_HOST_NAME = `dnsHostName`;
export const LDAP_OPATT_DNS_HOST_NAME_W = `dnsHostName`;
export const LDAP_OPATT_LDAP_SERVICE_NAME = `ldapServiceName`;
export const LDAP_OPATT_LDAP_SERVICE_NAME_W = `ldapServiceName`;
export const LDAP_OPATT_DS_SERVICE_NAME = `dsServiceName`;
export const LDAP_OPATT_DS_SERVICE_NAME_W = `dsServiceName`;
export const LDAP_OPATT_SUPPORTED_CAPABILITIES = `supportedCapabilities`;
export const LDAP_OPATT_SUPPORTED_CAPABILITIES_W = `supportedCapabilities`;
export const LDAP_CAP_ACTIVE_DIRECTORY_OID = `1.2.840.113556.1.4.800`;
export const LDAP_CAP_ACTIVE_DIRECTORY_OID_W = `1.2.840.113556.1.4.800`;
export const LDAP_CAP_ACTIVE_DIRECTORY_V51_OID = `1.2.840.113556.1.4.1670`;
export const LDAP_CAP_ACTIVE_DIRECTORY_V51_OID_W = `1.2.840.113556.1.4.1670`;
export const LDAP_CAP_ACTIVE_DIRECTORY_LDAP_INTEG_OID = `1.2.840.113556.1.4.1791`;
export const LDAP_CAP_ACTIVE_DIRECTORY_LDAP_INTEG_OID_W = `1.2.840.113556.1.4.1791`;
export const LDAP_CAP_ACTIVE_DIRECTORY_ADAM_OID = `1.2.840.113556.1.4.1851`;
export const LDAP_CAP_ACTIVE_DIRECTORY_ADAM_OID_W = `1.2.840.113556.1.4.1851`;
export const LDAP_CAP_ACTIVE_DIRECTORY_PARTIAL_SECRETS_OID = `1.2.840.113556.1.4.1920`;
export const LDAP_CAP_ACTIVE_DIRECTORY_PARTIAL_SECRETS_OID_W = `1.2.840.113556.1.4.1920`;
export const LDAP_CAP_ACTIVE_DIRECTORY_V60_OID = `1.2.840.113556.1.4.1935`;
export const LDAP_CAP_ACTIVE_DIRECTORY_V60_OID_W = `1.2.840.113556.1.4.1935`;
export const LDAP_CAP_ACTIVE_DIRECTORY_V61_OID = `1.2.840.113556.1.4.1935`;
export const LDAP_CAP_ACTIVE_DIRECTORY_V61_OID_W = `1.2.840.113556.1.4.1935`;
export const LDAP_CAP_ACTIVE_DIRECTORY_V61_R2_OID = `1.2.840.113556.1.4.2080`;
export const LDAP_CAP_ACTIVE_DIRECTORY_V61_R2_OID_W = `1.2.840.113556.1.4.2080`;
export const LDAP_CAP_ACTIVE_DIRECTORY_W8_OID = `1.2.840.113556.1.4.2237`;
export const LDAP_CAP_ACTIVE_DIRECTORY_W8_OID_W = `1.2.840.113556.1.4.2237`;
export const LDAP_MATCHING_RULE_BIT_AND = `1.2.840.113556.1.4.803`;
export const LDAP_MATCHING_RULE_BIT_AND_W = `1.2.840.113556.1.4.803`;
export const LDAP_MATCHING_RULE_BIT_OR = `1.2.840.113556.1.4.804`;
export const LDAP_MATCHING_RULE_BIT_OR_W = `1.2.840.113556.1.4.804`;
export const LDAP_MATCHING_RULE_TRANSITIVE_EVALUATION = `1.2.840.113556.1.4.1941`;
export const LDAP_MATCHING_RULE_TRANSITIVE_EVALUATION_W = `1.2.840.113556.1.4.1941`;
export const LDAP_MATCHING_RULE_DN_BINARY_COMPLEX = `1.2.840.113556.1.4.2253`;
export const LDAP_MATCHING_RULE_DN_BINARY_COMPLEX_W = `1.2.840.113556.1.4.2253`;
export const LDAP_SERVER_FAST_BIND_OID = `1.2.840.113556.1.4.1781`;
export const LDAP_SERVER_FAST_BIND_OID_W = `1.2.840.113556.1.4.1781`;
export const LDAP_SERVER_WHO_AM_I_OID = `1.3.6.1.4.1.4203.1.11.3`;
export const LDAP_SERVER_WHO_AM_I_OID_W = `1.3.6.1.4.1.4203.1.11.3`;
export const LDAP_SERVER_BATCH_REQUEST_OID = `1.2.840.113556.1.4.2212`;
export const LDAP_SERVER_BATCH_REQUEST_OID_W = `1.2.840.113556.1.4.2212`;
...
export interface LDAP {
  /** _ld_sb_e__Struct */
  ld_sb: Uint8Array | Deno.PointerValue;
  /** Windows.Win32.Foundation.PSTR */
  ld_host: string | null | Uint8Array;
  /** u32 */
  ld_version: number;
  /** u8 */
  ...
  ld_errno: number;
  /** Windows.Win32.Foundation.PSTR */
  ld_matched: string | null | Uint8Array;
  /** Windows.Win32.Foundation.PSTR */
  ld_error: string | null | Uint8Array;
  /** u32 */
  ld_msgid: number;
  /** array */
...
export function allocLDAP(data?: Partial<LDAP>): Uint8Array {
  ...
  const view = new DataView(buf.buffer);
  // 0x00: pointer
  if (data?.ld_sb !== undefined) view.setBigUint64(0, data.ld_sb === null ? 0n : BigInt(Deno.UnsafePointer.value(util.toPointer(data.ld_sb))), true);
  // 0x08: buffer
  ...
  // 0x3c: pad4
  // 0x40: pointer
  if (data?.Reserved3 !== undefined) view.setBigUint64(64, data.Reserved3 === null ? 0n : BigInt(Deno.UnsafePointer.value(util.toPointer(data.Reserved3))), true);
  // 0x48: u32
...
export class LDAPView {
  ...
  // 0x00: pointer
  get ld_sb(): Uint8Array | Deno.PointerValue {
    const ptr = this.view.getBigUint64(0, true);
    return Deno.UnsafePointer.create(ptr);
  }

  // 0x08: buffer
  get ld_host(): Uint8Array | Deno.PointerValue {
    const ptr = this.view.getBigUint64(8, true);
    return Deno.UnsafePointer.create(ptr);
  }
  ...
  // 0x28: buffer
  get ld_matched(): Uint8Array | Deno.PointerValue {
    const ptr = this.view.getBigUint64(40, true);
    return Deno.UnsafePointer.create(ptr);
  }

  // 0x30: buffer
  get ld_error(): Uint8Array | Deno.PointerValue {
  ...
  // 0x00: pointer
  set ld_sb(value: Uint8Array | Deno.PointerValue) {
    this.view.setBigUint64(0, BigInt(Deno.UnsafePointer.value(util.toPointer(value))), true);
  }

  // 0x08: buffer
  set ld_host(value: Uint8Array | Deno.PointerValue) {
  ...
  // 0x28: buffer
  set ld_matched(value: Uint8Array | Deno.PointerValue) {
  ...
  // 0x30: buffer
  set ld_error(value: Uint8Array | Deno.PointerValue) {
...
export class LDAP_BERVALView {
  ...
  // 0x08: buffer
  get bv_val(): Uint8Array | Deno.PointerValue {
    const ptr = this.view.getBigUint64(8, true);
    return Deno.UnsafePointer.create(ptr);
  }
  ...
  // 0x08: buffer
  set bv_val(value: Uint8Array | Deno.PointerValue) {
    (this.buf as any)._f8 = value;
    this.view.setBigUint64(8, BigInt(Deno.UnsafePointer.value(util.toPointer((this.buf as any)._f8))), true);
  }
}
...
export interface LDAPMessage {
  ...
  lm_msgtype: number;
  /** ptr */
  lm_ber: Deno.PointerValue | Uint8Array;
  /** ptr */
  lm_chain: Deno.PointerValue | Uint8Array;
  /** ptr */
  lm_next: Deno.PointerValue | Uint8Array;
  /** u32 */
  lm_time: number;
  /** ptr */
  Connection: Deno.PointerValue | Uint8Array;
  /** ptr */
  Request: Deno.PointerValue | Uint8Array;
  /** u32 */
  lm_returncode: number;
  /** u16 */
  lm_referral: number;
  /** Windows.Win32.Foundation.BOOLEAN */
  lm_chased: Uint8Array | Deno.PointerValue;
  /** Windows.Win32.Foundation.BOOLEAN */
  lm_eom: Uint8Array | Deno.PointerValue;
  /** Windows.Win32.Foundation.BOOLEAN */
  ConnectionReferenced: Uint8Array | Deno.PointerValue;
}
...
export function allocLDAPMessage(data?: Partial<LDAPMessage>): Uint8Array {
  ...
  // 0x08: pointer
  if (data?.lm_ber !== undefined) view.setBigUint64(8, data.lm_ber === null ? 0n : BigInt(Deno.UnsafePointer.value(util.toPointer(data.lm_ber))), true);
  // 0x10: pointer
  if (data?.lm_chain !== undefined) view.setBigUint64(16, data.lm_chain === null ? 0n : BigInt(Deno.UnsafePointer.value(util.toPointer(data.lm_chain))), true);
  // 0x18: pointer
  if (data?.lm_next !== undefined) view.setBigUint64(24, data.lm_next === null ? 0n : BigInt(Deno.UnsafePointer.value(util.toPointer(data.lm_next))), true);
  // 0x20: u32
  if (data?.lm_time !== undefined) view.setUint32(32, Number(data.lm_time), true);
  // 0x24: pad4
  // 0x28: pointer
  if (data?.Connection !== undefined) view.setBigUint64(40, data.Connection === null ? 0n : BigInt(Deno.UnsafePointer.value(util.toPointer(data.Connection))), true);
  // 0x30: pointer
  if (data?.Request !== undefined) view.setBigUint64(48, data.Request === null ? 0n : BigInt(Deno.UnsafePointer.value(util.toPointer(data.Request))), true);
  // 0x38: u32
  ...
  // 0x3e: pad2
  // 0x40: pointer
  if (data?.lm_chased !== undefined) view.setBigUint64(64, data.lm_chased === null ? 0n : BigInt(Deno.UnsafePointer.value(util.toPointer(data.lm_chased))), true);
  // 0x48: pointer
  if (data?.lm_eom !== undefined) view.setBigUint64(72, data.lm_eom === null ? 0n : BigInt(Deno.UnsafePointer.value(util.toPointer(data.lm_eom))), true);
  // 0x50: pointer
  if (data?.ConnectionReferenced !== undefined) view.setBigUint64(80, data.ConnectionReferenced === null ? 0n : BigInt(Deno.UnsafePointer.value(util.toPointer(data.ConnectionReferenced))), true);
  return buf;
}
...
export class LDAPMessageView {
  ...
  // 0x08: pointer
  get lm_ber(): Uint8Array | Deno.PointerValue {
    const ptr = this.view.getBigUint64(8, true);
    return Deno.UnsafePointer.create(ptr);
  }

  // 0x10: pointer
  get lm_chain(): Uint8Array | Deno.PointerValue {
    const ptr = this.view.getBigUint64(16, true);
    return Deno.UnsafePointer.create(ptr);
  }

  // 0x18: pointer
  get lm_next(): Uint8Array | Deno.PointerValue {
    const ptr = this.view.getBigUint64(24, true);
    return Deno.UnsafePointer.create(ptr);
  }
  ...
  // 0x28: pointer
  get Connection(): Uint8Array | Deno.PointerValue {
    const ptr = this.view.getBigUint64(40, true);
    return Deno.UnsafePointer.create(ptr);
  }
  ...
  // 0x40: pointer
  get lm_chased(): Uint8Array | Deno.PointerValue {
    const ptr = this.view.getBigUint64(64, true);
    return Deno.UnsafePointer.create(ptr);
  }

  // 0x48: pointer
  get lm_eom(): Uint8Array | Deno.PointerValue {
    const ptr = this.view.getBigUint64(72, true);
    return Deno.UnsafePointer.create(ptr);
  }

  // 0x50: pointer
  get ConnectionReferenced(): Uint8Array | Deno.PointerValue {
  ...
  // 0x08: pointer
  set lm_ber(value: Uint8Array | Deno.PointerValue) {
    this.view.setBigUint64(8, BigInt(Deno.UnsafePointer.value(util.toPointer(value))), true);
  }

  // 0x10: pointer
  set lm_chain(value: Uint8Array | Deno.PointerValue) {
    this.view.setBigUint64(16, BigInt(Deno.UnsafePointer.value(util.toPointer(value))), true);
  }

  // 0x18: pointer
  set lm_next(value: Uint8Array | Deno.PointerValue) {
    this.view.setBigUint64(24, BigInt(Deno.UnsafePointer.value(util.toPointer(value))), true);
  }
  ...
  // 0x28: pointer
  set Connection(value: Uint8Array | Deno.PointerValue) {
  ...
  // 0x40: pointer
  set lm_chased(value: Uint8Array | Deno.PointerValue) {
    this.view.setBigUint64(64, BigInt(Deno.UnsafePointer.value(util.toPointer(value))), true);
  }

  // 0x48: pointer
  set lm_eom(value: Uint8Array | Deno.PointerValue) {
    this.view.setBigUint64(72, BigInt(Deno.UnsafePointer.value(util.toPointer(value))), true);
  }

  // 0x50: pointer
  set ConnectionReferenced(value: Uint8Array | Deno.PointerValue) {
...
export interface LDAPControlA {
  /** Windows.Win32.Foundation.PSTR */
  ldctl_oid: string | null | Uint8Array;
  /** Windows.Win32.Networking.Ldap.LDAP_BERVAL */
  ldctl_value: Uint8Array | Deno.PointerValue;
  /** Windows.Win32.Foundation.BOOLEAN */
  ldctl_iscritical: Uint8Array | Deno.PointerValue;
}
...
export function allocLDAPControlA(data?: Partial<LDAPControlA>): Uint8Array {
  ...
  // 0x08: pointer
  if (data?.ldctl_value !== undefined) view.setBigUint64(8, data.ldctl_value === null ? 0n : BigInt(Deno.UnsafePointer.value(util.toPointer(data.ldctl_value))), true);
  // 0x10: pointer
  if (data?.ldctl_iscritical !== undefined) view.setBigUint64(16, data.ldctl_iscritical === null ? 0n : BigInt(Deno.UnsafePointer.value(util.toPointer(data.ldctl_iscritical))), true);
  return buf;
}
...
export class LDAPControlAView {
  ...
  // 0x00: buffer
  get ldctl_oid(): Uint8Array | Deno.PointerValue {
    const ptr = this.view.getBigUint64(0, true);
    return Deno.UnsafePointer.create(ptr);
  }

  // 0x08: pointer
  get ldctl_value(): Uint8Array | Deno.PointerValue {
    const ptr = this.view.getBigUint64(8, true);
    return Deno.UnsafePointer.create(ptr);
  }

  // 0x10: pointer
  get ldctl_iscritical(): Uint8Array | Deno.PointerValue {
    const ptr = this.view.getBigUint64(16, true);
    return Deno.UnsafePointer.create(ptr);
  }

  // 0x00: buffer
  set ldctl_oid(value: Uint8Array | Deno.PointerValue) {
    (this.buf as any)._f0 = value;
    this.view.setBigUint64(0, BigInt(Deno.UnsafePointer.value(util.toPointer((this.buf as any)._f0))), true);
  }

  // 0x08: pointer
  set ldctl_value(value: Uint8Array | Deno.PointerValue) {
    this.view.setBigUint64(8, BigInt(Deno.UnsafePointer.value(util.toPointer(value))), true);
  }

  // 0x10: pointer
  set ldctl_iscritical(value: Uint8Array | Deno.PointerValue) {
    this.view.setBigUint64(16, BigInt(Deno.UnsafePointer.value(util.toPointer(value))), true);
  }
}
...
export interface LDAPControlW {
  ...
  ldctl_oid: string | null | Uint8Array | Uint16Array;
  /** Windows.Win32.Networking.Ldap.LDAP_BERVAL */
  ldctl_value: Uint8Array | Deno.PointerValue;
  /** Windows.Win32.Foundation.BOOLEAN */
  ldctl_iscritical: Uint8Array | Deno.PointerValue;
...
export interface _mod_vals_e__Union {
  /** ptr */
  modv_strvals: Deno.PointerValue | Uint8Array;
  /** ptr */
  modv_bvals: Deno.PointerValue | Uint8Array;
}
...
export function alloc_mod_vals_e__Union(data?: Partial<_mod_vals_e__Union>): Uint8Array {
  ...
  const view = new DataView(buf.buffer);
  // 0x00: pointer
  if (data?.modv_strvals !== undefined) view.setBigUint64(0, data.modv_strvals === null ? 0n : BigInt(Deno.UnsafePointer.value(util.toPointer(data.modv_strvals))), true);
  // 0x08: pointer
  if (data?.modv_bvals !== undefined) view.setBigUint64(8, data.modv_bvals === null ? 0n : BigInt(Deno.UnsafePointer.value(util.toPointer(data.modv_bvals))), true);
  return buf;
}
...
export class _mod_vals_e__UnionView {
  ...
  // 0x00: pointer
  get modv_strvals(): Uint8Array | Deno.PointerValue {
    const ptr = this.view.getBigUint64(0, true);
    return Deno.UnsafePointer.create(ptr);
  }

  // 0x08: pointer
  get modv_bvals(): Uint8Array | Deno.PointerValue {
    const ptr = this.view.getBigUint64(8, true);
    return Deno.UnsafePointer.create(ptr);
  }

  // 0x00: pointer
  set modv_strvals(value: Uint8Array | Deno.PointerValue) {
    this.view.setBigUint64(0, BigInt(Deno.UnsafePointer.value(util.toPointer(value))), true);
  }

  // 0x08: pointer
  set modv_bvals(value: Uint8Array | Deno.PointerValue) {
    this.view.setBigUint64(8, BigInt(Deno.UnsafePointer.value(util.toPointer(value))), true);
  }
}
...
export interface LDAPModW {
  ...
  mod_op: number;
  /** Windows.Win32.Foundation.PWSTR */
  mod_type: string | null | Uint8Array | Uint16Array;
  /** _mod_vals_e__Union */
  mod_vals: Uint8Array | Deno.PointerValue;
}
...
export function allocLDAPModW(data?: Partial<LDAPModW>): Uint8Array {
  ...
  // 0x10: pointer
  if (data?.mod_vals !== undefined) view.setBigUint64(16, data.mod_vals === null ? 0n : BigInt(Deno.UnsafePointer.value(util.toPointer(data.mod_vals))), true);
  return buf;
}
...
export class LDAPModWView {
  ...
  // 0x08: buffer
  get mod_type(): Uint8Array | Deno.PointerValue {
    const ptr = this.view.getBigUint64(8, true);
    return Deno.UnsafePointer.create(ptr);
  }

  // 0x10: pointer
  get mod_vals(): Uint8Array | Deno.PointerValue {
    const ptr = this.view.getBigUint64(16, true);
    return Deno.UnsafePointer.create(ptr);
  }
  ...
  // 0x08: buffer
  set mod_type(value: Uint8Array | Deno.PointerValue) {
    (this.buf as any)._f8 = value;
    this.view.setBigUint64(8, BigInt(Deno.UnsafePointer.value(util.toPointer((this.buf as any)._f8))), true);
  }

  // 0x10: pointer
  set mod_vals(value: Uint8Array | Deno.PointerValue) {
    this.view.setBigUint64(16, BigInt(Deno.UnsafePointer.value(util.toPointer(value))), true);
  }
}
...
export interface LDAPModA {
  ...
  mod_op: number;
  /** Windows.Win32.Foundation.PSTR */
  mod_type: string | null | Uint8Array;
  /** _mod_vals_e__Union */
  mod_vals: Uint8Array | Deno.PointerValue;
}
...
export class BerElementView {
  ...
  // 0x00: buffer
  get opaque(): Uint8Array | Deno.PointerValue {
    const ptr = this.view.getBigUint64(0, true);
    return Deno.UnsafePointer.create(ptr);
  }

  // 0x00: buffer
  set opaque(value: Uint8Array | Deno.PointerValue) {
    (this.buf as any)._f0 = value;
    this.view.setBigUint64(0, BigInt(Deno.UnsafePointer.value(util.toPointer((this.buf as any)._f0))), true);
  }
}
...
export interface LDAPAPIInfoA {
  ...
  /** ptr */
  ldapai_extensions: Deno.PointerValue | Uint8Array;
  /** Windows.Win32.Foundation.PSTR */
  ldapai_vendor_name: string | null | Uint8Array;
  /** i32 */
...
export function allocLDAPAPIInfoA(data?: Partial<LDAPAPIInfoA>): Uint8Array {
  ...
  // 0x0c: pad4
  // 0x10: pointer
  if (data?.ldapai_extensions !== undefined) view.setBigUint64(16, data.ldapai_extensions === null ? 0n : BigInt(Deno.UnsafePointer.value(util.toPointer(data.ldapai_extensions))), true);
  // 0x18: buffer
...
export class LDAPAPIInfoAView {
  ...
  // 0x10: pointer
  get ldapai_extensions(): Uint8Array | Deno.PointerValue {
    const ptr = this.view.getBigUint64(16, true);
    return Deno.UnsafePointer.create(ptr);
  }

  // 0x18: buffer
  get ldapai_vendor_name(): Uint8Array | Deno.PointerValue {
    const ptr = this.view.getBigUint64(24, true);
    return Deno.UnsafePointer.create(ptr);
  }
  ...
  // 0x10: pointer
  set ldapai_extensions(value: Uint8Array | Deno.PointerValue) {
    this.view.setBigUint64(16, BigInt(Deno.UnsafePointer.value(util.toPointer(value))), true);
  }

  // 0x18: buffer
  set ldapai_vendor_name(value: Uint8Array | Deno.PointerValue) {
...
export interface LDAPAPIInfoW {
  ...
  ldapai_extensions: Deno.PointerValue | Uint8Array;
  /** Windows.Win32.Foundation.PWSTR */
  ldapai_vendor_name: string | null | Uint8Array | Uint16Array;
  /** i32 */
  ldapai_vendor_version: number;
}
...
export interface LDAPAPIFeatureInfoA {
  ...
  /** Windows.Win32.Foundation.PSTR */
  ldapaif_name: string | null | Uint8Array;
  /** i32 */
...
export class LDAPAPIFeatureInfoAView {
  ...
  // 0x08: buffer
  get ldapaif_name(): Uint8Array | Deno.PointerValue {
    const ptr = this.view.getBigUint64(8, true);
    return Deno.UnsafePointer.create(ptr);
  }
  ...
  // 0x08: buffer
  set ldapaif_name(value: Uint8Array | Deno.PointerValue) {
    (this.buf as any)._f8 = value;
    this.view.setBigUint64(8, BigInt(Deno.UnsafePointer.value(util.toPointer((this.buf as any)._f8))), true);
  }
...
export interface LDAPAPIFeatureInfoW {
  ...
  ldapaif_info_version: number;
  /** Windows.Win32.Foundation.PWSTR */
  ldapaif_name: string | null | Uint8Array | Uint16Array;
  /** i32 */
  ldapaif_version: number;
}
...
export interface LDAPSortKeyW {
  /** Windows.Win32.Foundation.PWSTR */
  sk_attrtype: string | null | Uint8Array | Uint16Array;
  /** Windows.Win32.Foundation.PWSTR */
  sk_matchruleoid: string | null | Uint8Array | Uint16Array;
  /** Windows.Win32.Foundation.BOOLEAN */
  sk_reverseorder: Uint8Array | Deno.PointerValue;
}
...
export function allocLDAPSortKeyW(data?: Partial<LDAPSortKeyW>): Uint8Array {
  ...
  // 0x10: pointer
  if (data?.sk_reverseorder !== undefined) view.setBigUint64(16, data.sk_reverseorder === null ? 0n : BigInt(Deno.UnsafePointer.value(util.toPointer(data.sk_reverseorder))), true);
  return buf;
}
...
export class LDAPSortKeyWView {
  ...
  // 0x00: buffer
  get sk_attrtype(): Uint8Array | Deno.PointerValue {
    const ptr = this.view.getBigUint64(0, true);
    return Deno.UnsafePointer.create(ptr);
  }

  // 0x08: buffer
  get sk_matchruleoid(): Uint8Array | Deno.PointerValue {
    const ptr = this.view.getBigUint64(8, true);
    return Deno.UnsafePointer.create(ptr);
  }

  // 0x10: pointer
  get sk_reverseorder(): Uint8Array | Deno.PointerValue {
    const ptr = this.view.getBigUint64(16, true);
    return Deno.UnsafePointer.create(ptr);
  }

  // 0x00: buffer
  set sk_attrtype(value: Uint8Array | Deno.PointerValue) {
    (this.buf as any)._f0 = value;
    this.view.setBigUint64(0, BigInt(Deno.UnsafePointer.value(util.toPointer((this.buf as any)._f0))), true);
  }

  // 0x08: buffer
  set sk_matchruleoid(value: Uint8Array | Deno.PointerValue) {
    (this.buf as any)._f8 = value;
    this.view.setBigUint64(8, BigInt(Deno.UnsafePointer.value(util.toPointer((this.buf as any)._f8))), true);
  }

  // 0x10: pointer
  set sk_reverseorder(value: Uint8Array | Deno.PointerValue) {
    this.view.setBigUint64(16, BigInt(Deno.UnsafePointer.value(util.toPointer(value))), true);
  }
}
...
export interface LDAPSortKeyA {
  /** Windows.Win32.Foundation.PSTR */
  sk_attrtype: string | null | Uint8Array;
  /** Windows.Win32.Foundation.PSTR */
  sk_matchruleoid: string | null | Uint8Array;
  /** Windows.Win32.Foundation.BOOLEAN */
  sk_reverseorder: Uint8Array | Deno.PointerValue;
}
...
export interface LDAPVLVInfo {
  ...
  ldvlv_count: number;
  /** ptr */
  ldvlv_attrvalue: Deno.PointerValue | Uint8Array;
  /** ptr */
  ldvlv_context: Deno.PointerValue | Uint8Array;
  /** ptr */
  ldvlv_extradata: Deno.PointerValue | Uint8Array;
}
...
export function allocLDAPVLVInfo(data?: Partial<LDAPVLVInfo>): Uint8Array {
  ...
  // 0x14: pad4
  // 0x18: pointer
  if (data?.ldvlv_attrvalue !== undefined) view.setBigUint64(24, data.ldvlv_attrvalue === null ? 0n : BigInt(Deno.UnsafePointer.value(util.toPointer(data.ldvlv_attrvalue))), true);
  // 0x20: pointer
  if (data?.ldvlv_context !== undefined) view.setBigUint64(32, data.ldvlv_context === null ? 0n : BigInt(Deno.UnsafePointer.value(util.toPointer(data.ldvlv_context))), true);
  // 0x28: pointer
  if (data?.ldvlv_extradata !== undefined) view.setBigUint64(40, data.ldvlv_extradata === null ? 0n : BigInt(Deno.UnsafePointer.value(util.toPointer(data.ldvlv_extradata))), true);
  return buf;
}
...
export class LDAPVLVInfoView {
  ...
  // 0x18: pointer
  get ldvlv_attrvalue(): Uint8Array | Deno.PointerValue {
    const ptr = this.view.getBigUint64(24, true);
    return Deno.UnsafePointer.create(ptr);
  }

  // 0x20: pointer
  get ldvlv_context(): Uint8Array | Deno.PointerValue {
    const ptr = this.view.getBigUint64(32, true);
    return Deno.UnsafePointer.create(ptr);
  }

  // 0x28: pointer
  get ldvlv_extradata(): Uint8Array | Deno.PointerValue {
    const ptr = this.view.getBigUint64(40, true);
    return Deno.UnsafePointer.create(ptr);
  }
  ...
  // 0x18: pointer
  set ldvlv_attrvalue(value: Uint8Array | Deno.PointerValue) {
    this.view.setBigUint64(24, BigInt(Deno.UnsafePointer.value(util.toPointer(value))), true);
  }

  // 0x20: pointer
  set ldvlv_context(value: Uint8Array | Deno.PointerValue) {
    this.view.setBigUint64(32, BigInt(Deno.UnsafePointer.value(util.toPointer(value))), true);
  }

  // 0x28: pointer
  set ldvlv_extradata(value: Uint8Array | Deno.PointerValue) {
    this.view.setBigUint64(40, BigInt(Deno.UnsafePointer.value(util.toPointer(value))), true);
  }
}
...
export interface LDAP_REFERRAL_CALLBACK {
  ...
  QueryForConnection: Uint8Array | Deno.PointerValue;
  /** Windows.Win32.Networking.Ldap.NOTIFYOFNEWCONNECTION */
  NotifyRoutine: Uint8Array | Deno.PointerValue;
  /** Windows.Win32.Networking.Ldap.DEREFERENCECONNECTION */
  DereferenceRoutine: Uint8Array | Deno.PointerValue;
}
...
export function allocLDAP_REFERRAL_CALLBACK(data?: Partial<LDAP_REFERRAL_CALLBACK>): Uint8Array {
  ...
  // 0x04: pad4
  // 0x08: pointer
  if (data?.QueryForConnection !== undefined) view.setBigUint64(8, data.QueryForConnection === null ? 0n : BigInt(Deno.UnsafePointer.value(util.toPointer(data.QueryForConnection))), true);
  // 0x10: pointer
  if (data?.NotifyRoutine !== undefined) view.setBigUint64(16, data.NotifyRoutine === null ? 0n : BigInt(Deno.UnsafePointer.value(util.toPointer(data.NotifyRoutine))), true);
  // 0x18: pointer
  if (data?.DereferenceRoutine !== undefined) view.setBigUint64(24, data.DereferenceRoutine === null ? 0n : BigInt(Deno.UnsafePointer.value(util.toPointer(data.DereferenceRoutine))), true);
  return buf;
}
...
export class LDAP_REFERRAL_CALLBACKView {
  ...
  // 0x08: pointer
  get QueryForConnection(): Uint8Array | Deno.PointerValue {
    const ptr = this.view.getBigUint64(8, true);
    return Deno.UnsafePointer.create(ptr);
  }

  // 0x10: pointer
  get NotifyRoutine(): Uint8Array | Deno.PointerValue {
    const ptr = this.view.getBigUint64(16, true);
    return Deno.UnsafePointer.create(ptr);
  }

  // 0x18: pointer
  get DereferenceRoutine(): Uint8Array | Deno.PointerValue {
    const ptr = this.view.getBigUint64(24, true);
    return Deno.UnsafePointer.create(ptr);
  }
  ...
  // 0x08: pointer
  set QueryForConnection(value: Uint8Array | Deno.PointerValue) {
    this.view.setBigUint64(8, BigInt(Deno.UnsafePointer.value(util.toPointer(value))), true);
  }

  // 0x10: pointer
  set NotifyRoutine(value: Uint8Array | Deno.PointerValue) {
    this.view.setBigUint64(16, BigInt(Deno.UnsafePointer.value(util.toPointer(value))), true);
  }

  // 0x18: pointer
  set DereferenceRoutine(value: Uint8Array | Deno.PointerValue) {
    this.view.setBigUint64(24, BigInt(Deno.UnsafePointer.value(util.toPointer(value))), true);
  }
}
...
try {
  var libWLDAP32_dll = Deno.dlopen("WLDAP32.dll", {
    ldap_openW: {
...
export function ldap_sasl_bindA(
  ...
  DistName: string | null | Uint8Array /* Windows.Win32.Foundation.PSTR */,
  AuthMechanism: string | null | Uint8Array /* Windows.Win32.Foundation.PSTR */,
  cred: Deno.PointerValue | Uint8Array /* ptr */,
  ServerCtrls: Deno.PointerValue | Uint8Array /* ptr */,
...
export function ldap_sasl_bindW(
  ExternalHandle: Deno.PointerValue | Uint8Array /* ptr */,
  DistName: string | null | Uint8Array | Uint16Array /* Windows.Win32.Foundation.PWSTR */,
  AuthMechanism: string | null | Uint8Array | Uint16Array /* Windows.Win32.Foundation.PWSTR */,
  cred: Deno.PointerValue | Uint8Array /* ptr */,
  ServerCtrls: Deno.PointerValue | Uint8Array /* ptr */,
  ClientCtrls: Deno.PointerValue | Uint8Array /* ptr */,
  MessageNumber: Deno.PointerValue | Uint8Array /* ptr */,
...
export function ldap_searchW(
  ld: Deno.PointerValue | Uint8Array /* ptr */,
  base: string | null | Uint8Array | Uint16Array /* Windows.Win32.Foundation.PWSTR */,
  scope: number /* u32 */,
...
export function ldap_searchA(
  ld: Deno.PointerValue | Uint8Array /* ptr */,
  base: string | null | Uint8Array /* Windows.Win32.Foundation.PSTR */,
  scope: number /* u32 */,
...
export function ldap_rename_extW(
  ld: Deno.PointerValue | Uint8Array /* ptr */,
  dn: string | null | Uint8Array | Uint16Array /* Windows.Win32.Foundation.PWSTR */,
  NewRDN: string | null | Uint8Array | Uint16Array /* Windows.Win32.Foundation.PWSTR */,
  NewParent: string | null | Uint8Array | Uint16Array /* Windows.Win32.Foundation.PWSTR */,
  DeleteOldRdn: number /* i32 */,
  ServerControls: Deno.PointerValue | Uint8Array /* ptr */,
  ClientControls: Deno.PointerValue | Uint8Array /* ptr */,
  MessageNumber: Deno.PointerValue | Uint8Array /* ptr */,
...
export function ldap_rename_extA(
  ld: Deno.PointerValue | Uint8Array /* ptr */,
  dn: string | null | Uint8Array /* Windows.Win32.Foundation.PSTR */,
  NewRDN: string | null | Uint8Array /* Windows.Win32.Foundation.PSTR */,
  NewParent: string | null | Uint8Array /* Windows.Win32.Foundation.PSTR */,
  DeleteOldRdn: number /* i32 */,
  ServerControls: Deno.PointerValue | Uint8Array /* ptr */,
  ClientControls: Deno.PointerValue | Uint8Array /* ptr */,
  MessageNumber: Deno.PointerValue | Uint8Array /* ptr */,
...
export function ldap_parse_resultW(
  ...
  ReturnCode: Deno.PointerValue | Uint8Array /* ptr */,
  MatchedDNs: Deno.PointerValue | Uint8Array /* ptr */,
  ErrorMessage: Deno.PointerValue | Uint8Array /* ptr */,
...
export function ldap_parse_extended_resultA(
  Connection: Deno.PointerValue | Uint8Array /* ptr */,
  ResultMessage: Deno.PointerValue | Uint8Array /* ptr */,
  ResultOID: Deno.PointerValue | Uint8Array /* ptr */,
...
export function ldap_escape_filter_elementW(
  sourceFilterElement: string | null | Uint8Array /* Windows.Win32.Foundation.PSTR */,
...
export function ldap_search_init_pageW(
  ...
  SearchFilter: string | null | Uint8Array | Uint16Array /* Windows.Win32.Foundation.PWSTR */,
  AttributeList: Deno.PointerValue | Uint8Array /* ptr */,
...
export function ldap_get_next_page(
  ExternalHandle: Deno.PointerValue | Uint8Array /* ptr */,
  SearchHandle: Deno.PointerValue | Uint8Array /* ptr */,
  PageSize: number /* u32 */,
  MessageNumber: Deno.PointerValue | Uint8Array /* ptr */,
): number /* u32 */ {
...
export function ldap_create_vlv_controlW(
  ExternalHandle: Deno.PointerValue | Uint8Array /* ptr */,
  VlvInfo: Deno.PointerValue | Uint8Array /* ptr */,
  IsCritical: number /* u8 */,
  Control: Deno.PointerValue | Uint8Array /* ptr */,
): number /* i32 */ {
...
export function ldap_parse_vlv_controlW(
  ExternalHandle: Deno.PointerValue | Uint8Array /* ptr */,
  Control: Deno.PointerValue | Uint8Array /* ptr */,
  TargetPos: Deno.PointerValue | Uint8Array /* ptr */,
  ListCount: Deno.PointerValue | Uint8Array /* ptr */,
...
export function ldap_start_tls_sW(
  ExternalHandle: Deno.PointerValue | Uint8Array /* ptr */,
  ServerReturnValue: Deno.PointerValue | Uint8Array /* ptr */,
  result: Deno.PointerValue | Uint8Array /* ptr */,
  ServerControls: Deno.PointerValue | Uint8Array /* ptr */,
  ClientControls: Deno.PointerValue | Uint8Array /* ptr */,
): number /* u32 */ {
...
export function ldap_extended_operationW(
  ld: Deno.PointerValue | Uint8Array /* ptr */,
  Oid: string | null | Uint8Array | Uint16Array /* Windows.Win32.Foundation.PWSTR */,
  Data: Deno.PointerValue | Uint8Array /* ptr */,
  ServerControls: Deno.PointerValue | Uint8Array /* ptr */,
  ClientControls: Deno.PointerValue | Uint8Array /* ptr */,
  MessageNumber: Deno.PointerValue | Uint8Array /* ptr */,
...
export function ldap_extended_operationA(
  ld: Deno.PointerValue | Uint8Array /* ptr */,
  Oid: string | null | Uint8Array /* Windows.Win32.Foundation.PSTR */,
  Data: Deno.PointerValue | Uint8Array /* ptr */,
  ServerControls: Deno.PointerValue | Uint8Array /* ptr */,
  ClientControls: Deno.PointerValue | Uint8Array /* ptr */,
  MessageNumber: Deno.PointerValue | Uint8Array /* ptr */,
