...
/**
 * Windows.Win32.Networking.ActiveDirectory.Apis (size: 152)
 */
export interface Apis {
  /** System.Guid */
  CLSID_CommonQuery: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  CLSID_DsAdminCreateObj: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  CLSID_MicrosoftDS: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  CLSID_DsPropertyPages: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  CLSID_DsDomainTreeBrowser: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  CLSID_DsDisplaySpecifier: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  CLSID_DsFolderProperties: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  CLSID_DsQuery: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  CLSID_DsFindObjects: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  CLSID_DsFindPeople: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  CLSID_DsFindPrinter: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  CLSID_DsFindComputer: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  CLSID_DsFindVolume: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  CLSID_DsFindContainer: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  CLSID_DsFindAdvanced: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  CLSID_DsFindDomainController: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  CLSID_DsFindWriteableDomainController: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  CLSID_DsFindFrsMembers: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  CLSID_DsObjectPicker: Uint8Array | Deno.PointerValue | null;
}

export const sizeofApis = 152;

export function allocApis(data?: Partial<Apis>): Uint8Array {
  const buf = new Uint8Array(sizeofApis);
  const view = new DataView(buf.buffer);
  // 0x00: pointer
  if (data?.CLSID_CommonQuery !== undefined) view.setBigUint64(0, data.CLSID_CommonQuery === null ? 0n : BigInt(util.toPointer(data.CLSID_CommonQuery)), true);
  // 0x08: pointer
  if (data?.CLSID_DsAdminCreateObj !== undefined) view.setBigUint64(8, data.CLSID_DsAdminCreateObj === null ? 0n : BigInt(util.toPointer(data.CLSID_DsAdminCreateObj)), true);
  // 0x10: pointer
  if (data?.CLSID_MicrosoftDS !== undefined) view.setBigUint64(16, data.CLSID_MicrosoftDS === null ? 0n : BigInt(util.toPointer(data.CLSID_MicrosoftDS)), true);
  // 0x18: pointer
  if (data?.CLSID_DsPropertyPages !== undefined) view.setBigUint64(24, data.CLSID_DsPropertyPages === null ? 0n : BigInt(util.toPointer(data.CLSID_DsPropertyPages)), true);
  // 0x20: pointer
  if (data?.CLSID_DsDomainTreeBrowser !== undefined) view.setBigUint64(32, data.CLSID_DsDomainTreeBrowser === null ? 0n : BigInt(util.toPointer(data.CLSID_DsDomainTreeBrowser)), true);
  // 0x28: pointer
  if (data?.CLSID_DsDisplaySpecifier !== undefined) view.setBigUint64(40, data.CLSID_DsDisplaySpecifier === null ? 0n : BigInt(util.toPointer(data.CLSID_DsDisplaySpecifier)), true);
  // 0x30: pointer
  if (data?.CLSID_DsFolderProperties !== undefined) view.setBigUint64(48, data.CLSID_DsFolderProperties === null ? 0n : BigInt(util.toPointer(data.CLSID_DsFolderProperties)), true);
  // 0x38: pointer
  if (data?.CLSID_DsQuery !== undefined) view.setBigUint64(56, data.CLSID_DsQuery === null ? 0n : BigInt(util.toPointer(data.CLSID_DsQuery)), true);
  // 0x40: pointer
  if (data?.CLSID_DsFindObjects !== undefined) view.setBigUint64(64, data.CLSID_DsFindObjects === null ? 0n : BigInt(util.toPointer(data.CLSID_DsFindObjects)), true);
  // 0x48: pointer
  if (data?.CLSID_DsFindPeople !== undefined) view.setBigUint64(72, data.CLSID_DsFindPeople === null ? 0n : BigInt(util.toPointer(data.CLSID_DsFindPeople)), true);
  // 0x50: pointer
  if (data?.CLSID_DsFindPrinter !== undefined) view.setBigUint64(80, data.CLSID_DsFindPrinter === null ? 0n : BigInt(util.toPointer(data.CLSID_DsFindPrinter)), true);
  // 0x58: pointer
  if (data?.CLSID_DsFindComputer !== undefined) view.setBigUint64(88, data.CLSID_DsFindComputer === null ? 0n : BigInt(util.toPointer(data.CLSID_DsFindComputer)), true);
  // 0x60: pointer
  if (data?.CLSID_DsFindVolume !== undefined) view.setBigUint64(96, data.CLSID_DsFindVolume === null ? 0n : BigInt(util.toPointer(data.CLSID_DsFindVolume)), true);
  // 0x68: pointer
  if (data?.CLSID_DsFindContainer !== undefined) view.setBigUint64(104, data.CLSID_DsFindContainer === null ? 0n : BigInt(util.toPointer(data.CLSID_DsFindContainer)), true);
  // 0x70: pointer
  if (data?.CLSID_DsFindAdvanced !== undefined) view.setBigUint64(112, data.CLSID_DsFindAdvanced === null ? 0n : BigInt(util.toPointer(data.CLSID_DsFindAdvanced)), true);
  // 0x78: pointer
  if (data?.CLSID_DsFindDomainController !== undefined) view.setBigUint64(120, data.CLSID_DsFindDomainController === null ? 0n : BigInt(util.toPointer(data.CLSID_DsFindDomainController)), true);
  // 0x80: pointer
  if (data?.CLSID_DsFindWriteableDomainController !== undefined) view.setBigUint64(128, data.CLSID_DsFindWriteableDomainController === null ? 0n : BigInt(util.toPointer(data.CLSID_DsFindWriteableDomainController)), true);
  // 0x88: pointer
  if (data?.CLSID_DsFindFrsMembers !== undefined) view.setBigUint64(136, data.CLSID_DsFindFrsMembers === null ? 0n : BigInt(util.toPointer(data.CLSID_DsFindFrsMembers)), true);
  // 0x90: pointer
  if (data?.CLSID_DsObjectPicker !== undefined) view.setBigUint64(144, data.CLSID_DsObjectPicker === null ? 0n : BigInt(util.toPointer(data.CLSID_DsObjectPicker)), true);
  return buf;
}
