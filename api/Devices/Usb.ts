...
/**
 * Windows.Win32.Devices.Usb.Apis (size: 112)
 */
export interface Apis {
  /** System.Guid */
  GUID_DEVINTERFACE_USB_HUB: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_DEVINTERFACE_USB_BILLBOARD: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_DEVINTERFACE_USB_DEVICE: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_DEVINTERFACE_USB_HOST_CONTROLLER: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_USB_WMI_STD_DATA: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_USB_WMI_STD_NOTIFICATION: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_USB_WMI_DEVICE_PERF_INFO: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_USB_WMI_NODE_INFO: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_USB_WMI_TRACING: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_USB_TRANSFER_TRACING: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_USB_PERFORMANCE_TRACING: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_USB_WMI_SURPRISE_REMOVAL_NOTIFICATION: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_USB_MSOS20_PLATFORM_CAPABILITY_ID: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  WinUSB_TestGuid: Uint8Array | Deno.PointerValue | null;
}
...
export function allocApis(data?: Partial<Apis>): Uint8Array {
  ...
  // 0x00: pointer
  if (data?.GUID_DEVINTERFACE_USB_HUB !== undefined) view.setBigUint64(0, data.GUID_DEVINTERFACE_USB_HUB === null ? 0n : BigInt(util.toPointer(data.GUID_DEVINTERFACE_USB_HUB)), true);
  // 0x08: pointer
  if (data?.GUID_DEVINTERFACE_USB_BILLBOARD !== undefined) view.setBigUint64(8, data.GUID_DEVINTERFACE_USB_BILLBOARD === null ? 0n : BigInt(util.toPointer(data.GUID_DEVINTERFACE_USB_BILLBOARD)), true);
  // 0x10: pointer
  if (data?.GUID_DEVINTERFACE_USB_DEVICE !== undefined) view.setBigUint64(16, data.GUID_DEVINTERFACE_USB_DEVICE === null ? 0n : BigInt(util.toPointer(data.GUID_DEVINTERFACE_USB_DEVICE)), true);
  // 0x18: pointer
  if (data?.GUID_DEVINTERFACE_USB_HOST_CONTROLLER !== undefined) view.setBigUint64(24, data.GUID_DEVINTERFACE_USB_HOST_CONTROLLER === null ? 0n : BigInt(util.toPointer(data.GUID_DEVINTERFACE_USB_HOST_CONTROLLER)), true);
  // 0x20: pointer
  if (data?.GUID_USB_WMI_STD_DATA !== undefined) view.setBigUint64(32, data.GUID_USB_WMI_STD_DATA === null ? 0n : BigInt(util.toPointer(data.GUID_USB_WMI_STD_DATA)), true);
  // 0x28: pointer
  if (data?.GUID_USB_WMI_STD_NOTIFICATION !== undefined) view.setBigUint64(40, data.GUID_USB_WMI_STD_NOTIFICATION === null ? 0n : BigInt(util.toPointer(data.GUID_USB_WMI_STD_NOTIFICATION)), true);
  // 0x30: pointer
  if (data?.GUID_USB_WMI_DEVICE_PERF_INFO !== undefined) view.setBigUint64(48, data.GUID_USB_WMI_DEVICE_PERF_INFO === null ? 0n : BigInt(util.toPointer(data.GUID_USB_WMI_DEVICE_PERF_INFO)), true);
  // 0x38: pointer
  if (data?.GUID_USB_WMI_NODE_INFO !== undefined) view.setBigUint64(56, data.GUID_USB_WMI_NODE_INFO === null ? 0n : BigInt(util.toPointer(data.GUID_USB_WMI_NODE_INFO)), true);
  // 0x40: pointer
  if (data?.GUID_USB_WMI_TRACING !== undefined) view.setBigUint64(64, data.GUID_USB_WMI_TRACING === null ? 0n : BigInt(util.toPointer(data.GUID_USB_WMI_TRACING)), true);
  // 0x48: pointer
  if (data?.GUID_USB_TRANSFER_TRACING !== undefined) view.setBigUint64(72, data.GUID_USB_TRANSFER_TRACING === null ? 0n : BigInt(util.toPointer(data.GUID_USB_TRANSFER_TRACING)), true);
  // 0x50: pointer
  if (data?.GUID_USB_PERFORMANCE_TRACING !== undefined) view.setBigUint64(80, data.GUID_USB_PERFORMANCE_TRACING === null ? 0n : BigInt(util.toPointer(data.GUID_USB_PERFORMANCE_TRACING)), true);
  // 0x58: pointer
  if (data?.GUID_USB_WMI_SURPRISE_REMOVAL_NOTIFICATION !== undefined) view.setBigUint64(88, data.GUID_USB_WMI_SURPRISE_REMOVAL_NOTIFICATION === null ? 0n : BigInt(util.toPointer(data.GUID_USB_WMI_SURPRISE_REMOVAL_NOTIFICATION)), true);
  // 0x60: pointer
  if (data?.GUID_USB_MSOS20_PLATFORM_CAPABILITY_ID !== undefined) view.setBigUint64(96, data.GUID_USB_MSOS20_PLATFORM_CAPABILITY_ID === null ? 0n : BigInt(util.toPointer(data.GUID_USB_MSOS20_PLATFORM_CAPABILITY_ID)), true);
  // 0x68: pointer
  if (data?.WinUSB_TestGuid !== undefined) view.setBigUint64(104, data.WinUSB_TestGuid === null ? 0n : BigInt(util.toPointer(data.WinUSB_TestGuid)), true);
  return buf;
}
