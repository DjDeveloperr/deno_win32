...
/**
 * Windows.Win32.Devices.Bluetooth.Apis (size: 112)
 */
export interface Apis {
  /** System.Guid */
  SVCID_BTH_PROVIDER: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_BLUETOOTHLE_DEVICE_INTERFACE: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_BLUETOOTH_GATT_SERVICE_DEVICE_INTERFACE: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  BTH_LE_ATT_BLUETOOTH_BASE_GUID: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_BTHPORT_DEVICE_INTERFACE: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_BTH_RFCOMM_SERVICE_DEVICE_INTERFACE: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_BLUETOOTH_RADIO_IN_RANGE: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_BLUETOOTH_RADIO_OUT_OF_RANGE: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_BLUETOOTH_L2CAP_EVENT: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_BLUETOOTH_HCI_EVENT: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_BLUETOOTH_AUTHENTICATION_REQUEST: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_BLUETOOTH_KEYPRESS_EVENT: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_BLUETOOTH_HCI_VENDOR_EVENT: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  Bluetooth_Base_UUID: Uint8Array | Deno.PointerValue | null;
}
...
export function allocApis(data?: Partial<Apis>): Uint8Array {
  ...
  // 0x00: pointer
  if (data?.SVCID_BTH_PROVIDER !== undefined) view.setBigUint64(0, data.SVCID_BTH_PROVIDER === null ? 0n : BigInt(util.toPointer(data.SVCID_BTH_PROVIDER)), true);
  // 0x08: pointer
  if (data?.GUID_BLUETOOTHLE_DEVICE_INTERFACE !== undefined) view.setBigUint64(8, data.GUID_BLUETOOTHLE_DEVICE_INTERFACE === null ? 0n : BigInt(util.toPointer(data.GUID_BLUETOOTHLE_DEVICE_INTERFACE)), true);
  // 0x10: pointer
  if (data?.GUID_BLUETOOTH_GATT_SERVICE_DEVICE_INTERFACE !== undefined) view.setBigUint64(16, data.GUID_BLUETOOTH_GATT_SERVICE_DEVICE_INTERFACE === null ? 0n : BigInt(util.toPointer(data.GUID_BLUETOOTH_GATT_SERVICE_DEVICE_INTERFACE)), true);
  // 0x18: pointer
  if (data?.BTH_LE_ATT_BLUETOOTH_BASE_GUID !== undefined) view.setBigUint64(24, data.BTH_LE_ATT_BLUETOOTH_BASE_GUID === null ? 0n : BigInt(util.toPointer(data.BTH_LE_ATT_BLUETOOTH_BASE_GUID)), true);
  // 0x20: pointer
  if (data?.GUID_BTHPORT_DEVICE_INTERFACE !== undefined) view.setBigUint64(32, data.GUID_BTHPORT_DEVICE_INTERFACE === null ? 0n : BigInt(util.toPointer(data.GUID_BTHPORT_DEVICE_INTERFACE)), true);
  // 0x28: pointer
  if (data?.GUID_BTH_RFCOMM_SERVICE_DEVICE_INTERFACE !== undefined) view.setBigUint64(40, data.GUID_BTH_RFCOMM_SERVICE_DEVICE_INTERFACE === null ? 0n : BigInt(util.toPointer(data.GUID_BTH_RFCOMM_SERVICE_DEVICE_INTERFACE)), true);
  // 0x30: pointer
  if (data?.GUID_BLUETOOTH_RADIO_IN_RANGE !== undefined) view.setBigUint64(48, data.GUID_BLUETOOTH_RADIO_IN_RANGE === null ? 0n : BigInt(util.toPointer(data.GUID_BLUETOOTH_RADIO_IN_RANGE)), true);
  // 0x38: pointer
  if (data?.GUID_BLUETOOTH_RADIO_OUT_OF_RANGE !== undefined) view.setBigUint64(56, data.GUID_BLUETOOTH_RADIO_OUT_OF_RANGE === null ? 0n : BigInt(util.toPointer(data.GUID_BLUETOOTH_RADIO_OUT_OF_RANGE)), true);
  // 0x40: pointer
  if (data?.GUID_BLUETOOTH_L2CAP_EVENT !== undefined) view.setBigUint64(64, data.GUID_BLUETOOTH_L2CAP_EVENT === null ? 0n : BigInt(util.toPointer(data.GUID_BLUETOOTH_L2CAP_EVENT)), true);
  // 0x48: pointer
  if (data?.GUID_BLUETOOTH_HCI_EVENT !== undefined) view.setBigUint64(72, data.GUID_BLUETOOTH_HCI_EVENT === null ? 0n : BigInt(util.toPointer(data.GUID_BLUETOOTH_HCI_EVENT)), true);
  // 0x50: pointer
  if (data?.GUID_BLUETOOTH_AUTHENTICATION_REQUEST !== undefined) view.setBigUint64(80, data.GUID_BLUETOOTH_AUTHENTICATION_REQUEST === null ? 0n : BigInt(util.toPointer(data.GUID_BLUETOOTH_AUTHENTICATION_REQUEST)), true);
  // 0x58: pointer
  if (data?.GUID_BLUETOOTH_KEYPRESS_EVENT !== undefined) view.setBigUint64(88, data.GUID_BLUETOOTH_KEYPRESS_EVENT === null ? 0n : BigInt(util.toPointer(data.GUID_BLUETOOTH_KEYPRESS_EVENT)), true);
  // 0x60: pointer
  if (data?.GUID_BLUETOOTH_HCI_VENDOR_EVENT !== undefined) view.setBigUint64(96, data.GUID_BLUETOOTH_HCI_VENDOR_EVENT === null ? 0n : BigInt(util.toPointer(data.GUID_BLUETOOTH_HCI_VENDOR_EVENT)), true);
  // 0x68: pointer
  if (data?.Bluetooth_Base_UUID !== undefined) view.setBigUint64(104, data.Bluetooth_Base_UUID === null ? 0n : BigInt(util.toPointer(data.Bluetooth_Base_UUID)), true);
  return buf;
}
