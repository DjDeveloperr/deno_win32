/// Auto-generated by Deno Win32: Windows.Win32.NetworkManagement.WNet.Apis

import * as util from "../../util.ts";

// Enums
export type UNC_INFO_LEVEL = number;
export type WNPERM_DLG = number;
export type WNET_OPEN_ENUM_USAGE = number;
export type NET_USE_CONNECT_FLAGS = number;
export type NP_PROPERTY_DIALOG_SELECTION = number;
export type NPDIRECTORY_NOTIFY_OPERATION = number;
export type NET_RESOURCE_TYPE = number;
export type NETWORK_NAME_FORMAT_FLAGS = number;
export type NET_RESOURCE_SCOPE = number;
export type NETINFOSTRUCT_CHARACTERISTICS = number;
export type CONNECTDLGSTRUCT_FLAGS = number;
export type DISCDLGSTRUCT_FLAGS = number;
export type WIN32_ERROR = number;

// Constants
export const UNIVERSAL_NAME_INFO_LEVEL = 1;
export const REMOTE_NAME_INFO_LEVEL = 2;
export const WNPERM_DLG_PERM = 0;
export const WNPERM_DLG_AUDIT = 1;
export const WNPERM_DLG_OWNER = 2;
export const RESOURCEUSAGE_NONE = 0;
export const RESOURCEUSAGE_CONNECTABLE = 1;
export const RESOURCEUSAGE_CONTAINER = 2;
export const RESOURCEUSAGE_ATTACHED = 16;
export const RESOURCEUSAGE_ALL = 19;
export const CONNECT_INTERACTIVE = 8;
export const CONNECT_PROMPT = 16;
export const CONNECT_REDIRECT = 128;
export const CONNECT_UPDATE_PROFILE = 1;
export const CONNECT_COMMANDLINE = 2048;
export const CONNECT_CMD_SAVECRED = 4096;
export const CONNECT_TEMPORARY = 4;
export const CONNECT_DEFERRED = 1024;
export const CONNECT_UPDATE_RECENT = 2;
export const WNPS_FILE = 0;
export const WNPS_DIR = 1;
export const WNPS_MULT = 2;
export const WNDN_MKDIR = 1;
export const WNDN_RMDIR = 2;
export const WNDN_MVDIR = 3;
export const RESOURCETYPE_ANY = 0;
export const RESOURCETYPE_DISK = 1;
export const RESOURCETYPE_PRINT = 2;
export const WNFMT_MULTILINE = 1;
export const WNFMT_ABBREVIATED = 2;
export const RESOURCE_CONNECTED = 1;
export const RESOURCE_CONTEXT = 5;
export const RESOURCE_GLOBALNET = 2;
export const RESOURCE_REMEMBERED = 3;
export const NETINFO_DLL16 = 1;
export const NETINFO_DISKRED = 4;
export const NETINFO_PRINTERRED = 8;
export const CONNDLG_RO_PATH = 1;
export const CONNDLG_CONN_POINT = 2;
export const CONNDLG_USE_MRU = 4;
export const CONNDLG_HIDE_BOX = 8;
export const CONNDLG_PERSIST = 16;
export const CONNDLG_NOT_PERSIST = 32;
export const DISC_UPDATE_PROFILE = 1;
export const DISC_NO_FORCE = 64;
export const WNGETCON_CONNECTED = 0;
export const WNGETCON_DISCONNECTED = 1;
export const WNNC_SPEC_VERSION = 1;
export const WNNC_SPEC_VERSION51 = 327681;
export const WNNC_NET_TYPE = 2;
export const WNNC_NET_NONE = 0;
export const WNNC_DRIVER_VERSION = 3;
export const WNNC_USER = 4;
export const WNNC_USR_GETUSER = 1;
export const WNNC_CONNECTION = 6;
export const WNNC_CON_ADDCONNECTION = 1;
export const WNNC_CON_CANCELCONNECTION = 2;
export const WNNC_CON_GETCONNECTIONS = 4;
export const WNNC_CON_ADDCONNECTION3 = 8;
export const WNNC_CON_ADDCONNECTION4 = 16;
export const WNNC_CON_CANCELCONNECTION2 = 32;
export const WNNC_CON_GETPERFORMANCE = 64;
export const WNNC_CON_DEFER = 128;
export const WNNC_DIALOG = 8;
export const WNNC_DLG_DEVICEMODE = 1;
export const WNNC_DLG_PROPERTYDIALOG = 32;
export const WNNC_DLG_SEARCHDIALOG = 64;
export const WNNC_DLG_FORMATNETWORKNAME = 128;
export const WNNC_DLG_PERMISSIONEDITOR = 256;
export const WNNC_DLG_GETRESOURCEPARENT = 512;
export const WNNC_DLG_GETRESOURCEINFORMATION = 2048;
export const WNNC_ADMIN = 9;
export const WNNC_ADM_GETDIRECTORYTYPE = 1;
export const WNNC_ADM_DIRECTORYNOTIFY = 2;
export const WNNC_ENUMERATION = 11;
export const WNNC_ENUM_GLOBAL = 1;
export const WNNC_ENUM_LOCAL = 2;
export const WNNC_ENUM_CONTEXT = 4;
export const WNNC_ENUM_SHAREABLE = 8;
export const WNNC_START = 12;
export const WNNC_WAIT_FOR_START = 1;
export const WNNC_CONNECTION_FLAGS = 13;
export const WNTYPE_DRIVE = 1;
export const WNTYPE_FILE = 2;
export const WNTYPE_PRINTER = 3;
export const WNTYPE_COMM = 4;
export const WNSRCH_REFRESH_FIRST_LEVEL = 1;
export const WNDT_NORMAL = 0;
export const WNDT_NETWORK = 1;
export const WN_NETWORK_CLASS = 1;
export const WN_CREDENTIAL_CLASS = 2;
export const WN_PRIMARY_AUTHENT_CLASS = 4;
export const WN_SERVICE_CLASS = 8;
export const WN_VALID_LOGON_ACCOUNT = 1;
export const WN_NT_PASSWORD_CHANGED = 2;
export const NOTIFY_PRE = 1;
export const NOTIFY_POST = 2;
export const WNPERMC_PERM = 1;
export const WNPERMC_AUDIT = 2;
export const WNPERMC_OWNER = 4;
export const RESOURCE_RECENT = 4;
export const RESOURCETYPE_RESERVED = 8;
export const RESOURCETYPE_UNKNOWN = 4294967295;
export const RESOURCEUSAGE_NOLOCALDEVICE = 4;
export const RESOURCEUSAGE_SIBLING = 8;
export const RESOURCEUSAGE_RESERVED = 2147483648;
export const RESOURCEDISPLAYTYPE_NETWORK = 6;
export const RESOURCEDISPLAYTYPE_ROOT = 7;
export const RESOURCEDISPLAYTYPE_SHAREADMIN = 8;
export const RESOURCEDISPLAYTYPE_DIRECTORY = 9;
export const RESOURCEDISPLAYTYPE_NDSCONTAINER = 11;
export const NETPROPERTY_PERSISTENT = 1;
export const CONNECT_NEED_DRIVE = 32;
export const CONNECT_REFCOUNT = 64;
export const CONNECT_LOCALDRIVE = 256;
export const CONNECT_CURRENT_MEDIA = 512;
export const CONNECT_RESERVED = 4278190080;
export const CONNECT_CRED_RESET = 8192;
export const CONNECT_REQUIRE_INTEGRITY = 16384;
export const CONNECT_REQUIRE_PRIVACY = 32768;
export const CONNECT_WRITE_THROUGH_SEMANTICS = 65536;
export const CONNECT_GLOBAL_MAPPING = 262144;
export const WNFMT_INENUM = 16;
export const WNFMT_CONNECTION = 32;
export const WNCON_FORNETCARD = 1;
export const WNCON_NOTROUTED = 2;
export const WNCON_SLOWLINK = 4;
export const WNCON_DYNAMIC = 8;
...
/**
 * Windows.Win32.NetworkManagement.WNet.NETRESOURCEA (size: 48)
 */
export interface NETRESOURCEA {
  /** Windows.Win32.NetworkManagement.WNet.NET_RESOURCE_SCOPE */
  dwScope: NET_RESOURCE_SCOPE;
  /** Windows.Win32.NetworkManagement.WNet.NET_RESOURCE_TYPE */
...
export function allocNETRESOURCEA(data?: Partial<NETRESOURCEA>): Uint8Array {
  const buf = new Uint8Array(sizeofNETRESOURCEA);
  ...
  // 0x08: u32
  if (data?.dwDisplayType !== undefined) view.setUint32(8, Number(data.dwDisplayType), true);
  // 0x0c: u32
  if (data?.dwUsage !== undefined) view.setUint32(12, Number(data.dwUsage), true);
  // 0x10: buffer
...
export class NETRESOURCEAView {
  ...
  // 0x28: buffer
  get lpProvider(): Uint8Array | Deno.PointerValue {
  ...
  // 0x28: buffer
  set lpProvider(value: Uint8Array | Deno.PointerValue) {
...
/**
 * Windows.Win32.NetworkManagement.WNet.NETRESOURCEW (size: 48)
 */
export interface NETRESOURCEW {
  /** Windows.Win32.NetworkManagement.WNet.NET_RESOURCE_SCOPE */
  dwScope: NET_RESOURCE_SCOPE;
  /** Windows.Win32.NetworkManagement.WNet.NET_RESOURCE_TYPE */
  dwType: NET_RESOURCE_TYPE;
...
export function allocNETRESOURCEW(data?: Partial<NETRESOURCEW>): Uint8Array {
  const buf = new Uint8Array(sizeofNETRESOURCEW);
  const view = new DataView(buf.buffer);
  // 0x00: u32
  if (data?.dwScope !== undefined) view.setUint32(0, Number(data.dwScope), true);
  // 0x04: u32
  ...
  // 0x28: buffer
  if (data?.lpProvider !== undefined) {
    (buf as any)._f40 = util.pwstrToFfi(data.lpProvider);
    view.setBigUint64(40, (buf as any)._f40 === null ? 0n : BigInt(Deno.UnsafePointer.value(Deno.UnsafePointer.of((buf as any)._f40))), true);
  }
  return buf;
}

export class NETRESOURCEWView {
  private readonly view: DataView;
  constructor(private readonly buf: Uint8Array) {
    this.view = new DataView(buf.buffer);
  }
 ...
 */
export interface CONNECTDLGSTRUCTA {
  /** u32 */
  cbStructure: number;
  /** Windows.Win32.Foundation.HWND */
  hwndOwner: Deno.PointerValue;
  /** ptr */
  lpConnRes: Deno.PointerValue | Uint8Array;
  /** Windows.Win32.NetworkManagement.WNet.CONNECTDLGSTRUCT_FLAGS */
  dwFlags: CONNECTDLGSTRUCT_FLAGS;
  /** u32 */
  dwDevNum: number;
}

export const sizeofCONNECTDLGSTRUCTA = 32;

export function allocCONNECTDLGSTRUCTA(data?: Partial<CONNECTDLGSTRUCTA>): Uint8Array {
  const buf = new Uint8Array(sizeofCONNECTDLGSTRUCTA);
  const view = new DataView(buf.buffer);
  // 0x00: u32
  if (data?.cbStructure !== undefined) view.setUint32(0, Number(data.cbStructure), true);
  // 0x04: pad4
  // 0x08: pointer
  ...
  // 0x10: pointer
  if (data?.lpConnRes !== undefined) view.setBigUint64(16, data.lpConnRes === null ? 0n : BigInt(Deno.UnsafePointer.value(util.toPointer(data.lpConnRes))), true);
  // 0x18: u32
  if (data?.dwFlags !== undefined) view.setUint32(24, Number(data.dwFlags), true);
  // 0x1c: u32
  if (data?.dwDevNum !== undefined) view.setUint32(28, Number(data.dwDevNum), true);
  return buf;
}

export class CONNECTDLGSTRUCTAView {
  private readonly view: DataView;
  constructor(private readonly buf: Uint8Array) {
    this.view = new DataView(buf.buffer);
  }
  ...
  // 0x10: pointer
  get lpConnRes(): Uint8Array | Deno.PointerValue {
    const ptr = this.view.getBigUint64(16, true);
    return Deno.UnsafePointer.create(ptr);
  }
  ...
  // 0x10: pointer
  set lpConnRes(value: Uint8Array | Deno.PointerValue) {
  ...
  // 0x1c: u32
  set dwDevNum(value: number) {
    this.view.setUint32(28, value, true);
  }
}

/**
 * Windows.Win32.NetworkManagement.WNet.CONNECTDLGSTRUCTW (size: 32)
 */
export interface CONNECTDLGSTRUCTW {
  /** u32 */
  cbStructure: number;
  /** Windows.Win32.Foundation.HWND */
  hwndOwner: Deno.PointerValue;
...
export const sizeofCONNECTDLGSTRUCTW = 32;

export function allocCONNECTDLGSTRUCTW(data?: Partial<CONNECTDLGSTRUCTW>): Uint8Array {
  const buf = new Uint8Array(sizeofCONNECTDLGSTRUCTW);
  const view = new DataView(buf.buffer);
  // 0x00: u32
  if (data?.cbStructure !== undefined) view.setUint32(0, Number(data.cbStructure), true);
  // 0x04: pad4
...
export class CONNECTDLGSTRUCTWView {
  private readonly view: DataView;
  constructor(private readonly buf: Uint8Array) {
    this.view = new DataView(buf.buffer);
  }
...
/**
 * Windows.Win32.NetworkManagement.WNet.DISCDLGSTRUCTA (size: 40)
 */
export interface DISCDLGSTRUCTA {
  /** u32 */
  cbStructure: number;
  /** Windows.Win32.Foundation.HWND */
  hwndOwner: Deno.PointerValue;
...
export const sizeofDISCDLGSTRUCTA = 40;

export function allocDISCDLGSTRUCTA(data?: Partial<DISCDLGSTRUCTA>): Uint8Array {
  const buf = new Uint8Array(sizeofDISCDLGSTRUCTA);
  const view = new DataView(buf.buffer);
  // 0x00: u32
  if (data?.cbStructure !== undefined) view.setUint32(0, Number(data.cbStructure), true);
  // 0x04: pad4
...
export class DISCDLGSTRUCTAView {
  private readonly view: DataView;
  constructor(private readonly buf: Uint8Array) {
    this.view = new DataView(buf.buffer);
  }
...
/**
 * Windows.Win32.NetworkManagement.WNet.DISCDLGSTRUCTW (size: 40)
 */
export interface DISCDLGSTRUCTW {
  /** u32 */
  cbStructure: number;
  /** Windows.Win32.Foundation.HWND */
  hwndOwner: Deno.PointerValue;
...
export const sizeofDISCDLGSTRUCTW = 40;

export function allocDISCDLGSTRUCTW(data?: Partial<DISCDLGSTRUCTW>): Uint8Array {
  const buf = new Uint8Array(sizeofDISCDLGSTRUCTW);
  const view = new DataView(buf.buffer);
  // 0x00: u32
  if (data?.cbStructure !== undefined) view.setUint32(0, Number(data.cbStructure), true);
  // 0x04: pad4
...
export class DISCDLGSTRUCTWView {
  private readonly view: DataView;
  constructor(private readonly buf: Uint8Array) {
    this.view = new DataView(buf.buffer);
  }
...
/**
 * Windows.Win32.NetworkManagement.WNet.UNIVERSAL_NAME_INFOA (size: 8)
 */
...
export function allocUNIVERSAL_NAME_INFOA(data?: Partial<UNIVERSAL_NAME_INFOA>): Uint8Array {
  const buf = new Uint8Array(sizeofUNIVERSAL_NAME_INFOA);
  const view = new DataView(buf.buffer);
  // 0x00: buffer
  if (data?.lpUniversalName !== undefined) {
    (buf as any)._f0 = util.pstrToFfi(data.lpUniversalName);
    view.setBigUint64(0, (buf as any)._f0 === null ? 0n : BigInt(Deno.UnsafePointer.value(Deno.UnsafePointer.of((buf as any)._f0))), true);
  }
  return buf;
}

export class UNIVERSAL_NAME_INFOAView {
  private readonly view: DataView;
  constructor(private readonly buf: Uint8Array) {
    this.view = new DataView(buf.buffer);
  }
  ...
  // 0x00: buffer
  get lpUniversalName(): Uint8Array | Deno.PointerValue {
    const ptr = this.view.getBigUint64(0, true);
    return Deno.UnsafePointer.create(ptr);
  }

  // 0x00: buffer
  set lpUniversalName(value: Uint8Array | Deno.PointerValue) {
...
/**
 * Windows.Win32.NetworkManagement.WNet.UNIVERSAL_NAME_INFOW (size: 8)
 */
...
export function allocUNIVERSAL_NAME_INFOW(data?: Partial<UNIVERSAL_NAME_INFOW>): Uint8Array {
  const buf = new Uint8Array(sizeofUNIVERSAL_NAME_INFOW);
  const view = new DataView(buf.buffer);
  // 0x00: buffer
  if (data?.lpUniversalName !== undefined) {
    (buf as any)._f0 = util.pwstrToFfi(data.lpUniversalName);
    view.setBigUint64(0, (buf as any)._f0 === null ? 0n : BigInt(Deno.UnsafePointer.value(Deno.UnsafePointer.of((buf as any)._f0))), true);
  }
  return buf;
}

export class UNIVERSAL_NAME_INFOWView {
  private readonly view: DataView;
  constructor(private readonly buf: Uint8Array) {
    this.view = new DataView(buf.buffer);
  }
...
/**
 * Windows.Win32.NetworkManagement.WNet.REMOTE_NAME_INFOA (size: 24)
 */
...
export function allocREMOTE_NAME_INFOA(data?: Partial<REMOTE_NAME_INFOA>): Uint8Array {
  const buf = new Uint8Array(sizeofREMOTE_NAME_INFOA);
  const view = new DataView(buf.buffer);
  // 0x00: buffer
  if (data?.lpUniversalName !== undefined) {
    (buf as any)._f0 = util.pstrToFfi(data.lpUniversalName);
  ...
  // 0x08: buffer
  if (data?.lpConnectionName !== undefined) {
    (buf as any)._f8 = util.pstrToFfi(data.lpConnectionName);
    view.setBigUint64(8, (buf as any)._f8 === null ? 0n : BigInt(Deno.UnsafePointer.value(Deno.UnsafePointer.of((buf as any)._f8))), true);
  }
  // 0x10: buffer
  if (data?.lpRemainingPath !== undefined) {
    (buf as any)._f16 = util.pstrToFfi(data.lpRemainingPath);
    view.setBigUint64(16, (buf as any)._f16 === null ? 0n : BigInt(Deno.UnsafePointer.value(Deno.UnsafePointer.of((buf as any)._f16))), true);
  }
  return buf;
}

export class REMOTE_NAME_INFOAView {
  private readonly view: DataView;
  constructor(private readonly buf: Uint8Array) {
    this.view = new DataView(buf.buffer);
  }
  ...
  // 0x08: buffer
  get lpConnectionName(): Uint8Array | Deno.PointerValue {
    const ptr = this.view.getBigUint64(8, true);
    return Deno.UnsafePointer.create(ptr);
  }

  // 0x10: buffer
  get lpRemainingPath(): Uint8Array | Deno.PointerValue {
    const ptr = this.view.getBigUint64(16, true);
    return Deno.UnsafePointer.create(ptr);
  }
  ...
  // 0x08: buffer
  set lpConnectionName(value: Uint8Array | Deno.PointerValue) {
    (this.buf as any)._f8 = value;
    this.view.setBigUint64(8, BigInt(Deno.UnsafePointer.value(util.toPointer((this.buf as any)._f8))), true);
  }

  // 0x10: buffer
  set lpRemainingPath(value: Uint8Array | Deno.PointerValue) {
    (this.buf as any)._f16 = value;
    this.view.setBigUint64(16, BigInt(Deno.UnsafePointer.value(util.toPointer((this.buf as any)._f16))), true);
  }
}
...
/**
 * Windows.Win32.NetworkManagement.WNet.REMOTE_NAME_INFOW (size: 24)
 */
...
export function allocREMOTE_NAME_INFOW(data?: Partial<REMOTE_NAME_INFOW>): Uint8Array {
  const buf = new Uint8Array(sizeofREMOTE_NAME_INFOW);
  const view = new DataView(buf.buffer);
  // 0x00: buffer
  if (data?.lpUniversalName !== undefined) {
    (buf as any)._f0 = util.pwstrToFfi(data.lpUniversalName);
  ...
  // 0x08: buffer
  if (data?.lpConnectionName !== undefined) {
    (buf as any)._f8 = util.pwstrToFfi(data.lpConnectionName);
    view.setBigUint64(8, (buf as any)._f8 === null ? 0n : BigInt(Deno.UnsafePointer.value(Deno.UnsafePointer.of((buf as any)._f8))), true);
  }
  // 0x10: buffer
  if (data?.lpRemainingPath !== undefined) {
    (buf as any)._f16 = util.pwstrToFfi(data.lpRemainingPath);
    view.setBigUint64(16, (buf as any)._f16 === null ? 0n : BigInt(Deno.UnsafePointer.value(Deno.UnsafePointer.of((buf as any)._f16))), true);
  }
  return buf;
}

export class REMOTE_NAME_INFOWView {
  private readonly view: DataView;
  constructor(private readonly buf: Uint8Array) {
    this.view = new DataView(buf.buffer);
  }
...
/**
 * Windows.Win32.NetworkManagement.WNet.NETINFOSTRUCT (size: 40)
 */
export interface NETINFOSTRUCT {
  /** u32 */
  cbStructure: number;
  /** u32 */
  dwProviderVersion: number;
...
export const sizeofNETINFOSTRUCT = 40;

export function allocNETINFOSTRUCT(data?: Partial<NETINFOSTRUCT>): Uint8Array {
  const buf = new Uint8Array(sizeofNETINFOSTRUCT);
  const view = new DataView(buf.buffer);
  // 0x00: u32
  if (data?.cbStructure !== undefined) view.setUint32(0, Number(data.cbStructure), true);
  // 0x04: u32
  if (data?.dwProviderVersion !== undefined) view.setUint32(4, Number(data.dwProviderVersion), true);
  // 0x08: u32
  if (data?.dwStatus !== undefined) view.setUint32(8, Number(data.dwStatus), true);
  // 0x0c: u32
  if (data?.dwCharacteristics !== undefined) view.setUint32(12, Number(data.dwCharacteristics), true);
  // 0x10: usize
  if (data?.dwHandle !== undefined) view.setBigUint64(16, BigInt(data.dwHandle), true);
  // 0x18: u16
  if (data?.wNetType !== undefined) view.setUint16(24, Number(data.wNetType), true);
  // 0x1a: u32
  if (data?.dwPrinters !== undefined) view.setUint32(26, Number(data.dwPrinters), true);
  // 0x1e: u32
  if (data?.dwDrives !== undefined) view.setUint32(30, Number(data.dwDrives), true);
  // 0x22: pad6
  return buf;
}

export class NETINFOSTRUCTView {
  private readonly view: DataView;
  constructor(private readonly buf: Uint8Array) {
    this.view = new DataView(buf.buffer);
  }
  ...
  // 0x04: u32
  set dwProviderVersion(value: number) {
    this.view.setUint32(4, value, true);
  }
  ...
  // 0x0c: u32
  set dwCharacteristics(value: number) {
    this.view.setUint32(12, value, true);
  }
  ...
  // 0x18: u16
  set wNetType(value: number) {
    this.view.setUint16(24, value, true);
  }

  // 0x1a: u32
  set dwPrinters(value: number) {
    this.view.setUint32(26, value, true);
  }

  // 0x1e: u32
  set dwDrives(value: number) {
...
/**
 * Windows.Win32.NetworkManagement.WNet.NETCONNECTINFOSTRUCT (size: 24)
 */
export interface NETCONNECTINFOSTRUCT {
  /** u32 */
  cbStructure: number;
  /** u32 */
  dwFlags: number;
  ...
  dwDelay: number;
  /** u32 */
  dwOptDataSize: number;
}

export const sizeofNETCONNECTINFOSTRUCT = 24;

export function allocNETCONNECTINFOSTRUCT(data?: Partial<NETCONNECTINFOSTRUCT>): Uint8Array {
  const buf = new Uint8Array(sizeofNETCONNECTINFOSTRUCT);
  const view = new DataView(buf.buffer);
  // 0x00: u32
  if (data?.cbStructure !== undefined) view.setUint32(0, Number(data.cbStructure), true);
  // 0x04: u32
  ...
  // 0x08: u32
  if (data?.dwSpeed !== undefined) view.setUint32(8, Number(data.dwSpeed), true);
  // 0x0c: u32
  if (data?.dwDelay !== undefined) view.setUint32(12, Number(data.dwDelay), true);
  // 0x10: u32
  if (data?.dwOptDataSize !== undefined) view.setUint32(16, Number(data.dwOptDataSize), true);
  // 0x14: pad4
  return buf;
}

export class NETCONNECTINFOSTRUCTView {
  private readonly view: DataView;
  constructor(private readonly buf: Uint8Array) {
    this.view = new DataView(buf.buffer);
  }
  ...
  // 0x10: u32
  set dwOptDataSize(value: number) {
...
/**
 * Windows.Win32.NetworkManagement.WNet.NOTIFYINFO (size: 16)
 */
export interface NOTIFYINFO {
  /** u32 */
  dwNotifyStatus: number;
  /** u32 */
  dwOperationStatus: number;
  /** ptr */
  lpContext: Deno.PointerValue | Uint8Array;
}

export const sizeofNOTIFYINFO = 16;

export function allocNOTIFYINFO(data?: Partial<NOTIFYINFO>): Uint8Array {
  const buf = new Uint8Array(sizeofNOTIFYINFO);
  const view = new DataView(buf.buffer);
  // 0x00: u32
  if (data?.dwNotifyStatus !== undefined) view.setUint32(0, Number(data.dwNotifyStatus), true);
  // 0x04: u32
  if (data?.dwOperationStatus !== undefined) view.setUint32(4, Number(data.dwOperationStatus), true);
  // 0x08: pointer
  if (data?.lpContext !== undefined) view.setBigUint64(8, data.lpContext === null ? 0n : BigInt(Deno.UnsafePointer.value(util.toPointer(data.lpContext))), true);
  return buf;
}

export class NOTIFYINFOView {
  private readonly view: DataView;
  constructor(private readonly buf: Uint8Array) {
    this.view = new DataView(buf.buffer);
  }
  ...
  // 0x00: u32
  get dwNotifyStatus(): number {
    return this.view.getUint32(0, true);
  }

  // 0x04: u32
  get dwOperationStatus(): number {
    return this.view.getUint32(4, true);
  }
  ...
  // 0x00: u32
  set dwNotifyStatus(value: number) {
    this.view.setUint32(0, value, true);
  }

  // 0x04: u32
  set dwOperationStatus(value: number) {
    this.view.setUint32(4, value, true);
  }
...
/**
 * Windows.Win32.NetworkManagement.WNet.NOTIFYADD (size: 24)
 */
export interface NOTIFYADD {
  /** Windows.Win32.Foundation.HWND */
  hwndOwner: Deno.PointerValue;
  /** Windows.Win32.NetworkManagement.WNet.NETRESOURCEA */
  NetResource: Uint8Array | Deno.PointerValue;
  /** Windows.Win32.NetworkManagement.WNet.NET_USE_CONNECT_FLAGS */
  dwAddFlags: NET_USE_CONNECT_FLAGS;
}

export const sizeofNOTIFYADD = 24;

export function allocNOTIFYADD(data?: Partial<NOTIFYADD>): Uint8Array {
  const buf = new Uint8Array(sizeofNOTIFYADD);
  const view = new DataView(buf.buffer);
  // 0x00: pointer
  if (data?.hwndOwner !== undefined) view.setBigUint64(0, data.hwndOwner === null ? 0n : BigInt(Deno.UnsafePointer.value(util.toPointer(data.hwndOwner))), true);
  // 0x08: pointer
  if (data?.NetResource !== undefined) view.setBigUint64(8, data.NetResource === null ? 0n : BigInt(Deno.UnsafePointer.value(util.toPointer(data.NetResource))), true);
  // 0x10: u32
  if (data?.dwAddFlags !== undefined) view.setUint32(16, Number(data.dwAddFlags), true);
  // 0x14: pad4
  return buf;
}

export class NOTIFYADDView {
  private readonly view: DataView;
  constructor(private readonly buf: Uint8Array) {
    this.view = new DataView(buf.buffer);
  }
  ...
  // 0x08: pointer
  get NetResource(): Uint8Array | Deno.PointerValue {
    const ptr = this.view.getBigUint64(8, true);
    return Deno.UnsafePointer.create(ptr);
  }

  // 0x10: u32
  get dwAddFlags(): number {
    return this.view.getUint32(16, true);
  }
  ...
  // 0x08: pointer
  set NetResource(value: Uint8Array | Deno.PointerValue) {
    this.view.setBigUint64(8, BigInt(Deno.UnsafePointer.value(util.toPointer(value))), true);
  }

  // 0x10: u32
  set dwAddFlags(value: number) {
    this.view.setUint32(16, value, true);
  }
...
/**
 * Windows.Win32.NetworkManagement.WNet.NOTIFYCANCEL (size: 24)
 */
...
export const sizeofNOTIFYCANCEL = 24;

export function allocNOTIFYCANCEL(data?: Partial<NOTIFYCANCEL>): Uint8Array {
  const buf = new Uint8Array(sizeofNOTIFYCANCEL);
  const view = new DataView(buf.buffer);
  // 0x00: buffer
  if (data?.lpName !== undefined) {
    (buf as any)._f0 = util.pwstrToFfi(data.lpName);
    view.setBigUint64(0, (buf as any)._f0 === null ? 0n : BigInt(Deno.UnsafePointer.value(Deno.UnsafePointer.of((buf as any)._f0))), true);
  }
  // 0x08: buffer
  if (data?.lpProvider !== undefined) {
    (buf as any)._f8 = util.pwstrToFfi(data.lpProvider);
    view.setBigUint64(8, (buf as any)._f8 === null ? 0n : BigInt(Deno.UnsafePointer.value(Deno.UnsafePointer.of((buf as any)._f8))), true);
  }
  // 0x10: u32
  if (data?.dwFlags !== undefined) view.setUint32(16, Number(data.dwFlags), true);
  // 0x14: i32
  if (data?.fForce !== undefined) view.setInt32(20, Number(data.fForce), true);
  return buf;
}

export class NOTIFYCANCELView {
  private readonly view: DataView;
  constructor(private readonly buf: Uint8Array) {
    this.view = new DataView(buf.buffer);
  }
...
try {
  var libMPR_dll = Deno.dlopen("MPR.dll", {
    WNetAddConnectionA: {
    ...
    WNetUseConnectionA: {
      parameters: ["pointer", "pointer", "buffer", "buffer", "u32", "buffer", "pointer", "pointer"],
      result: "u32",
      optional: true,
    },
    WNetUseConnectionW: {
    ...
    WNetUseConnection4A: {
      parameters: ["pointer", "pointer", "pointer", "u32", "u32", "pointer", "u32", "buffer", "pointer", "pointer"],
      result: "u32",
      optional: true,
    },
    WNetUseConnection4W: {
...
export function WNetAddConnection2A(
  lpNetResource: Deno.PointerValue | Uint8Array /* ptr */,
  lpPassword: string | null | Uint8Array /* Windows.Win32.Foundation.PSTR */,
...
export function WNetAddConnection3A(
  ...
  return libMPR_dll.WNetAddConnection3A!((hwndOwner), util.toPointer(lpNetResource), util.pstrToFfi(lpPassword), util.pstrToFfi(lpUserName), dwFlags);
}
...
export function WNetAddConnection3W(
  ...
  return libMPR_dll.WNetAddConnection3W!((hwndOwner), util.toPointer(lpNetResource), util.pwstrToFfi(lpPassword), util.pwstrToFfi(lpUserName), dwFlags);
}

export function WNetAddConnection4A(
  hwndOwner: Deno.PointerValue /* Windows.Win32.Foundation.HWND */,
  lpNetResource: Deno.PointerValue | Uint8Array /* ptr */,
  pAuthBuffer: Deno.PointerValue | Uint8Array /* ptr */,
  cbAuthBuffer: number /* u32 */,
  dwFlags: number /* u32 */,
  lpUseOptions: Deno.PointerValue | Uint8Array /* ptr */,
  cbUseOptions: number /* u32 */,
): number /* u32 */ {
  return libMPR_dll.WNetAddConnection4A!((hwndOwner), util.toPointer(lpNetResource), util.toPointer(pAuthBuffer), cbAuthBuffer, dwFlags, util.toPointer(lpUseOptions), cbUseOptions);
}

export function WNetAddConnection4W(
  hwndOwner: Deno.PointerValue /* Windows.Win32.Foundation.HWND */,
  lpNetResource: Deno.PointerValue | Uint8Array /* ptr */,
  pAuthBuffer: Deno.PointerValue | Uint8Array /* ptr */,
  cbAuthBuffer: number /* u32 */,
  ...
  return libMPR_dll.WNetAddConnection4W!((hwndOwner), util.toPointer(lpNetResource), util.toPointer(pAuthBuffer), cbAuthBuffer, dwFlags, util.toPointer(lpUseOptions), cbUseOptions);
}
...
export function WNetCancelConnection2A(
  ...
  return libMPR_dll.WNetCancelConnection2A!(util.pstrToFfi(lpName), dwFlags, util.boolToFfi(fForce));
}
...
export function WNetCancelConnection2W(
  ...
  return libMPR_dll.WNetCancelConnection2W!(util.pwstrToFfi(lpName), dwFlags, util.boolToFfi(fForce));
}

export function WNetGetConnectionA(
  lpLocalName: string | null | Uint8Array /* Windows.Win32.Foundation.PSTR */,
  lpRemoteName: string | null | Uint8Array /* Windows.Win32.Foundation.PSTR */,
  lpnLength: Deno.PointerValue | Uint8Array /* ptr */,
): number /* u32 */ {
...
export function WNetUseConnectionA(
  ...
  lpBufferSize: Deno.PointerValue | Uint8Array /* ptr */,
  lpResult: Deno.PointerValue | Uint8Array /* ptr */,
): number /* u32 */ {
  return libMPR_dll.WNetUseConnectionA!((hwndOwner), util.toPointer(lpNetResource), util.pstrToFfi(lpPassword), util.pstrToFfi(lpUserId), dwFlags, util.pstrToFfi(lpAccessName), util.toPointer(lpBufferSize), util.toPointer(lpResult));
}
...
export function WNetUseConnectionW(
  ...
  return libMPR_dll.WNetUseConnectionW!((hwndOwner), util.toPointer(lpNetResource), util.pwstrToFfi(lpPassword), util.pwstrToFfi(lpUserId), dwFlags, util.pwstrToFfi(lpAccessName), util.toPointer(lpBufferSize), util.toPointer(lpResult));
}

export function WNetUseConnection4A(
  hwndOwner: Deno.PointerValue /* Windows.Win32.Foundation.HWND */,
  lpNetResource: Deno.PointerValue | Uint8Array /* ptr */,
  pAuthBuffer: Deno.PointerValue | Uint8Array /* ptr */,
  cbAuthBuffer: number /* u32 */,
  ...
  return libMPR_dll.WNetUseConnection4A!((hwndOwner), util.toPointer(lpNetResource), util.toPointer(pAuthBuffer), cbAuthBuffer, dwFlags, util.toPointer(lpUseOptions), cbUseOptions, util.pstrToFfi(lpAccessName), util.toPointer(lpBufferSize), util.toPointer(lpResult));
}

export function WNetUseConnection4W(
  hwndOwner: Deno.PointerValue /* Windows.Win32.Foundation.HWND */,
  lpNetResource: Deno.PointerValue | Uint8Array /* ptr */,
  pAuthBuffer: Deno.PointerValue | Uint8Array /* ptr */,
  cbAuthBuffer: number /* u32 */,
  ...
  return libMPR_dll.WNetUseConnection4W!((hwndOwner), util.toPointer(lpNetResource), util.toPointer(pAuthBuffer), cbAuthBuffer, dwFlags, util.toPointer(lpUseOptions), cbUseOptions, util.pwstrToFfi(lpAccessName), util.toPointer(lpBufferSize), util.toPointer(lpResult));
}

export function WNetConnectionDialog(
  hwnd: Deno.PointerValue /* Windows.Win32.Foundation.HWND */,
  dwType: number /* u32 */,
): number /* u32 */ {
  return libMPR_dll.WNetConnectionDialog!((hwnd), dwType);
}

export function WNetDisconnectDialog(
  hwnd: Deno.PointerValue /* Windows.Win32.Foundation.HWND */,
  dwType: number /* u32 */,
): number /* u32 */ {
  return libMPR_dll.WNetDisconnectDialog!((hwnd), dwType);
}

export function WNetConnectionDialog1A(
  lpConnDlgStruct: Deno.PointerValue | Uint8Array /* ptr */,
): number /* u32 */ {
  return libMPR_dll.WNetConnectionDialog1A!(util.toPointer(lpConnDlgStruct));
}

export function WNetConnectionDialog1W(
  lpConnDlgStruct: Deno.PointerValue | Uint8Array /* ptr */,
): number /* u32 */ {
  return libMPR_dll.WNetConnectionDialog1W!(util.toPointer(lpConnDlgStruct));
}

export function WNetDisconnectDialog1A(
  lpConnDlgStruct: Deno.PointerValue | Uint8Array /* ptr */,
): number /* u32 */ {
  return libMPR_dll.WNetDisconnectDialog1A!(util.toPointer(lpConnDlgStruct));
}

export function WNetDisconnectDialog1W(
  lpConnDlgStruct: Deno.PointerValue | Uint8Array /* ptr */,
): number /* u32 */ {
  return libMPR_dll.WNetDisconnectDialog1W!(util.toPointer(lpConnDlgStruct));
}

export function WNetOpenEnumA(
  dwScope: NET_RESOURCE_SCOPE /* Windows.Win32.NetworkManagement.WNet.NET_RESOURCE_SCOPE */,
  dwType: NET_RESOURCE_TYPE /* Windows.Win32.NetworkManagement.WNet.NET_RESOURCE_TYPE */,
  dwUsage: WNET_OPEN_ENUM_USAGE /* Windows.Win32.NetworkManagement.WNet.WNET_OPEN_ENUM_USAGE */,
  lpNetResource: Deno.PointerValue | Uint8Array /* ptr */,
  lphEnum: Deno.PointerValue | Uint8Array /* ptr */,
): number /* u32 */ {
  return libMPR_dll.WNetOpenEnumA!(dwScope, dwType, dwUsage, util.toPointer(lpNetResource), util.toPointer(lphEnum));
}

export function WNetOpenEnumW(
  dwScope: NET_RESOURCE_SCOPE /* Windows.Win32.NetworkManagement.WNet.NET_RESOURCE_SCOPE */,
  dwType: NET_RESOURCE_TYPE /* Windows.Win32.NetworkManagement.WNet.NET_RESOURCE_TYPE */,
  dwUsage: WNET_OPEN_ENUM_USAGE /* Windows.Win32.NetworkManagement.WNet.WNET_OPEN_ENUM_USAGE */,
  lpNetResource: Deno.PointerValue | Uint8Array /* ptr */,
  ...
  return libMPR_dll.WNetOpenEnumW!(dwScope, dwType, dwUsage, util.toPointer(lpNetResource), util.toPointer(lphEnum));
}

export function WNetEnumResourceA(
  hEnum: Uint8Array | Deno.PointerValue /* Windows.Win32.Foundation.HANDLE */,
  lpcCount: Deno.PointerValue | Uint8Array /* ptr */,
  lpBuffer: Deno.PointerValue | Uint8Array /* ptr */,
  lpBufferSize: Deno.PointerValue | Uint8Array /* ptr */,
): number /* u32 */ {
  return libMPR_dll.WNetEnumResourceA!(util.toPointer(hEnum), util.toPointer(lpcCount), util.toPointer(lpBuffer), util.toPointer(lpBufferSize));
}

export function WNetEnumResourceW(
  hEnum: Uint8Array | Deno.PointerValue /* Windows.Win32.Foundation.HANDLE */,
  lpcCount: Deno.PointerValue | Uint8Array /* ptr */,
  lpBuffer: Deno.PointerValue | Uint8Array /* ptr */,
  lpBufferSize: Deno.PointerValue | Uint8Array /* ptr */,
): number /* u32 */ {
  return libMPR_dll.WNetEnumResourceW!(util.toPointer(hEnum), util.toPointer(lpcCount), util.toPointer(lpBuffer), util.toPointer(lpBufferSize));
}

export function WNetCloseEnum(
  hEnum: Uint8Array | Deno.PointerValue /* Windows.Win32.Foundation.HANDLE */,
): number /* u32 */ {
  return libMPR_dll.WNetCloseEnum!(util.toPointer(hEnum));
}

export function WNetGetResourceParentA(
  lpNetResource: Deno.PointerValue | Uint8Array /* ptr */,
  lpBuffer: Deno.PointerValue | Uint8Array /* ptr */,
  lpcbBuffer: Deno.PointerValue | Uint8Array /* ptr */,
): number /* u32 */ {
  return libMPR_dll.WNetGetResourceParentA!(util.toPointer(lpNetResource), util.toPointer(lpBuffer), util.toPointer(lpcbBuffer));
}

export function WNetGetResourceParentW(
  lpNetResource: Deno.PointerValue | Uint8Array /* ptr */,
  lpBuffer: Deno.PointerValue | Uint8Array /* ptr */,
  lpcbBuffer: Deno.PointerValue | Uint8Array /* ptr */,
): number /* u32 */ {
  return libMPR_dll.WNetGetResourceParentW!(util.toPointer(lpNetResource), util.toPointer(lpBuffer), util.toPointer(lpcbBuffer));
}

export function WNetGetResourceInformationA(
  lpNetResource: Deno.PointerValue | Uint8Array /* ptr */,
  lpBuffer: Deno.PointerValue | Uint8Array /* ptr */,
  lpcbBuffer: Deno.PointerValue | Uint8Array /* ptr */,
  lplpSystem: Deno.PointerValue | Uint8Array /* ptr */,
): number /* u32 */ {
  return libMPR_dll.WNetGetResourceInformationA!(util.toPointer(lpNetResource), util.toPointer(lpBuffer), util.toPointer(lpcbBuffer), util.toPointer(lplpSystem));
}

export function WNetGetResourceInformationW(
  lpNetResource: Deno.PointerValue | Uint8Array /* ptr */,
  lpBuffer: Deno.PointerValue | Uint8Array /* ptr */,
  lpcbBuffer: Deno.PointerValue | Uint8Array /* ptr */,
  lplpSystem: Deno.PointerValue | Uint8Array /* ptr */,
): number /* u32 */ {
  return libMPR_dll.WNetGetResourceInformationW!(util.toPointer(lpNetResource), util.toPointer(lpBuffer), util.toPointer(lpcbBuffer), util.toPointer(lplpSystem));
}
...
export function WNetGetUniversalNameA(
  ...
  return libMPR_dll.WNetGetUniversalNameA!(util.pstrToFfi(lpLocalPath), dwInfoLevel, util.toPointer(lpBuffer), util.toPointer(lpBufferSize));
}
...
export function WNetGetUniversalNameW(
  ...
  return libMPR_dll.WNetGetUniversalNameW!(util.pwstrToFfi(lpLocalPath), dwInfoLevel, util.toPointer(lpBuffer), util.toPointer(lpBufferSize));
}
...
export function WNetGetNetworkInformationA(
  ...
  lpNetInfoStruct: Deno.PointerValue | Uint8Array /* ptr */,
): number /* u32 */ {
...
export function MultinetGetConnectionPerformanceA(
  lpNetResource: Deno.PointerValue | Uint8Array /* ptr */,
  lpNetConnectInfoStruct: Deno.PointerValue | Uint8Array /* ptr */,
): number /* u32 */ {
  return libMPR_dll.MultinetGetConnectionPerformanceA!(util.toPointer(lpNetResource), util.toPointer(lpNetConnectInfoStruct));
}

export function MultinetGetConnectionPerformanceW(
  lpNetResource: Deno.PointerValue | Uint8Array /* ptr */,
  lpNetConnectInfoStruct: Deno.PointerValue | Uint8Array /* ptr */,
): number /* u32 */ {
  return libMPR_dll.MultinetGetConnectionPerformanceW!(util.toPointer(lpNetResource), util.toPointer(lpNetConnectInfoStruct));
}
...
export function NPAddConnection3(
  ...
  return libdavclnt_dll.NPAddConnection3!((hwndOwner), util.toPointer(lpNetResource), util.pwstrToFfi(lpPassword), util.pwstrToFfi(lpUserName), dwFlags);
}

export function NPAddConnection4(
  hwndOwner: Deno.PointerValue /* Windows.Win32.Foundation.HWND */,
  lpNetResource: Deno.PointerValue | Uint8Array /* ptr */,
  lpAuthBuffer: Deno.PointerValue | Uint8Array /* ptr */,
  cbAuthBuffer: number /* u32 */,
  dwFlags: number /* u32 */,
  lpUseOptions: Deno.PointerValue | Uint8Array /* ptr */,
  cbUseOptions: number /* u32 */,
): number /* u32 */ {
  return libNTLANMAN_dll.NPAddConnection4!((hwndOwner), util.toPointer(lpNetResource), util.toPointer(lpAuthBuffer), cbAuthBuffer, dwFlags, util.toPointer(lpUseOptions), cbUseOptions);
}
...
export function NPCancelConnection2(
  ...
  return libNTLANMAN_dll.NPCancelConnection2!(util.pwstrToFfi(lpName), util.boolToFfi(fForce), dwFlags);
}

export function NPGetConnection(
  lpLocalName: string | null | Uint8Array | Uint16Array /* Windows.Win32.Foundation.PWSTR */,
  lpRemoteName: string | null | Uint8Array | Uint16Array /* Windows.Win32.Foundation.PWSTR */,
  lpnBufferLen: Deno.PointerValue | Uint8Array /* ptr */,
): number /* u32 */ {
...
export function NPGetConnection3(
  ...
  return libNTLANMAN_dll.NPGetConnection3!(util.pwstrToFfi(lpLocalName), dwLevel, util.toPointer(lpBuffer), util.toPointer(lpBufferSize));
}
...
export function NPGetUniversalName(
  ...
  return libdavclnt_dll.NPGetUniversalName!(util.pwstrToFfi(lpLocalPath), dwInfoLevel, util.toPointer(lpBuffer), util.toPointer(lpBufferSize));
}

export function NPGetConnectionPerformance(
  lpRemoteName: string | null | Uint8Array | Uint16Array /* Windows.Win32.Foundation.PWSTR */,
  lpNetConnectInfo: Deno.PointerValue | Uint8Array /* ptr */,
): number /* u32 */ {
  return libNTLANMAN_dll.NPGetConnectionPerformance!(util.pwstrToFfi(lpRemoteName), util.toPointer(lpNetConnectInfo));
}

export function NPOpenEnum(
  dwScope: number /* u32 */,
  dwType: number /* u32 */,
  dwUsage: number /* u32 */,
  lpNetResource: Deno.PointerValue | Uint8Array /* ptr */,
  ...
  return libdavclnt_dll.NPOpenEnum!(dwScope, dwType, dwUsage, util.toPointer(lpNetResource), util.toPointer(lphEnum));
}

export function NPEnumResource(
  hEnum: Uint8Array | Deno.PointerValue /* Windows.Win32.Foundation.HANDLE */,
  lpcCount: Deno.PointerValue | Uint8Array /* ptr */,
  lpBuffer: Deno.PointerValue | Uint8Array /* ptr */,
  lpBufferSize: Deno.PointerValue | Uint8Array /* ptr */,
): number /* u32 */ {
  return libdavclnt_dll.NPEnumResource!(util.toPointer(hEnum), util.toPointer(lpcCount), util.toPointer(lpBuffer), util.toPointer(lpBufferSize));
}

export function NPCloseEnum(
  hEnum: Uint8Array | Deno.PointerValue /* Windows.Win32.Foundation.HANDLE */,
): number /* u32 */ {
  return libdavclnt_dll.NPCloseEnum!(util.toPointer(hEnum));
}

export function NPGetCaps(
  ndex: number /* u32 */,
): number /* u32 */ {
  return libdavclnt_dll.NPGetCaps!(ndex);
}
...
export function NPGetPersistentUseOptionsForConnection(
  ...
  lpReadUseOptions: Deno.PointerValue | Uint8Array /* ptr */,
  cbReadUseOptions: number /* u32 */,
  lpWriteUseOptions: Deno.PointerValue | Uint8Array /* ptr */,
  lpSizeWriteUseOptions: Deno.PointerValue | Uint8Array /* ptr */,
): number /* u32 */ {
  return libNTLANMAN_dll.NPGetPersistentUseOptionsForConnection!(util.pwstrToFfi(lpRemotePath), util.toPointer(lpReadUseOptions), cbReadUseOptions, util.toPointer(lpWriteUseOptions), util.toPointer(lpSizeWriteUseOptions));
}

export function NPGetResourceParent(
  lpNetResource: Deno.PointerValue | Uint8Array /* ptr */,
  lpBuffer: Deno.PointerValue | Uint8Array /* ptr */,
  lpBufferSize: Deno.PointerValue | Uint8Array /* ptr */,
): number /* u32 */ {
  return libdavclnt_dll.NPGetResourceParent!(util.toPointer(lpNetResource), util.toPointer(lpBuffer), util.toPointer(lpBufferSize));
}

export function NPGetResourceInformation(
  lpNetResource: Deno.PointerValue | Uint8Array /* ptr */,
  lpBuffer: Deno.PointerValue | Uint8Array /* ptr */,
  lpBufferSize: Deno.PointerValue | Uint8Array /* ptr */,
  lplpSystem: Deno.PointerValue | Uint8Array /* ptr */,
): number /* u32 */ {
  return libdavclnt_dll.NPGetResourceInformation!(util.toPointer(lpNetResource), util.toPointer(lpBuffer), util.toPointer(lpBufferSize), util.toPointer(lplpSystem));
}
...
export function NPFormatNetworkName(
  ...
  return libdavclnt_dll.NPFormatNetworkName!(util.pwstrToFfi(lpRemoteName), util.pwstrToFfi(lpFormattedName), util.toPointer(lpnLength), dwFlags, dwAveCharPerLine);
}
