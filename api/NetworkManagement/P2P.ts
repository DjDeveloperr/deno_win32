...
try {
  var libP2PGRAPH = Deno.dlopen("P2PGRAPH", {
    PeerGraphStartup: {
...
try {
  var libdrtprov = Deno.dlopen("drtprov", {
...
try {
  var libdrttransport = Deno.dlopen("drttransport", {
...
try {
  var libPeerDist = Deno.dlopen("PeerDist", {
    PeerDistStartup: {
...
export function PeerGraphStartup(
  ...
  return util.pointerFromFfi(libP2PGRAPH.PeerGraphStartup(wVersionRequested, util.toPointer(pVersionData)));
}

export function PeerGraphShutdown(): Deno.PointerValue | null /* Windows.Win32.Foundation.HRESULT */ {
  return util.pointerFromFfi(libP2PGRAPH.PeerGraphShutdown());
}

export function PeerGraphFreeData(
  pvData: Deno.PointerValue | Uint8Array | null /* ptr */,
): void /* void */ {
  return libP2PGRAPH.PeerGraphFreeData(util.toPointer(pvData));
}
...
export function PeerGraphGetItemCount(
  ...
  return util.pointerFromFfi(libP2PGRAPH.PeerGraphGetItemCount(util.toPointer(hPeerEnum), util.toPointer(pCount)));
}
...
export function PeerGraphGetNextItem(
  ...
  return util.pointerFromFfi(libP2PGRAPH.PeerGraphGetNextItem(util.toPointer(hPeerEnum), util.toPointer(pCount), util.toPointer(pppvItems)));
}

export function PeerGraphEndEnumeration(
  hPeerEnum: Deno.PointerValue | Uint8Array | null /* ptr */,
): Deno.PointerValue | null /* Windows.Win32.Foundation.HRESULT */ {
  return util.pointerFromFfi(libP2PGRAPH.PeerGraphEndEnumeration(util.toPointer(hPeerEnum)));
}
...
export function PeerGraphCreate(
  ...
  return util.pointerFromFfi(libP2PGRAPH.PeerGraphCreate(util.toPointer(pGraphProperties), util.pwstrToFfi(pwzDatabaseName), util.toPointer(pSecurityInterface), util.toPointer(phGraph)));
}
...
export function PeerGraphOpen(
  ...
  return util.pointerFromFfi(libP2PGRAPH.PeerGraphOpen(util.pwstrToFfi(pwzGraphId), util.pwstrToFfi(pwzPeerId), util.pwstrToFfi(pwzDatabaseName), util.toPointer(pSecurityInterface), cRecordTypeSyncPrecedence, util.toPointer(pRecordTypeSyncPrecedence), util.toPointer(phGraph)));
}
...
export function PeerGraphListen(
  ...
  return util.pointerFromFfi(libP2PGRAPH.PeerGraphListen(util.toPointer(hGraph), dwScope, dwScopeId, wPort));
}
...
export function PeerGraphConnect(
  ...
  return util.pointerFromFfi(libP2PGRAPH.PeerGraphConnect(util.toPointer(hGraph), util.pwstrToFfi(pwzPeerId), util.toPointer(pAddress), util.toPointer(pullConnectionId)));
}

export function PeerGraphClose(
  hGraph: Deno.PointerValue | Uint8Array | null /* ptr */,
): Deno.PointerValue | null /* Windows.Win32.Foundation.HRESULT */ {
  return util.pointerFromFfi(libP2PGRAPH.PeerGraphClose(util.toPointer(hGraph)));
}
...
export function PeerGraphDelete(
  ...
  return util.pointerFromFfi(libP2PGRAPH.PeerGraphDelete(util.pwstrToFfi(pwzGraphId), util.pwstrToFfi(pwzPeerId), util.pwstrToFfi(pwzDatabaseName)));
}
...
export function PeerGraphGetStatus(
  ...
  return util.pointerFromFfi(libP2PGRAPH.PeerGraphGetStatus(util.toPointer(hGraph), util.toPointer(pdwStatus)));
}
...
export function PeerGraphGetProperties(
  ...
  return util.pointerFromFfi(libP2PGRAPH.PeerGraphGetProperties(util.toPointer(hGraph), util.toPointer(ppGraphProperties)));
}
...
export function PeerGraphSetProperties(
  ...
  return util.pointerFromFfi(libP2PGRAPH.PeerGraphSetProperties(util.toPointer(hGraph), util.toPointer(pGraphProperties)));
}
...
export function PeerGraphRegisterEvent(
  ...
  return util.pointerFromFfi(libP2PGRAPH.PeerGraphRegisterEvent(util.toPointer(hGraph), util.toPointer(hEvent), cEventRegistrations, util.toPointer(pEventRegistrations), util.toPointer(phPeerEvent)));
}

export function PeerGraphUnregisterEvent(
  hPeerEvent: Deno.PointerValue | Uint8Array | null /* ptr */,
): Deno.PointerValue | null /* Windows.Win32.Foundation.HRESULT */ {
  return util.pointerFromFfi(libP2PGRAPH.PeerGraphUnregisterEvent(util.toPointer(hPeerEvent)));
}
...
export function PeerGraphGetEventData(
  ...
  return util.pointerFromFfi(libP2PGRAPH.PeerGraphGetEventData(util.toPointer(hPeerEvent), util.toPointer(ppEventData)));
}
...
export function PeerGraphGetRecord(
  ...
  return util.pointerFromFfi(libP2PGRAPH.PeerGraphGetRecord(util.toPointer(hGraph), util.toPointer(pRecordId), util.toPointer(ppRecord)));
}
...
export function PeerGraphAddRecord(
  ...
  return util.pointerFromFfi(libP2PGRAPH.PeerGraphAddRecord(util.toPointer(hGraph), util.toPointer(pRecord), util.toPointer(pRecordId)));
}
...
export function PeerGraphUpdateRecord(
  ...
  return util.pointerFromFfi(libP2PGRAPH.PeerGraphUpdateRecord(util.toPointer(hGraph), util.toPointer(pRecord)));
}
...
export function PeerGraphDeleteRecord(
  ...
  return util.pointerFromFfi(libP2PGRAPH.PeerGraphDeleteRecord(util.toPointer(hGraph), util.toPointer(pRecordId), util.boolToFfi(fLocal)));
}
...
export function PeerGraphEnumRecords(
  ...
  return util.pointerFromFfi(libP2PGRAPH.PeerGraphEnumRecords(util.toPointer(hGraph), util.toPointer(pRecordType), util.pwstrToFfi(pwzPeerId), util.toPointer(phPeerEnum)));
}
...
export function PeerGraphSearchRecords(
  ...
  return util.pointerFromFfi(libP2PGRAPH.PeerGraphSearchRecords(util.toPointer(hGraph), util.pwstrToFfi(pwzCriteria), util.toPointer(phPeerEnum)));
}
...
export function PeerGraphExportDatabase(
  ...
  return util.pointerFromFfi(libP2PGRAPH.PeerGraphExportDatabase(util.toPointer(hGraph), util.pwstrToFfi(pwzFilePath)));
}
...
export function PeerGraphImportDatabase(
  ...
  return util.pointerFromFfi(libP2PGRAPH.PeerGraphImportDatabase(util.toPointer(hGraph), util.pwstrToFfi(pwzFilePath)));
}
...
export function PeerGraphValidateDeferredRecords(
  ...
  return util.pointerFromFfi(libP2PGRAPH.PeerGraphValidateDeferredRecords(util.toPointer(hGraph), cRecordIds, util.toPointer(pRecordIds)));
}
...
export function PeerGraphOpenDirectConnection(
  ...
  return util.pointerFromFfi(libP2PGRAPH.PeerGraphOpenDirectConnection(util.toPointer(hGraph), util.pwstrToFfi(pwzPeerId), util.toPointer(pAddress), util.toPointer(pullConnectionId)));
}
...
export function PeerGraphSendData(
  ...
  return util.pointerFromFfi(libP2PGRAPH.PeerGraphSendData(util.toPointer(hGraph), ullConnectionId, util.toPointer(pType), cbData, util.toPointer(pvData)));
}
...
export function PeerGraphCloseDirectConnection(
  ...
  return util.pointerFromFfi(libP2PGRAPH.PeerGraphCloseDirectConnection(util.toPointer(hGraph), ullConnectionId));
}
...
export function PeerGraphEnumConnections(
  ...
  return util.pointerFromFfi(libP2PGRAPH.PeerGraphEnumConnections(util.toPointer(hGraph), dwFlags, util.toPointer(phPeerEnum)));
}
...
export function PeerGraphEnumNodes(
  ...
  return util.pointerFromFfi(libP2PGRAPH.PeerGraphEnumNodes(util.toPointer(hGraph), util.pwstrToFfi(pwzPeerId), util.toPointer(phPeerEnum)));
}
...
export function PeerGraphSetPresence(
  ...
  return util.pointerFromFfi(libP2PGRAPH.PeerGraphSetPresence(util.toPointer(hGraph), util.boolToFfi(fPresent)));
}
...
export function PeerGraphGetNodeInfo(
  ...
  return util.pointerFromFfi(libP2PGRAPH.PeerGraphGetNodeInfo(util.toPointer(hGraph), ullNodeId, util.toPointer(ppNodeInfo)));
}
...
export function PeerGraphSetNodeAttributes(
  ...
  return util.pointerFromFfi(libP2PGRAPH.PeerGraphSetNodeAttributes(util.toPointer(hGraph), util.pwstrToFfi(pwzAttributes)));
}
...
export function PeerGraphPeerTimeToUniversalTime(
  ...
  return util.pointerFromFfi(libP2PGRAPH.PeerGraphPeerTimeToUniversalTime(util.toPointer(hGraph), util.toPointer(pftPeerTime), util.toPointer(pftUniversalTime)));
}
...
export function PeerGraphUniversalTimeToPeerTime(
  ...
  return util.pointerFromFfi(libP2PGRAPH.PeerGraphUniversalTimeToPeerTime(util.toPointer(hGraph), util.toPointer(pftUniversalTime), util.toPointer(pftPeerTime)));
}

export function PeerFreeData(
  pvData: Deno.PointerValue | Uint8Array | null /* ptr */,
): void /* void */ {
  return libP2P.PeerFreeData(util.toPointer(pvData));
}
...
export function PeerGetItemCount(
  ...
  return util.pointerFromFfi(libP2P.PeerGetItemCount(util.toPointer(hPeerEnum), util.toPointer(pCount)));
}
...
export function PeerGetNextItem(
  ...
  return util.pointerFromFfi(libP2P.PeerGetNextItem(util.toPointer(hPeerEnum), util.toPointer(pCount), util.toPointer(pppvItems)));
}

export function PeerEndEnumeration(
  hPeerEnum: Deno.PointerValue | Uint8Array | null /* ptr */,
): Deno.PointerValue | null /* Windows.Win32.Foundation.HRESULT */ {
  return util.pointerFromFfi(libP2P.PeerEndEnumeration(util.toPointer(hPeerEnum)));
}
...
export function PeerGroupStartup(
  ...
  return util.pointerFromFfi(libP2P.PeerGroupStartup(wVersionRequested, util.toPointer(pVersionData)));
}

export function PeerGroupShutdown(): Deno.PointerValue | null /* Windows.Win32.Foundation.HRESULT */ {
  return util.pointerFromFfi(libP2P.PeerGroupShutdown());
}
...
export function PeerGroupCreate(
  ...
  return util.pointerFromFfi(libP2P.PeerGroupCreate(util.toPointer(pProperties), util.toPointer(phGroup)));
}
...
export function PeerGroupOpen(
  ...
  return util.pointerFromFfi(libP2P.PeerGroupOpen(util.pwstrToFfi(pwzIdentity), util.pwstrToFfi(pwzGroupPeerName), util.pwstrToFfi(pwzCloud), util.toPointer(phGroup)));
}
...
export function PeerGroupJoin(
  ...
  return util.pointerFromFfi(libP2P.PeerGroupJoin(util.pwstrToFfi(pwzIdentity), util.pwstrToFfi(pwzInvitation), util.pwstrToFfi(pwzCloud), util.toPointer(phGroup)));
}
...
export function PeerGroupPasswordJoin(
  ...
  return util.pointerFromFfi(libP2P.PeerGroupPasswordJoin(util.pwstrToFfi(pwzIdentity), util.pwstrToFfi(pwzInvitation), util.pwstrToFfi(pwzPassword), util.pwstrToFfi(pwzCloud), util.toPointer(phGroup)));
}

export function PeerGroupConnect(
  hGroup: Deno.PointerValue | Uint8Array | null /* ptr */,
): Deno.PointerValue | null /* Windows.Win32.Foundation.HRESULT */ {
  return util.pointerFromFfi(libP2P.PeerGroupConnect(util.toPointer(hGroup)));
}
...
export function PeerGroupConnectByAddress(
  ...
  return util.pointerFromFfi(libP2P.PeerGroupConnectByAddress(util.toPointer(hGroup), cAddresses, util.toPointer(pAddresses)));
}

export function PeerGroupClose(
  hGroup: Deno.PointerValue | Uint8Array | null /* ptr */,
): Deno.PointerValue | null /* Windows.Win32.Foundation.HRESULT */ {
  return util.pointerFromFfi(libP2P.PeerGroupClose(util.toPointer(hGroup)));
}
...
export function PeerGroupDelete(
  ...
  return util.pointerFromFfi(libP2P.PeerGroupDelete(util.pwstrToFfi(pwzIdentity), util.pwstrToFfi(pwzGroupPeerName)));
}
...
export function PeerGroupCreateInvitation(
  ...
  return util.pointerFromFfi(libP2P.PeerGroupCreateInvitation(util.toPointer(hGroup), util.pwstrToFfi(pwzIdentityInfo), util.toPointer(pftExpiration), cRoles, util.toPointer(pRoles), util.toPointer(ppwzInvitation)));
}
...
export function PeerGroupCreatePasswordInvitation(
  ...
  return util.pointerFromFfi(libP2P.PeerGroupCreatePasswordInvitation(util.toPointer(hGroup), util.toPointer(ppwzInvitation)));
}
...
export function PeerGroupParseInvitation(
  ...
  return util.pointerFromFfi(libP2P.PeerGroupParseInvitation(util.pwstrToFfi(pwzInvitation), util.toPointer(ppInvitationInfo)));
}
...
export function PeerGroupGetStatus(
  ...
  return util.pointerFromFfi(libP2P.PeerGroupGetStatus(util.toPointer(hGroup), util.toPointer(pdwStatus)));
}
...
export function PeerGroupGetProperties(
  ...
  return util.pointerFromFfi(libP2P.PeerGroupGetProperties(util.toPointer(hGroup), util.toPointer(ppProperties)));
}
...
export function PeerGroupSetProperties(
  ...
  return util.pointerFromFfi(libP2P.PeerGroupSetProperties(util.toPointer(hGroup), util.toPointer(pProperties)));
}
...
export function PeerGroupEnumMembers(
  ...
  return util.pointerFromFfi(libP2P.PeerGroupEnumMembers(util.toPointer(hGroup), dwFlags, util.pwstrToFfi(pwzIdentity), util.toPointer(phPeerEnum)));
}
...
export function PeerGroupOpenDirectConnection(
  ...
  return util.pointerFromFfi(libP2P.PeerGroupOpenDirectConnection(util.toPointer(hGroup), util.pwstrToFfi(pwzIdentity), util.toPointer(pAddress), util.toPointer(pullConnectionId)));
}
...
export function PeerGroupCloseDirectConnection(
  ...
  return util.pointerFromFfi(libP2P.PeerGroupCloseDirectConnection(util.toPointer(hGroup), ullConnectionId));
}
...
export function PeerGroupEnumConnections(
  ...
  return util.pointerFromFfi(libP2P.PeerGroupEnumConnections(util.toPointer(hGroup), dwFlags, util.toPointer(phPeerEnum)));
}
...
export function PeerGroupSendData(
  ...
  return util.pointerFromFfi(libP2P.PeerGroupSendData(util.toPointer(hGroup), ullConnectionId, util.toPointer(pType), cbData, util.toPointer(pvData)));
}
...
export function PeerGroupRegisterEvent(
  ...
  return util.pointerFromFfi(libP2P.PeerGroupRegisterEvent(util.toPointer(hGroup), util.toPointer(hEvent), cEventRegistration, util.toPointer(pEventRegistrations), util.toPointer(phPeerEvent)));
}

export function PeerGroupUnregisterEvent(
  hPeerEvent: Deno.PointerValue | Uint8Array | null /* ptr */,
): Deno.PointerValue | null /* Windows.Win32.Foundation.HRESULT */ {
  return util.pointerFromFfi(libP2P.PeerGroupUnregisterEvent(util.toPointer(hPeerEvent)));
}
...
export function PeerGroupGetEventData(
  ...
  return util.pointerFromFfi(libP2P.PeerGroupGetEventData(util.toPointer(hPeerEvent), util.toPointer(ppEventData)));
}
...
export function PeerGroupGetRecord(
  ...
  return util.pointerFromFfi(libP2P.PeerGroupGetRecord(util.toPointer(hGroup), util.toPointer(pRecordId), util.toPointer(ppRecord)));
}
...
export function PeerGroupAddRecord(
  ...
  return util.pointerFromFfi(libP2P.PeerGroupAddRecord(util.toPointer(hGroup), util.toPointer(pRecord), util.toPointer(pRecordId)));
}
...
export function PeerGroupUpdateRecord(
  ...
  return util.pointerFromFfi(libP2P.PeerGroupUpdateRecord(util.toPointer(hGroup), util.toPointer(pRecord)));
}
...
export function PeerGroupDeleteRecord(
  ...
  return util.pointerFromFfi(libP2P.PeerGroupDeleteRecord(util.toPointer(hGroup), util.toPointer(pRecordId)));
}
...
export function PeerGroupEnumRecords(
  ...
  return util.pointerFromFfi(libP2P.PeerGroupEnumRecords(util.toPointer(hGroup), util.toPointer(pRecordType), util.toPointer(phPeerEnum)));
}
...
export function PeerGroupSearchRecords(
  ...
  return util.pointerFromFfi(libP2P.PeerGroupSearchRecords(util.toPointer(hGroup), util.pwstrToFfi(pwzCriteria), util.toPointer(phPeerEnum)));
}
...
export function PeerGroupExportDatabase(
  ...
  return util.pointerFromFfi(libP2P.PeerGroupExportDatabase(util.toPointer(hGroup), util.pwstrToFfi(pwzFilePath)));
}
...
export function PeerGroupImportDatabase(
  ...
  return util.pointerFromFfi(libP2P.PeerGroupImportDatabase(util.toPointer(hGroup), util.pwstrToFfi(pwzFilePath)));
}
...
export function PeerGroupIssueCredentials(
  ...
  return util.pointerFromFfi(libP2P.PeerGroupIssueCredentials(util.toPointer(hGroup), util.pwstrToFfi(pwzSubjectIdentity), util.toPointer(pCredentialInfo), dwFlags, util.toPointer(ppwzInvitation)));
}
...
export function PeerGroupExportConfig(
  ...
  return util.pointerFromFfi(libP2P.PeerGroupExportConfig(util.toPointer(hGroup), util.pwstrToFfi(pwzPassword), util.toPointer(ppwzXML)));
}
...
export function PeerGroupImportConfig(
  ...
  return util.pointerFromFfi(libP2P.PeerGroupImportConfig(util.pwstrToFfi(pwzXML), util.pwstrToFfi(pwzPassword), util.boolToFfi(fOverwrite), util.toPointer(ppwzIdentity), util.toPointer(ppwzGroup)));
}
...
export function PeerGroupPeerTimeToUniversalTime(
  ...
  return util.pointerFromFfi(libP2P.PeerGroupPeerTimeToUniversalTime(util.toPointer(hGroup), util.toPointer(pftPeerTime), util.toPointer(pftUniversalTime)));
}
...
export function PeerGroupUniversalTimeToPeerTime(
  ...
  return util.pointerFromFfi(libP2P.PeerGroupUniversalTimeToPeerTime(util.toPointer(hGroup), util.toPointer(pftUniversalTime), util.toPointer(pftPeerTime)));
}
...
export function PeerGroupResumePasswordAuthentication(
  ...
  return util.pointerFromFfi(libP2P.PeerGroupResumePasswordAuthentication(util.toPointer(hGroup), util.toPointer(hPeerEventHandle)));
}
...
export function PeerIdentityCreate(
  ...
  return util.pointerFromFfi(libP2P.PeerIdentityCreate(util.pwstrToFfi(pwzClassifier), util.pwstrToFfi(pwzFriendlyName), hCryptProv, util.toPointer(ppwzIdentity)));
}
...
export function PeerIdentityGetFriendlyName(
  ...
  return util.pointerFromFfi(libP2P.PeerIdentityGetFriendlyName(util.pwstrToFfi(pwzIdentity), util.toPointer(ppwzFriendlyName)));
}
...
export function PeerIdentitySetFriendlyName(
  ...
  return util.pointerFromFfi(libP2P.PeerIdentitySetFriendlyName(util.pwstrToFfi(pwzIdentity), util.pwstrToFfi(pwzFriendlyName)));
}
...
export function PeerIdentityGetCryptKey(
  ...
  return util.pointerFromFfi(libP2P.PeerIdentityGetCryptKey(util.pwstrToFfi(pwzIdentity), util.toPointer(phCryptProv)));
}

export function PeerIdentityDelete(
  pwzIdentity: string | null /* Windows.Win32.Foundation.PWSTR */,
): Deno.PointerValue | null /* Windows.Win32.Foundation.HRESULT */ {
  return util.pointerFromFfi(libP2P.PeerIdentityDelete(util.pwstrToFfi(pwzIdentity)));
}

export function PeerEnumIdentities(
  phPeerEnum: Deno.PointerValue | Uint8Array | null /* ptr */,
): Deno.PointerValue | null /* Windows.Win32.Foundation.HRESULT */ {
  return util.pointerFromFfi(libP2P.PeerEnumIdentities(util.toPointer(phPeerEnum)));
}
...
export function PeerEnumGroups(
  ...
  return util.pointerFromFfi(libP2P.PeerEnumGroups(util.pwstrToFfi(pwzIdentity), util.toPointer(phPeerEnum)));
}
...
export function PeerCreatePeerName(
  ...
  return util.pointerFromFfi(libP2P.PeerCreatePeerName(util.pwstrToFfi(pwzIdentity), util.pwstrToFfi(pwzClassifier), util.toPointer(ppwzPeerName)));
}
...
export function PeerIdentityGetXML(
  ...
  return util.pointerFromFfi(libP2P.PeerIdentityGetXML(util.pwstrToFfi(pwzIdentity), util.toPointer(ppwzIdentityXML)));
}
...
export function PeerIdentityExport(
  ...
  return util.pointerFromFfi(libP2P.PeerIdentityExport(util.pwstrToFfi(pwzIdentity), util.pwstrToFfi(pwzPassword), util.toPointer(ppwzExportXML)));
}
...
export function PeerIdentityImport(
  ...
  return util.pointerFromFfi(libP2P.PeerIdentityImport(util.pwstrToFfi(pwzImportXML), util.pwstrToFfi(pwzPassword), util.toPointer(ppwzIdentity)));
}

export function PeerIdentityGetDefault(
  ppwzPeerName: Deno.PointerValue | Uint8Array | null /* ptr */,
): Deno.PointerValue | null /* Windows.Win32.Foundation.HRESULT */ {
  return util.pointerFromFfi(libP2P.PeerIdentityGetDefault(util.toPointer(ppwzPeerName)));
}

export function PeerCollabStartup(
  wVersionRequested: number /* u16 */,
): Deno.PointerValue | null /* Windows.Win32.Foundation.HRESULT */ {
  return util.pointerFromFfi(libP2P.PeerCollabStartup(wVersionRequested));
}

export function PeerCollabShutdown(): Deno.PointerValue | null /* Windows.Win32.Foundation.HRESULT */ {
  return util.pointerFromFfi(libP2P.PeerCollabShutdown());
}
...
export function PeerCollabSignin(
  ...
  return util.pointerFromFfi(libP2P.PeerCollabSignin(util.hwndToFfi(hwndParent), dwSigninOptions));
}

export function PeerCollabSignout(
  dwSigninOptions: number /* u32 */,
): Deno.PointerValue | null /* Windows.Win32.Foundation.HRESULT */ {
  return util.pointerFromFfi(libP2P.PeerCollabSignout(dwSigninOptions));
}

export function PeerCollabGetSigninOptions(
  pdwSigninOptions: Deno.PointerValue | Uint8Array | null /* ptr */,
): Deno.PointerValue | null /* Windows.Win32.Foundation.HRESULT */ {
  return util.pointerFromFfi(libP2P.PeerCollabGetSigninOptions(util.toPointer(pdwSigninOptions)));
}
...
export function PeerCollabAsyncInviteContact(
  ...
  return util.pointerFromFfi(libP2P.PeerCollabAsyncInviteContact(util.toPointer(pcContact), util.toPointer(pcEndpoint), util.toPointer(pcInvitation), util.toPointer(hEvent), util.toPointer(phInvitation)));
}
...
export function PeerCollabGetInvitationResponse(
  ...
  return util.pointerFromFfi(libP2P.PeerCollabGetInvitationResponse(util.toPointer(hInvitation), util.toPointer(ppInvitationResponse)));
}

export function PeerCollabCancelInvitation(
  hInvitation: Uint8Array | Deno.PointerValue | null /* Windows.Win32.Foundation.HANDLE */,
): Deno.PointerValue | null /* Windows.Win32.Foundation.HRESULT */ {
  return util.pointerFromFfi(libP2P.PeerCollabCancelInvitation(util.toPointer(hInvitation)));
}

export function PeerCollabCloseHandle(
  hInvitation: Uint8Array | Deno.PointerValue | null /* Windows.Win32.Foundation.HANDLE */,
): Deno.PointerValue | null /* Windows.Win32.Foundation.HRESULT */ {
  return util.pointerFromFfi(libP2P.PeerCollabCloseHandle(util.toPointer(hInvitation)));
}
...
export function PeerCollabInviteContact(
  ...
  return util.pointerFromFfi(libP2P.PeerCollabInviteContact(util.toPointer(pcContact), util.toPointer(pcEndpoint), util.toPointer(pcInvitation), util.toPointer(ppResponse)));
}
...
export function PeerCollabAsyncInviteEndpoint(
  ...
  return util.pointerFromFfi(libP2P.PeerCollabAsyncInviteEndpoint(util.toPointer(pcEndpoint), util.toPointer(pcInvitation), util.toPointer(hEvent), util.toPointer(phInvitation)));
}
...
export function PeerCollabInviteEndpoint(
  ...
  return util.pointerFromFfi(libP2P.PeerCollabInviteEndpoint(util.toPointer(pcEndpoint), util.toPointer(pcInvitation), util.toPointer(ppResponse)));
}

export function PeerCollabGetAppLaunchInfo(
  ppLaunchInfo: Deno.PointerValue | Uint8Array | null /* ptr */,
): Deno.PointerValue | null /* Windows.Win32.Foundation.HRESULT */ {
  return util.pointerFromFfi(libP2P.PeerCollabGetAppLaunchInfo(util.toPointer(ppLaunchInfo)));
}
...
export function PeerCollabRegisterApplication(
  ...
  return util.pointerFromFfi(libP2P.PeerCollabRegisterApplication(util.toPointer(pcApplication), registrationType));
}
...
export function PeerCollabUnregisterApplication(
  ...
  return util.pointerFromFfi(libP2P.PeerCollabUnregisterApplication(util.toPointer(pApplicationId), registrationType));
}
...
export function PeerCollabGetApplicationRegistrationInfo(
  ...
  return util.pointerFromFfi(libP2P.PeerCollabGetApplicationRegistrationInfo(util.toPointer(pApplicationId), registrationType, util.toPointer(ppApplication)));
}
...
export function PeerCollabEnumApplicationRegistrationInfo(
  ...
  return util.pointerFromFfi(libP2P.PeerCollabEnumApplicationRegistrationInfo(registrationType, util.toPointer(phPeerEnum)));
}
...
export function PeerCollabGetPresenceInfo(
  ...
  return util.pointerFromFfi(libP2P.PeerCollabGetPresenceInfo(util.toPointer(pcEndpoint), util.toPointer(ppPresenceInfo)));
}
...
export function PeerCollabEnumApplications(
  ...
  return util.pointerFromFfi(libP2P.PeerCollabEnumApplications(util.toPointer(pcEndpoint), util.toPointer(pApplicationId), util.toPointer(phPeerEnum)));
}
...
export function PeerCollabEnumObjects(
  ...
  return util.pointerFromFfi(libP2P.PeerCollabEnumObjects(util.toPointer(pcEndpoint), util.toPointer(pObjectId), util.toPointer(phPeerEnum)));
}
...
export function PeerCollabEnumEndpoints(
  ...
  return util.pointerFromFfi(libP2P.PeerCollabEnumEndpoints(util.toPointer(pcContact), util.toPointer(phPeerEnum)));
}

export function PeerCollabRefreshEndpointData(
  pcEndpoint: Deno.PointerValue | Uint8Array | null /* ptr */,
): Deno.PointerValue | null /* Windows.Win32.Foundation.HRESULT */ {
  return util.pointerFromFfi(libP2P.PeerCollabRefreshEndpointData(util.toPointer(pcEndpoint)));
}

export function PeerCollabDeleteEndpointData(
  pcEndpoint: Deno.PointerValue | Uint8Array | null /* ptr */,
): Deno.PointerValue | null /* Windows.Win32.Foundation.HRESULT */ {
  return util.pointerFromFfi(libP2P.PeerCollabDeleteEndpointData(util.toPointer(pcEndpoint)));
}
...
export function PeerCollabQueryContactData(
  ...
  return util.pointerFromFfi(libP2P.PeerCollabQueryContactData(util.toPointer(pcEndpoint), util.toPointer(ppwzContactData)));
}

export function PeerCollabSubscribeEndpointData(
  pcEndpoint: Deno.PointerValue | Uint8Array | null /* ptr */,
): Deno.PointerValue | null /* Windows.Win32.Foundation.HRESULT */ {
  return util.pointerFromFfi(libP2P.PeerCollabSubscribeEndpointData(util.toPointer(pcEndpoint)));
}

export function PeerCollabUnsubscribeEndpointData(
  pcEndpoint: Deno.PointerValue | Uint8Array | null /* ptr */,
): Deno.PointerValue | null /* Windows.Win32.Foundation.HRESULT */ {
  return util.pointerFromFfi(libP2P.PeerCollabUnsubscribeEndpointData(util.toPointer(pcEndpoint)));
}

export function PeerCollabSetPresenceInfo(
  pcPresenceInfo: Deno.PointerValue | Uint8Array | null /* ptr */,
): Deno.PointerValue | null /* Windows.Win32.Foundation.HRESULT */ {
  return util.pointerFromFfi(libP2P.PeerCollabSetPresenceInfo(util.toPointer(pcPresenceInfo)));
}

export function PeerCollabGetEndpointName(
  ppwzEndpointName: Deno.PointerValue | Uint8Array | null /* ptr */,
): Deno.PointerValue | null /* Windows.Win32.Foundation.HRESULT */ {
  return util.pointerFromFfi(libP2P.PeerCollabGetEndpointName(util.toPointer(ppwzEndpointName)));
}

export function PeerCollabSetEndpointName(
  pwzEndpointName: string | null /* Windows.Win32.Foundation.PWSTR */,
): Deno.PointerValue | null /* Windows.Win32.Foundation.HRESULT */ {
  return util.pointerFromFfi(libP2P.PeerCollabSetEndpointName(util.pwstrToFfi(pwzEndpointName)));
}

export function PeerCollabSetObject(
  pcObject: Deno.PointerValue | Uint8Array | null /* ptr */,
): Deno.PointerValue | null /* Windows.Win32.Foundation.HRESULT */ {
  return util.pointerFromFfi(libP2P.PeerCollabSetObject(util.toPointer(pcObject)));
}

export function PeerCollabDeleteObject(
  pObjectId: Deno.PointerValue | Uint8Array | null /* ptr */,
): Deno.PointerValue | null /* Windows.Win32.Foundation.HRESULT */ {
  return util.pointerFromFfi(libP2P.PeerCollabDeleteObject(util.toPointer(pObjectId)));
}
...
export function PeerCollabRegisterEvent(
  ...
  return util.pointerFromFfi(libP2P.PeerCollabRegisterEvent(util.toPointer(hEvent), cEventRegistration, util.toPointer(pEventRegistrations), util.toPointer(phPeerEvent)));
}
...
export function PeerCollabGetEventData(
  ...
  return util.pointerFromFfi(libP2P.PeerCollabGetEventData(util.toPointer(hPeerEvent), util.toPointer(ppEventData)));
}

export function PeerCollabUnregisterEvent(
  hPeerEvent: Deno.PointerValue | Uint8Array | null /* ptr */,
): Deno.PointerValue | null /* Windows.Win32.Foundation.HRESULT */ {
  return util.pointerFromFfi(libP2P.PeerCollabUnregisterEvent(util.toPointer(hPeerEvent)));
}

export function PeerCollabEnumPeopleNearMe(
  phPeerEnum: Deno.PointerValue | Uint8Array | null /* ptr */,
): Deno.PointerValue | null /* Windows.Win32.Foundation.HRESULT */ {
  return util.pointerFromFfi(libP2P.PeerCollabEnumPeopleNearMe(util.toPointer(phPeerEnum)));
}
...
export function PeerCollabAddContact(
  ...
  return util.pointerFromFfi(libP2P.PeerCollabAddContact(util.pwstrToFfi(pwzContactData), util.toPointer(ppContact)));
}

export function PeerCollabDeleteContact(
  pwzPeerName: string | null /* Windows.Win32.Foundation.PWSTR */,
): Deno.PointerValue | null /* Windows.Win32.Foundation.HRESULT */ {
  return util.pointerFromFfi(libP2P.PeerCollabDeleteContact(util.pwstrToFfi(pwzPeerName)));
}
...
export function PeerCollabGetContact(
  ...
  return util.pointerFromFfi(libP2P.PeerCollabGetContact(util.pwstrToFfi(pwzPeerName), util.toPointer(ppContact)));
}

export function PeerCollabUpdateContact(
  pContact: Deno.PointerValue | Uint8Array | null /* ptr */,
): Deno.PointerValue | null /* Windows.Win32.Foundation.HRESULT */ {
  return util.pointerFromFfi(libP2P.PeerCollabUpdateContact(util.toPointer(pContact)));
}

export function PeerCollabEnumContacts(
  phPeerEnum: Deno.PointerValue | Uint8Array | null /* ptr */,
): Deno.PointerValue | null /* Windows.Win32.Foundation.HRESULT */ {
  return util.pointerFromFfi(libP2P.PeerCollabEnumContacts(util.toPointer(phPeerEnum)));
}
...
export function PeerCollabExportContact(
  ...
  return util.pointerFromFfi(libP2P.PeerCollabExportContact(util.pwstrToFfi(pwzPeerName), util.toPointer(ppwzContactData)));
}
...
export function PeerCollabParseContact(
  ...
  return util.pointerFromFfi(libP2P.PeerCollabParseContact(util.pwstrToFfi(pwzContactData), util.toPointer(ppContact)));
}
...
export function PeerNameToPeerHostName(
  ...
  return util.pointerFromFfi(libP2P.PeerNameToPeerHostName(util.pwstrToFfi(pwzPeerName), util.toPointer(ppwzHostName)));
}
...
export function PeerHostNameToPeerName(
  ...
  return util.pointerFromFfi(libP2P.PeerHostNameToPeerName(util.pwstrToFfi(pwzHostName), util.toPointer(ppwzPeerName)));
}

export function PeerPnrpStartup(
  wVersionRequested: number /* u16 */,
): Deno.PointerValue | null /* Windows.Win32.Foundation.HRESULT */ {
  return util.pointerFromFfi(libP2P.PeerPnrpStartup(wVersionRequested));
}

export function PeerPnrpShutdown(): Deno.PointerValue | null /* Windows.Win32.Foundation.HRESULT */ {
  return util.pointerFromFfi(libP2P.PeerPnrpShutdown());
}
...
export function PeerPnrpRegister(
  ...
  return util.pointerFromFfi(libP2P.PeerPnrpRegister(util.pwstrToFfi(pcwzPeerName), util.toPointer(pRegistrationInfo), util.toPointer(phRegistration)));
}
...
export function PeerPnrpUpdateRegistration(
  ...
  return util.pointerFromFfi(libP2P.PeerPnrpUpdateRegistration(util.toPointer(hRegistration), util.toPointer(pRegistrationInfo)));
}

export function PeerPnrpUnregister(
  hRegistration: Deno.PointerValue | Uint8Array | null /* ptr */,
): Deno.PointerValue | null /* Windows.Win32.Foundation.HRESULT */ {
  return util.pointerFromFfi(libP2P.PeerPnrpUnregister(util.toPointer(hRegistration)));
}
...
export function PeerPnrpResolve(
  ...
  return util.pointerFromFfi(libP2P.PeerPnrpResolve(util.pwstrToFfi(pcwzPeerName), util.pwstrToFfi(pcwzCloudName), util.toPointer(pcEndpoints), util.toPointer(ppEndpoints)));
}
...
export function PeerPnrpStartResolve(
  ...
  return util.pointerFromFfi(libP2P.PeerPnrpStartResolve(util.pwstrToFfi(pcwzPeerName), util.pwstrToFfi(pcwzCloudName), cMaxEndpoints, util.toPointer(hEvent), util.toPointer(phResolve)));
}
...
export function PeerPnrpGetCloudInfo(
  ...
  return util.pointerFromFfi(libP2P.PeerPnrpGetCloudInfo(util.toPointer(pcNumClouds), util.toPointer(ppCloudInfo)));
}
...
export function PeerPnrpGetEndpoint(
  ...
  return util.pointerFromFfi(libP2P.PeerPnrpGetEndpoint(util.toPointer(hResolve), util.toPointer(ppEndpoint)));
}

export function PeerPnrpEndResolve(
  hResolve: Deno.PointerValue | Uint8Array | null /* ptr */,
): Deno.PointerValue | null /* Windows.Win32.Foundation.HRESULT */ {
  return util.pointerFromFfi(libP2P.PeerPnrpEndResolve(util.toPointer(hResolve)));
}
...
export function DrtCreatePnrpBootstrapResolver(
  ...
  return util.pointerFromFfi(libdrtprov.DrtCreatePnrpBootstrapResolver(util.boolToFfi(fPublish), util.pwstrToFfi(pwzPeerName), util.pwstrToFfi(pwzCloudName), util.pwstrToFfi(pwzPublishingIdentity), util.toPointer(ppResolver)));
}

export function DrtDeletePnrpBootstrapResolver(
  pResolver: Deno.PointerValue | Uint8Array | null /* ptr */,
): void /* void */ {
  return libdrtprov.DrtDeletePnrpBootstrapResolver(util.toPointer(pResolver));
}
...
export function DrtCreateDnsBootstrapResolver(
  ...
  return util.pointerFromFfi(libdrtprov.DrtCreateDnsBootstrapResolver(port, util.pwstrToFfi(pwszAddress), util.toPointer(ppModule)));
}

export function DrtDeleteDnsBootstrapResolver(
  pResolver: Deno.PointerValue | Uint8Array | null /* ptr */,
): void /* void */ {
  return libdrtprov.DrtDeleteDnsBootstrapResolver(util.toPointer(pResolver));
}
...
export function DrtCreateIpv6UdpTransport(
  ...
  return util.pointerFromFfi(libdrttransport.DrtCreateIpv6UdpTransport(scope, dwScopeId, dwLocalityThreshold, util.toPointer(pwPort), util.toPointer(phTransport)));
}

export function DrtDeleteIpv6UdpTransport(
  hTransport: Deno.PointerValue | Uint8Array | null /* ptr */,
): Deno.PointerValue | null /* Windows.Win32.Foundation.HRESULT */ {
  return util.pointerFromFfi(libdrttransport.DrtDeleteIpv6UdpTransport(util.toPointer(hTransport)));
}
...
export function DrtCreateDerivedKeySecurityProvider(
  ...
  return util.pointerFromFfi(libdrtprov.DrtCreateDerivedKeySecurityProvider(util.toPointer(pRootCert), util.toPointer(pLocalCert), util.toPointer(ppSecurityProvider)));
}
...
export function DrtCreateDerivedKey(
  ...
  return util.pointerFromFfi(libdrtprov.DrtCreateDerivedKey(util.toPointer(pLocalCert), util.toPointer(pKey)));
}

export function DrtDeleteDerivedKeySecurityProvider(
  pSecurityProvider: Deno.PointerValue | Uint8Array | null /* ptr */,
): void /* void */ {
  return libdrtprov.DrtDeleteDerivedKeySecurityProvider(util.toPointer(pSecurityProvider));
}

export function DrtCreateNullSecurityProvider(
  ppSecurityProvider: Deno.PointerValue | Uint8Array | null /* ptr */,
): Deno.PointerValue | null /* Windows.Win32.Foundation.HRESULT */ {
  return util.pointerFromFfi(libdrtprov.DrtCreateNullSecurityProvider(util.toPointer(ppSecurityProvider)));
}

export function DrtDeleteNullSecurityProvider(
  pSecurityProvider: Deno.PointerValue | Uint8Array | null /* ptr */,
): void /* void */ {
  return libdrtprov.DrtDeleteNullSecurityProvider(util.toPointer(pSecurityProvider));
}
...
export function DrtOpen(
  ...
  return util.pointerFromFfi(libdrt.DrtOpen(util.toPointer(pSettings), util.toPointer(hEvent), util.toPointer(pvContext), util.toPointer(phDrt)));
}

export function DrtClose(
  hDrt: Deno.PointerValue | Uint8Array | null /* ptr */,
): void /* void */ {
  return libdrt.DrtClose(util.toPointer(hDrt));
}
...
export function DrtGetEventDataSize(
  ...
  return util.pointerFromFfi(libdrt.DrtGetEventDataSize(util.toPointer(hDrt), util.toPointer(pulEventDataLen)));
}
...
export function DrtGetEventData(
  ...
  return util.pointerFromFfi(libdrt.DrtGetEventData(util.toPointer(hDrt), ulEventDataLen, util.toPointer(pEventData)));
}
...
export function DrtRegisterKey(
  ...
  return util.pointerFromFfi(libdrt.DrtRegisterKey(util.toPointer(hDrt), util.toPointer(pRegistration), util.toPointer(pvKeyContext), util.toPointer(phKeyRegistration)));
}
...
export function DrtUpdateKey(
  ...
  return util.pointerFromFfi(libdrt.DrtUpdateKey(util.toPointer(hKeyRegistration), util.toPointer(pAppData)));
}

export function DrtUnregisterKey(
  hKeyRegistration: Deno.PointerValue | Uint8Array | null /* ptr */,
): void /* void */ {
  return libdrt.DrtUnregisterKey(util.toPointer(hKeyRegistration));
}
...
export function DrtStartSearch(
  ...
  return util.pointerFromFfi(libdrt.DrtStartSearch(util.toPointer(hDrt), util.toPointer(pKey), util.toPointer(pInfo), timeout, util.toPointer(hEvent), util.toPointer(pvContext), util.toPointer(hSearchContext)));
}

export function DrtContinueSearch(
  hSearchContext: Deno.PointerValue | Uint8Array | null /* ptr */,
): Deno.PointerValue | null /* Windows.Win32.Foundation.HRESULT */ {
  return util.pointerFromFfi(libdrt.DrtContinueSearch(util.toPointer(hSearchContext)));
}
...
export function DrtGetSearchResultSize(
  ...
  return util.pointerFromFfi(libdrt.DrtGetSearchResultSize(util.toPointer(hSearchContext), util.toPointer(pulSearchResultSize)));
}
...
export function DrtGetSearchResult(
  ...
  return util.pointerFromFfi(libdrt.DrtGetSearchResult(util.toPointer(hSearchContext), ulSearchResultSize, util.toPointer(pSearchResult)));
}
...
export function DrtGetSearchPathSize(
  ...
  return util.pointerFromFfi(libdrt.DrtGetSearchPathSize(util.toPointer(hSearchContext), util.toPointer(pulSearchPathSize)));
}
...
export function DrtGetSearchPath(
  ...
  return util.pointerFromFfi(libdrt.DrtGetSearchPath(util.toPointer(hSearchContext), ulSearchPathSize, util.toPointer(pSearchPath)));
}

export function DrtEndSearch(
  hSearchContext: Deno.PointerValue | Uint8Array | null /* ptr */,
): Deno.PointerValue | null /* Windows.Win32.Foundation.HRESULT */ {
  return util.pointerFromFfi(libdrt.DrtEndSearch(util.toPointer(hSearchContext)));
}
...
export function DrtGetInstanceName(
  ...
  return util.pointerFromFfi(libdrt.DrtGetInstanceName(util.toPointer(hDrt), ulcbInstanceNameSize, util.pwstrToFfi(pwzDrtInstanceName)));
}
...
export function DrtGetInstanceNameSize(
  ...
  return util.pointerFromFfi(libdrt.DrtGetInstanceNameSize(util.toPointer(hDrt), util.toPointer(pulcbInstanceNameSize)));
}
...
export function PeerDistStartup(
  ...
  return libPeerDist.PeerDistStartup(dwVersionRequested, util.toPointer(phPeerDist), util.toPointer(pdwSupportedVersion));
}

export function PeerDistShutdown(
  hPeerDist: Deno.PointerValue /* isize */,
): number /* u32 */ {
  return libPeerDist.PeerDistShutdown(hPeerDist);
}
...
export function PeerDistGetStatus(
  ...
  return libPeerDist.PeerDistGetStatus(hPeerDist, util.toPointer(pPeerDistStatus));
}
...
export function PeerDistRegisterForStatusChangeNotification(
  ...
  return libPeerDist.PeerDistRegisterForStatusChangeNotification(hPeerDist, util.toPointer(hCompletionPort), ulCompletionKey, util.toPointer(lpOverlapped), util.toPointer(pPeerDistStatus));
}

export function PeerDistUnregisterForStatusChangeNotification(
  hPeerDist: Deno.PointerValue /* isize */,
): number /* u32 */ {
  return libPeerDist.PeerDistUnregisterForStatusChangeNotification(hPeerDist);
}
...
export function PeerDistServerPublishStream(
  ...
  return libPeerDist.PeerDistServerPublishStream(hPeerDist, cbContentIdentifier, util.toPointer(pContentIdentifier), cbContentLength, util.toPointer(pPublishOptions), util.toPointer(hCompletionPort), ulCompletionKey, util.toPointer(phStream));
}
...
export function PeerDistServerPublishAddToStream(
  ...
  return libPeerDist.PeerDistServerPublishAddToStream(hPeerDist, hStream, cbNumberOfBytes, util.toPointer(pBuffer), util.toPointer(lpOverlapped));
}
...
export function PeerDistServerPublishCompleteStream(
  ...
  return libPeerDist.PeerDistServerPublishCompleteStream(hPeerDist, hStream, util.toPointer(lpOverlapped));
}
...
export function PeerDistServerCloseStreamHandle(
  ...
  return libPeerDist.PeerDistServerCloseStreamHandle(hPeerDist, hStream);
}
...
export function PeerDistServerUnpublish(
  ...
  return libPeerDist.PeerDistServerUnpublish(hPeerDist, cbContentIdentifier, util.toPointer(pContentIdentifier));
}
...
export function PeerDistServerOpenContentInformation(
  ...
  return libPeerDist.PeerDistServerOpenContentInformation(hPeerDist, cbContentIdentifier, util.toPointer(pContentIdentifier), ullContentOffset, cbContentLength, util.toPointer(hCompletionPort), ulCompletionKey, util.toPointer(phContentInfo));
}
...
export function PeerDistServerRetrieveContentInformation(
  ...
  return libPeerDist.PeerDistServerRetrieveContentInformation(hPeerDist, hContentInfo, cbMaxNumberOfBytes, util.toPointer(pBuffer), util.toPointer(lpOverlapped));
}
...
export function PeerDistServerCloseContentInformation(
  ...
  return libPeerDist.PeerDistServerCloseContentInformation(hPeerDist, hContentInfo);
}
...
export function PeerDistServerCancelAsyncOperation(
  ...
  return libPeerDist.PeerDistServerCancelAsyncOperation(hPeerDist, cbContentIdentifier, util.toPointer(pContentIdentifier), util.toPointer(pOverlapped));
}
...
export function PeerDistClientOpenContent(
  ...
  return libPeerDist.PeerDistClientOpenContent(hPeerDist, util.toPointer(pContentTag), util.toPointer(hCompletionPort), ulCompletionKey, util.toPointer(phContentHandle));
}
...
export function PeerDistClientCloseContent(
  ...
  return libPeerDist.PeerDistClientCloseContent(hPeerDist, hContentHandle);
}
...
export function PeerDistClientAddContentInformation(
  ...
  return libPeerDist.PeerDistClientAddContentInformation(hPeerDist, hContentHandle, cbNumberOfBytes, util.toPointer(pBuffer), util.toPointer(lpOverlapped));
}
...
export function PeerDistClientCompleteContentInformation(
  ...
  return libPeerDist.PeerDistClientCompleteContentInformation(hPeerDist, hContentHandle, util.toPointer(lpOverlapped));
}
...
export function PeerDistClientAddData(
  ...
  return libPeerDist.PeerDistClientAddData(hPeerDist, hContentHandle, cbNumberOfBytes, util.toPointer(pBuffer), util.toPointer(lpOverlapped));
}
...
export function PeerDistClientBlockRead(
  ...
  return libPeerDist.PeerDistClientBlockRead(hPeerDist, hContentHandle, cbMaxNumberOfBytes, util.toPointer(pBuffer), dwTimeoutInMilliseconds, util.toPointer(lpOverlapped));
}
...
export function PeerDistClientStreamRead(
  ...
  return libPeerDist.PeerDistClientStreamRead(hPeerDist, hContentHandle, cbMaxNumberOfBytes, util.toPointer(pBuffer), dwTimeoutInMilliseconds, util.toPointer(lpOverlapped));
}
...
export function PeerDistClientFlushContent(
  ...
  return libPeerDist.PeerDistClientFlushContent(hPeerDist, util.toPointer(pContentTag), util.toPointer(hCompletionPort), ulCompletionKey, util.toPointer(lpOverlapped));
}
...
export function PeerDistClientCancelAsyncOperation(
  ...
  return libPeerDist.PeerDistClientCancelAsyncOperation(hPeerDist, hContentHandle, util.toPointer(pOverlapped));
}
...
export function PeerDistGetStatusEx(
  ...
  return libPeerDist.PeerDistGetStatusEx(hPeerDist, util.toPointer(pPeerDistStatus));
}
...
export function PeerDistRegisterForStatusChangeNotificationEx(
  ...
  return libPeerDist.PeerDistRegisterForStatusChangeNotificationEx(hPeerDist, util.toPointer(hCompletionPort), ulCompletionKey, util.toPointer(lpOverlapped), util.toPointer(pPeerDistStatus));
}
...
export function PeerDistGetOverlappedResult(
  ...
  return util.boolFromFfi(libPeerDist.PeerDistGetOverlappedResult(util.toPointer(lpOverlapped), util.toPointer(lpNumberOfBytesTransferred), util.boolToFfi(bWait)));
}
...
export function PeerDistServerOpenContentInformationEx(
  ...
  return libPeerDist.PeerDistServerOpenContentInformationEx(hPeerDist, cbContentIdentifier, util.toPointer(pContentIdentifier), ullContentOffset, cbContentLength, util.toPointer(pRetrievalOptions), util.toPointer(hCompletionPort), ulCompletionKey, util.toPointer(phContentInfo));
}
...
export function PeerDistClientGetInformationByHandle(
  ...
  return libPeerDist.PeerDistClientGetInformationByHandle(hPeerDist, hContentHandle, PeerDistClientInfoClass, dwBufferSize, util.toPointer(lpInformation));
}
