...
/**
 * Windows.Win32.NetworkManagement.QoS.Apis (size: 128)
 */
export interface Apis {
  /** System.Guid */
  GUID_QOS_REMAINING_BANDWIDTH: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_QOS_BESTEFFORT_BANDWIDTH: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_QOS_LATENCY: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_QOS_FLOW_COUNT: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_QOS_NON_BESTEFFORT_LIMIT: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_QOS_MAX_OUTSTANDING_SENDS: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_QOS_STATISTICS_BUFFER: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_QOS_FLOW_MODE: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_QOS_ISSLOW_FLOW: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_QOS_TIMER_RESOLUTION: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_QOS_FLOW_IP_CONFORMING: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_QOS_FLOW_IP_NONCONFORMING: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_QOS_FLOW_8021P_CONFORMING: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_QOS_FLOW_8021P_NONCONFORMING: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_QOS_ENABLE_AVG_STATS: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_QOS_ENABLE_WINDOW_ADJUSTMENT: Uint8Array | Deno.PointerValue | null;
}

export const sizeofApis = 128;

export function allocApis(data?: Partial<Apis>): Uint8Array {
  const buf = new Uint8Array(sizeofApis);
  const view = new DataView(buf.buffer);
  // 0x00: pointer
  if (data?.GUID_QOS_REMAINING_BANDWIDTH !== undefined) view.setBigUint64(0, data.GUID_QOS_REMAINING_BANDWIDTH === null ? 0n : BigInt(util.toPointer(data.GUID_QOS_REMAINING_BANDWIDTH)), true);
  // 0x08: pointer
  if (data?.GUID_QOS_BESTEFFORT_BANDWIDTH !== undefined) view.setBigUint64(8, data.GUID_QOS_BESTEFFORT_BANDWIDTH === null ? 0n : BigInt(util.toPointer(data.GUID_QOS_BESTEFFORT_BANDWIDTH)), true);
  // 0x10: pointer
  if (data?.GUID_QOS_LATENCY !== undefined) view.setBigUint64(16, data.GUID_QOS_LATENCY === null ? 0n : BigInt(util.toPointer(data.GUID_QOS_LATENCY)), true);
  // 0x18: pointer
  if (data?.GUID_QOS_FLOW_COUNT !== undefined) view.setBigUint64(24, data.GUID_QOS_FLOW_COUNT === null ? 0n : BigInt(util.toPointer(data.GUID_QOS_FLOW_COUNT)), true);
  // 0x20: pointer
  if (data?.GUID_QOS_NON_BESTEFFORT_LIMIT !== undefined) view.setBigUint64(32, data.GUID_QOS_NON_BESTEFFORT_LIMIT === null ? 0n : BigInt(util.toPointer(data.GUID_QOS_NON_BESTEFFORT_LIMIT)), true);
  // 0x28: pointer
  if (data?.GUID_QOS_MAX_OUTSTANDING_SENDS !== undefined) view.setBigUint64(40, data.GUID_QOS_MAX_OUTSTANDING_SENDS === null ? 0n : BigInt(util.toPointer(data.GUID_QOS_MAX_OUTSTANDING_SENDS)), true);
  // 0x30: pointer
  if (data?.GUID_QOS_STATISTICS_BUFFER !== undefined) view.setBigUint64(48, data.GUID_QOS_STATISTICS_BUFFER === null ? 0n : BigInt(util.toPointer(data.GUID_QOS_STATISTICS_BUFFER)), true);
  // 0x38: pointer
  if (data?.GUID_QOS_FLOW_MODE !== undefined) view.setBigUint64(56, data.GUID_QOS_FLOW_MODE === null ? 0n : BigInt(util.toPointer(data.GUID_QOS_FLOW_MODE)), true);
  // 0x40: pointer
  if (data?.GUID_QOS_ISSLOW_FLOW !== undefined) view.setBigUint64(64, data.GUID_QOS_ISSLOW_FLOW === null ? 0n : BigInt(util.toPointer(data.GUID_QOS_ISSLOW_FLOW)), true);
  // 0x48: pointer
  if (data?.GUID_QOS_TIMER_RESOLUTION !== undefined) view.setBigUint64(72, data.GUID_QOS_TIMER_RESOLUTION === null ? 0n : BigInt(util.toPointer(data.GUID_QOS_TIMER_RESOLUTION)), true);
  // 0x50: pointer
  if (data?.GUID_QOS_FLOW_IP_CONFORMING !== undefined) view.setBigUint64(80, data.GUID_QOS_FLOW_IP_CONFORMING === null ? 0n : BigInt(util.toPointer(data.GUID_QOS_FLOW_IP_CONFORMING)), true);
  // 0x58: pointer
  if (data?.GUID_QOS_FLOW_IP_NONCONFORMING !== undefined) view.setBigUint64(88, data.GUID_QOS_FLOW_IP_NONCONFORMING === null ? 0n : BigInt(util.toPointer(data.GUID_QOS_FLOW_IP_NONCONFORMING)), true);
  // 0x60: pointer
  if (data?.GUID_QOS_FLOW_8021P_CONFORMING !== undefined) view.setBigUint64(96, data.GUID_QOS_FLOW_8021P_CONFORMING === null ? 0n : BigInt(util.toPointer(data.GUID_QOS_FLOW_8021P_CONFORMING)), true);
  // 0x68: pointer
  if (data?.GUID_QOS_FLOW_8021P_NONCONFORMING !== undefined) view.setBigUint64(104, data.GUID_QOS_FLOW_8021P_NONCONFORMING === null ? 0n : BigInt(util.toPointer(data.GUID_QOS_FLOW_8021P_NONCONFORMING)), true);
  // 0x70: pointer
  if (data?.GUID_QOS_ENABLE_AVG_STATS !== undefined) view.setBigUint64(112, data.GUID_QOS_ENABLE_AVG_STATS === null ? 0n : BigInt(util.toPointer(data.GUID_QOS_ENABLE_AVG_STATS)), true);
  // 0x78: pointer
  if (data?.GUID_QOS_ENABLE_WINDOW_ADJUSTMENT !== undefined) view.setBigUint64(120, data.GUID_QOS_ENABLE_WINDOW_ADJUSTMENT === null ? 0n : BigInt(util.toPointer(data.GUID_QOS_ENABLE_WINDOW_ADJUSTMENT)), true);
  return buf;
}
