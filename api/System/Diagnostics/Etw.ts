...
/**
 * Windows.Win32.System.Diagnostics.Etw.Apis (size: 184)
 */
export interface Apis {
  /** System.Guid */
  EventTraceGuid: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  SystemTraceControlGuid: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  EventTraceConfigGuid: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  DefaultTraceSecurityGuid: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  PrivateLoggerNotificationGuid: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  SystemIoFilterProviderGuid: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  SystemObjectProviderGuid: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  SystemPowerProviderGuid: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  SystemHypervisorProviderGuid: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  SystemLockProviderGuid: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  SystemConfigProviderGuid: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  SystemCpuProviderGuid: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  SystemSchedulerProviderGuid: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  SystemProfileProviderGuid: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  SystemIoProviderGuid: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  SystemMemoryProviderGuid: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  SystemRegistryProviderGuid: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  SystemProcessProviderGuid: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  SystemAlpcProviderGuid: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  SystemSyscallProviderGuid: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  SystemInterruptProviderGuid: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  SystemTimerProviderGuid: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  CLSID_TraceRelogger: Uint8Array | Deno.PointerValue | null;
}
...
export function allocApis(data?: Partial<Apis>): Uint8Array {
  ...
  // 0x00: pointer
  if (data?.EventTraceGuid !== undefined) view.setBigUint64(0, data.EventTraceGuid === null ? 0n : BigInt(util.toPointer(data.EventTraceGuid)), true);
  // 0x08: pointer
  if (data?.SystemTraceControlGuid !== undefined) view.setBigUint64(8, data.SystemTraceControlGuid === null ? 0n : BigInt(util.toPointer(data.SystemTraceControlGuid)), true);
  // 0x10: pointer
  if (data?.EventTraceConfigGuid !== undefined) view.setBigUint64(16, data.EventTraceConfigGuid === null ? 0n : BigInt(util.toPointer(data.EventTraceConfigGuid)), true);
  // 0x18: pointer
  if (data?.DefaultTraceSecurityGuid !== undefined) view.setBigUint64(24, data.DefaultTraceSecurityGuid === null ? 0n : BigInt(util.toPointer(data.DefaultTraceSecurityGuid)), true);
  // 0x20: pointer
  if (data?.PrivateLoggerNotificationGuid !== undefined) view.setBigUint64(32, data.PrivateLoggerNotificationGuid === null ? 0n : BigInt(util.toPointer(data.PrivateLoggerNotificationGuid)), true);
  // 0x28: pointer
  if (data?.SystemIoFilterProviderGuid !== undefined) view.setBigUint64(40, data.SystemIoFilterProviderGuid === null ? 0n : BigInt(util.toPointer(data.SystemIoFilterProviderGuid)), true);
  // 0x30: pointer
  if (data?.SystemObjectProviderGuid !== undefined) view.setBigUint64(48, data.SystemObjectProviderGuid === null ? 0n : BigInt(util.toPointer(data.SystemObjectProviderGuid)), true);
  // 0x38: pointer
  if (data?.SystemPowerProviderGuid !== undefined) view.setBigUint64(56, data.SystemPowerProviderGuid === null ? 0n : BigInt(util.toPointer(data.SystemPowerProviderGuid)), true);
  // 0x40: pointer
  if (data?.SystemHypervisorProviderGuid !== undefined) view.setBigUint64(64, data.SystemHypervisorProviderGuid === null ? 0n : BigInt(util.toPointer(data.SystemHypervisorProviderGuid)), true);
  // 0x48: pointer
  if (data?.SystemLockProviderGuid !== undefined) view.setBigUint64(72, data.SystemLockProviderGuid === null ? 0n : BigInt(util.toPointer(data.SystemLockProviderGuid)), true);
  // 0x50: pointer
  if (data?.SystemConfigProviderGuid !== undefined) view.setBigUint64(80, data.SystemConfigProviderGuid === null ? 0n : BigInt(util.toPointer(data.SystemConfigProviderGuid)), true);
  // 0x58: pointer
  if (data?.SystemCpuProviderGuid !== undefined) view.setBigUint64(88, data.SystemCpuProviderGuid === null ? 0n : BigInt(util.toPointer(data.SystemCpuProviderGuid)), true);
  // 0x60: pointer
  if (data?.SystemSchedulerProviderGuid !== undefined) view.setBigUint64(96, data.SystemSchedulerProviderGuid === null ? 0n : BigInt(util.toPointer(data.SystemSchedulerProviderGuid)), true);
  // 0x68: pointer
  if (data?.SystemProfileProviderGuid !== undefined) view.setBigUint64(104, data.SystemProfileProviderGuid === null ? 0n : BigInt(util.toPointer(data.SystemProfileProviderGuid)), true);
  // 0x70: pointer
  if (data?.SystemIoProviderGuid !== undefined) view.setBigUint64(112, data.SystemIoProviderGuid === null ? 0n : BigInt(util.toPointer(data.SystemIoProviderGuid)), true);
  // 0x78: pointer
  if (data?.SystemMemoryProviderGuid !== undefined) view.setBigUint64(120, data.SystemMemoryProviderGuid === null ? 0n : BigInt(util.toPointer(data.SystemMemoryProviderGuid)), true);
  // 0x80: pointer
  if (data?.SystemRegistryProviderGuid !== undefined) view.setBigUint64(128, data.SystemRegistryProviderGuid === null ? 0n : BigInt(util.toPointer(data.SystemRegistryProviderGuid)), true);
  // 0x88: pointer
  if (data?.SystemProcessProviderGuid !== undefined) view.setBigUint64(136, data.SystemProcessProviderGuid === null ? 0n : BigInt(util.toPointer(data.SystemProcessProviderGuid)), true);
  // 0x90: pointer
  if (data?.SystemAlpcProviderGuid !== undefined) view.setBigUint64(144, data.SystemAlpcProviderGuid === null ? 0n : BigInt(util.toPointer(data.SystemAlpcProviderGuid)), true);
  // 0x98: pointer
  if (data?.SystemSyscallProviderGuid !== undefined) view.setBigUint64(152, data.SystemSyscallProviderGuid === null ? 0n : BigInt(util.toPointer(data.SystemSyscallProviderGuid)), true);
  // 0xa0: pointer
  if (data?.SystemInterruptProviderGuid !== undefined) view.setBigUint64(160, data.SystemInterruptProviderGuid === null ? 0n : BigInt(util.toPointer(data.SystemInterruptProviderGuid)), true);
  // 0xa8: pointer
  if (data?.SystemTimerProviderGuid !== undefined) view.setBigUint64(168, data.SystemTimerProviderGuid === null ? 0n : BigInt(util.toPointer(data.SystemTimerProviderGuid)), true);
  // 0xb0: pointer
  if (data?.CLSID_TraceRelogger !== undefined) view.setBigUint64(176, data.CLSID_TraceRelogger === null ? 0n : BigInt(util.toPointer(data.CLSID_TraceRelogger)), true);
  return buf;
}
