...
export const HKEY_CURRENT_USER = 8815420375041;
export const HKEY_LOCAL_MACHINE = 3317862236162;
export const HKEY_USERS = 4417373863939;
export const HKEY_PERFORMANCE_DATA = 153950955241476;
export const HKEY_PERFORMANCE_TEXT = 105572443619408;
export const HKEY_PERFORMANCE_NLSTEXT = 864691147782488160n;
...
/**
 * Windows.Win32.System.Registry.provider_info (size: 48)
 */
export interface provider_info {
...
export const sizeofProvider_info = 48;

export function allocProvider_info(data?: Partial<provider_info>): Uint8Array {
  const buf = new Uint8Array(sizeofProvider_info);
  const view = new DataView(buf.buffer);
  // 0x00: pointer
...
try {
  var libapi_ms_win_core_state_helpers_l1_1_0 = Deno.dlopen("api-ms-win-core-state-helpers-l1-1-0", {
...
export function RegCloseKey(
  ...
  return libADVAPI32.RegCloseKey(util.toPointer(hKey));
}
...
export function RegOverridePredefKey(
  ...
  return libADVAPI32.RegOverridePredefKey(util.toPointer(hKey), util.toPointer(hNewHKey));
}
...
export function RegOpenUserClassesRoot(
  ...
  return libADVAPI32.RegOpenUserClassesRoot(util.toPointer(hToken), dwOptions, samDesired, util.toPointer(phkResult));
}
...
export function RegConnectRegistryA(
  ...
  return libADVAPI32.RegConnectRegistryA(util.pstrToFfi(lpMachineName), util.toPointer(hKey), util.toPointer(phkResult));
}
...
export function RegConnectRegistryW(
  ...
  return libADVAPI32.RegConnectRegistryW(util.pwstrToFfi(lpMachineName), util.toPointer(hKey), util.toPointer(phkResult));
}
...
export function RegConnectRegistryExA(
  ...
  return libADVAPI32.RegConnectRegistryExA(util.pstrToFfi(lpMachineName), util.toPointer(hKey), Flags, util.toPointer(phkResult));
}
...
export function RegConnectRegistryExW(
  ...
  return libADVAPI32.RegConnectRegistryExW(util.pwstrToFfi(lpMachineName), util.toPointer(hKey), Flags, util.toPointer(phkResult));
}
...
export function RegCreateKeyA(
  ...
  return libADVAPI32.RegCreateKeyA(util.toPointer(hKey), util.pstrToFfi(lpSubKey), util.toPointer(phkResult));
}
...
export function RegCreateKeyW(
  ...
  return libADVAPI32.RegCreateKeyW(util.toPointer(hKey), util.pwstrToFfi(lpSubKey), util.toPointer(phkResult));
}
...
export function RegCreateKeyExA(
  ...
  return libADVAPI32.RegCreateKeyExA(util.toPointer(hKey), util.pstrToFfi(lpSubKey), Reserved, util.pstrToFfi(lpClass), dwOptions, samDesired, util.toPointer(lpSecurityAttributes), util.toPointer(phkResult), util.toPointer(lpdwDisposition));
}
...
export function RegCreateKeyExW(
  ...
  return libADVAPI32.RegCreateKeyExW(util.toPointer(hKey), util.pwstrToFfi(lpSubKey), Reserved, util.pwstrToFfi(lpClass), dwOptions, samDesired, util.toPointer(lpSecurityAttributes), util.toPointer(phkResult), util.toPointer(lpdwDisposition));
}
...
export function RegCreateKeyTransactedA(
  ...
  return libADVAPI32.RegCreateKeyTransactedA(util.toPointer(hKey), util.pstrToFfi(lpSubKey), Reserved, util.pstrToFfi(lpClass), dwOptions, samDesired, util.toPointer(lpSecurityAttributes), util.toPointer(phkResult), util.toPointer(lpdwDisposition), util.toPointer(hTransaction), util.toPointer(pExtendedParemeter));
}
...
export function RegCreateKeyTransactedW(
  ...
  return libADVAPI32.RegCreateKeyTransactedW(util.toPointer(hKey), util.pwstrToFfi(lpSubKey), Reserved, util.pwstrToFfi(lpClass), dwOptions, samDesired, util.toPointer(lpSecurityAttributes), util.toPointer(phkResult), util.toPointer(lpdwDisposition), util.toPointer(hTransaction), util.toPointer(pExtendedParemeter));
}
...
export function RegDeleteKeyA(
  ...
  return libADVAPI32.RegDeleteKeyA(util.toPointer(hKey), util.pstrToFfi(lpSubKey));
}
...
export function RegDeleteKeyW(
  ...
  return libADVAPI32.RegDeleteKeyW(util.toPointer(hKey), util.pwstrToFfi(lpSubKey));
}
...
export function RegDeleteKeyExA(
  ...
  return libADVAPI32.RegDeleteKeyExA(util.toPointer(hKey), util.pstrToFfi(lpSubKey), samDesired, Reserved);
}
...
export function RegDeleteKeyExW(
  ...
  return libADVAPI32.RegDeleteKeyExW(util.toPointer(hKey), util.pwstrToFfi(lpSubKey), samDesired, Reserved);
}
...
export function RegDeleteKeyTransactedA(
  ...
  return libADVAPI32.RegDeleteKeyTransactedA(util.toPointer(hKey), util.pstrToFfi(lpSubKey), samDesired, Reserved, util.toPointer(hTransaction), util.toPointer(pExtendedParameter));
}
...
export function RegDeleteKeyTransactedW(
  ...
  return libADVAPI32.RegDeleteKeyTransactedW(util.toPointer(hKey), util.pwstrToFfi(lpSubKey), samDesired, Reserved, util.toPointer(hTransaction), util.toPointer(pExtendedParameter));
}

export function RegDisableReflectionKey(
  hBase: Uint8Array | Deno.PointerValue | null /* Windows.Win32.System.Registry.HKEY */,
): WIN32_ERROR /* Windows.Win32.Foundation.WIN32_ERROR */ {
  return libADVAPI32.RegDisableReflectionKey(util.toPointer(hBase));
}

export function RegEnableReflectionKey(
  hBase: Uint8Array | Deno.PointerValue | null /* Windows.Win32.System.Registry.HKEY */,
): WIN32_ERROR /* Windows.Win32.Foundation.WIN32_ERROR */ {
  return libADVAPI32.RegEnableReflectionKey(util.toPointer(hBase));
}
...
export function RegQueryReflectionKey(
  ...
  return libADVAPI32.RegQueryReflectionKey(util.toPointer(hBase), util.toPointer(bIsReflectionDisabled));
}
...
export function RegDeleteValueA(
  ...
  return libADVAPI32.RegDeleteValueA(util.toPointer(hKey), util.pstrToFfi(lpValueName));
}
...
export function RegDeleteValueW(
  ...
  return libADVAPI32.RegDeleteValueW(util.toPointer(hKey), util.pwstrToFfi(lpValueName));
}
...
export function RegEnumKeyA(
  ...
  return libADVAPI32.RegEnumKeyA(util.toPointer(hKey), dwIndex, util.pstrToFfi(lpName), cchName);
}
...
export function RegEnumKeyW(
  ...
  return libADVAPI32.RegEnumKeyW(util.toPointer(hKey), dwIndex, util.pwstrToFfi(lpName), cchName);
}
...
export function RegEnumKeyExA(
  ...
  return libADVAPI32.RegEnumKeyExA(util.toPointer(hKey), dwIndex, util.pstrToFfi(lpName), util.toPointer(lpcchName), util.toPointer(lpReserved), util.pstrToFfi(lpClass), util.toPointer(lpcchClass), util.toPointer(lpftLastWriteTime));
}
...
export function RegEnumKeyExW(
  ...
  return libADVAPI32.RegEnumKeyExW(util.toPointer(hKey), dwIndex, util.pwstrToFfi(lpName), util.toPointer(lpcchName), util.toPointer(lpReserved), util.pwstrToFfi(lpClass), util.toPointer(lpcchClass), util.toPointer(lpftLastWriteTime));
}
...
export function RegEnumValueA(
  ...
  return libADVAPI32.RegEnumValueA(util.toPointer(hKey), dwIndex, util.pstrToFfi(lpValueName), util.toPointer(lpcchValueName), util.toPointer(lpReserved), util.toPointer(lpType), util.toPointer(lpData), util.toPointer(lpcbData));
}
...
export function RegEnumValueW(
  ...
  return libADVAPI32.RegEnumValueW(util.toPointer(hKey), dwIndex, util.pwstrToFfi(lpValueName), util.toPointer(lpcchValueName), util.toPointer(lpReserved), util.toPointer(lpType), util.toPointer(lpData), util.toPointer(lpcbData));
}

export function RegFlushKey(
  hKey: Uint8Array | Deno.PointerValue | null /* Windows.Win32.System.Registry.HKEY */,
): WIN32_ERROR /* Windows.Win32.Foundation.WIN32_ERROR */ {
  return libADVAPI32.RegFlushKey(util.toPointer(hKey));
}
...
export function RegGetKeySecurity(
  ...
  return libADVAPI32.RegGetKeySecurity(util.toPointer(hKey), SecurityInformation, util.toPointer(pSecurityDescriptor), util.toPointer(lpcbSecurityDescriptor));
}
...
export function RegLoadKeyA(
  ...
  return libADVAPI32.RegLoadKeyA(util.toPointer(hKey), util.pstrToFfi(lpSubKey), util.pstrToFfi(lpFile));
}
...
export function RegLoadKeyW(
  ...
  return libADVAPI32.RegLoadKeyW(util.toPointer(hKey), util.pwstrToFfi(lpSubKey), util.pwstrToFfi(lpFile));
}
...
export function RegNotifyChangeKeyValue(
  ...
  return libADVAPI32.RegNotifyChangeKeyValue(util.toPointer(hKey), util.boolToFfi(bWatchSubtree), dwNotifyFilter, util.toPointer(hEvent), util.boolToFfi(fAsynchronous));
}
...
export function RegOpenKeyA(
  ...
  return libADVAPI32.RegOpenKeyA(util.toPointer(hKey), util.pstrToFfi(lpSubKey), util.toPointer(phkResult));
}
...
export function RegOpenKeyW(
  ...
  return libADVAPI32.RegOpenKeyW(util.toPointer(hKey), util.pwstrToFfi(lpSubKey), util.toPointer(phkResult));
}
...
export function RegOpenKeyExA(
  ...
  return libADVAPI32.RegOpenKeyExA(util.toPointer(hKey), util.pstrToFfi(lpSubKey), ulOptions, samDesired, util.toPointer(phkResult));
}
...
export function RegOpenKeyExW(
  ...
  return libADVAPI32.RegOpenKeyExW(util.toPointer(hKey), util.pwstrToFfi(lpSubKey), ulOptions, samDesired, util.toPointer(phkResult));
}
...
export function RegOpenKeyTransactedA(
  ...
  return libADVAPI32.RegOpenKeyTransactedA(util.toPointer(hKey), util.pstrToFfi(lpSubKey), ulOptions, samDesired, util.toPointer(phkResult), util.toPointer(hTransaction), util.toPointer(pExtendedParemeter));
}
...
export function RegOpenKeyTransactedW(
  ...
  return libADVAPI32.RegOpenKeyTransactedW(util.toPointer(hKey), util.pwstrToFfi(lpSubKey), ulOptions, samDesired, util.toPointer(phkResult), util.toPointer(hTransaction), util.toPointer(pExtendedParemeter));
}
...
export function RegQueryInfoKeyA(
  ...
  return libADVAPI32.RegQueryInfoKeyA(util.toPointer(hKey), util.pstrToFfi(lpClass), util.toPointer(lpcchClass), util.toPointer(lpReserved), util.toPointer(lpcSubKeys), util.toPointer(lpcbMaxSubKeyLen), util.toPointer(lpcbMaxClassLen), util.toPointer(lpcValues), util.toPointer(lpcbMaxValueNameLen), util.toPointer(lpcbMaxValueLen), util.toPointer(lpcbSecurityDescriptor), util.toPointer(lpftLastWriteTime));
}
...
export function RegQueryInfoKeyW(
  ...
  return libADVAPI32.RegQueryInfoKeyW(util.toPointer(hKey), util.pwstrToFfi(lpClass), util.toPointer(lpcchClass), util.toPointer(lpReserved), util.toPointer(lpcSubKeys), util.toPointer(lpcbMaxSubKeyLen), util.toPointer(lpcbMaxClassLen), util.toPointer(lpcValues), util.toPointer(lpcbMaxValueNameLen), util.toPointer(lpcbMaxValueLen), util.toPointer(lpcbSecurityDescriptor), util.toPointer(lpftLastWriteTime));
}
...
export function RegQueryValueA(
  ...
  return libADVAPI32.RegQueryValueA(util.toPointer(hKey), util.pstrToFfi(lpSubKey), util.pstrToFfi(lpData), util.toPointer(lpcbData));
}
...
export function RegQueryValueW(
  ...
  return libADVAPI32.RegQueryValueW(util.toPointer(hKey), util.pwstrToFfi(lpSubKey), util.pwstrToFfi(lpData), util.toPointer(lpcbData));
}
...
export function RegQueryMultipleValuesA(
  ...
  return libADVAPI32.RegQueryMultipleValuesA(util.toPointer(hKey), util.toPointer(val_list), num_vals, util.pstrToFfi(lpValueBuf), util.toPointer(ldwTotsize));
}
...
export function RegQueryMultipleValuesW(
  ...
  return libADVAPI32.RegQueryMultipleValuesW(util.toPointer(hKey), util.toPointer(val_list), num_vals, util.pwstrToFfi(lpValueBuf), util.toPointer(ldwTotsize));
}
...
export function RegQueryValueExA(
  ...
  return libADVAPI32.RegQueryValueExA(util.toPointer(hKey), util.pstrToFfi(lpValueName), util.toPointer(lpReserved), util.toPointer(lpType), util.toPointer(lpData), util.toPointer(lpcbData));
}
...
export function RegQueryValueExW(
  ...
  return libADVAPI32.RegQueryValueExW(util.toPointer(hKey), util.pwstrToFfi(lpValueName), util.toPointer(lpReserved), util.toPointer(lpType), util.toPointer(lpData), util.toPointer(lpcbData));
}
...
export function RegReplaceKeyA(
  ...
  return libADVAPI32.RegReplaceKeyA(util.toPointer(hKey), util.pstrToFfi(lpSubKey), util.pstrToFfi(lpNewFile), util.pstrToFfi(lpOldFile));
}
...
export function RegReplaceKeyW(
  ...
  return libADVAPI32.RegReplaceKeyW(util.toPointer(hKey), util.pwstrToFfi(lpSubKey), util.pwstrToFfi(lpNewFile), util.pwstrToFfi(lpOldFile));
}
...
export function RegRestoreKeyA(
  ...
  return libADVAPI32.RegRestoreKeyA(util.toPointer(hKey), util.pstrToFfi(lpFile), dwFlags);
}
...
export function RegRestoreKeyW(
  ...
  return libADVAPI32.RegRestoreKeyW(util.toPointer(hKey), util.pwstrToFfi(lpFile), dwFlags);
}
...
export function RegRenameKey(
  ...
  return libADVAPI32.RegRenameKey(util.toPointer(hKey), util.pwstrToFfi(lpSubKeyName), util.pwstrToFfi(lpNewKeyName));
}
...
export function RegSaveKeyA(
  ...
  return libADVAPI32.RegSaveKeyA(util.toPointer(hKey), util.pstrToFfi(lpFile), util.toPointer(lpSecurityAttributes));
}
...
export function RegSaveKeyW(
  ...
  return libADVAPI32.RegSaveKeyW(util.toPointer(hKey), util.pwstrToFfi(lpFile), util.toPointer(lpSecurityAttributes));
}
...
export function RegSetKeySecurity(
  ...
  return libADVAPI32.RegSetKeySecurity(util.toPointer(hKey), SecurityInformation, util.toPointer(pSecurityDescriptor));
}
...
export function RegSetValueA(
  ...
  return libADVAPI32.RegSetValueA(util.toPointer(hKey), util.pstrToFfi(lpSubKey), dwType, util.pstrToFfi(lpData), cbData);
}
...
export function RegSetValueW(
  ...
  return libADVAPI32.RegSetValueW(util.toPointer(hKey), util.pwstrToFfi(lpSubKey), dwType, util.pwstrToFfi(lpData), cbData);
}
...
export function RegSetValueExA(
  ...
  return libADVAPI32.RegSetValueExA(util.toPointer(hKey), util.pstrToFfi(lpValueName), Reserved, dwType, util.toPointer(lpData), cbData);
}
...
export function RegSetValueExW(
  ...
  return libADVAPI32.RegSetValueExW(util.toPointer(hKey), util.pwstrToFfi(lpValueName), Reserved, dwType, util.toPointer(lpData), cbData);
}
...
export function RegUnLoadKeyA(
  ...
  return libADVAPI32.RegUnLoadKeyA(util.toPointer(hKey), util.pstrToFfi(lpSubKey));
}
...
export function RegUnLoadKeyW(
  ...
  return libADVAPI32.RegUnLoadKeyW(util.toPointer(hKey), util.pwstrToFfi(lpSubKey));
}
...
export function RegDeleteKeyValueA(
  ...
  return libADVAPI32.RegDeleteKeyValueA(util.toPointer(hKey), util.pstrToFfi(lpSubKey), util.pstrToFfi(lpValueName));
}
...
export function RegDeleteKeyValueW(
  ...
  return libADVAPI32.RegDeleteKeyValueW(util.toPointer(hKey), util.pwstrToFfi(lpSubKey), util.pwstrToFfi(lpValueName));
}
...
export function RegSetKeyValueA(
  ...
  return libADVAPI32.RegSetKeyValueA(util.toPointer(hKey), util.pstrToFfi(lpSubKey), util.pstrToFfi(lpValueName), dwType, util.toPointer(lpData), cbData);
}
...
export function RegSetKeyValueW(
  ...
  return libADVAPI32.RegSetKeyValueW(util.toPointer(hKey), util.pwstrToFfi(lpSubKey), util.pwstrToFfi(lpValueName), dwType, util.toPointer(lpData), cbData);
}
...
export function RegDeleteTreeA(
  ...
  return libADVAPI32.RegDeleteTreeA(util.toPointer(hKey), util.pstrToFfi(lpSubKey));
}
...
export function RegDeleteTreeW(
  ...
  return libADVAPI32.RegDeleteTreeW(util.toPointer(hKey), util.pwstrToFfi(lpSubKey));
}
...
export function RegCopyTreeA(
  ...
  return libADVAPI32.RegCopyTreeA(util.toPointer(hKeySrc), util.pstrToFfi(lpSubKey), util.toPointer(hKeyDest));
}
...
export function RegGetValueA(
  ...
  return libADVAPI32.RegGetValueA(util.toPointer(hkey), util.pstrToFfi(lpSubKey), util.pstrToFfi(lpValue), dwFlags, util.toPointer(pdwType), util.toPointer(pvData), util.toPointer(pcbData));
}
...
export function RegGetValueW(
  ...
  return libADVAPI32.RegGetValueW(util.toPointer(hkey), util.pwstrToFfi(lpSubKey), util.pwstrToFfi(lpValue), dwFlags, util.toPointer(pdwType), util.toPointer(pvData), util.toPointer(pcbData));
}
...
export function RegCopyTreeW(
  ...
  return libADVAPI32.RegCopyTreeW(util.toPointer(hKeySrc), util.pwstrToFfi(lpSubKey), util.toPointer(hKeyDest));
}
...
export function RegLoadMUIStringA(
  ...
  return libADVAPI32.RegLoadMUIStringA(util.toPointer(hKey), util.pstrToFfi(pszValue), util.pstrToFfi(pszOutBuf), cbOutBuf, util.toPointer(pcbData), Flags, util.pstrToFfi(pszDirectory));
}
...
export function RegLoadMUIStringW(
  ...
  return libADVAPI32.RegLoadMUIStringW(util.toPointer(hKey), util.pwstrToFfi(pszValue), util.pwstrToFfi(pszOutBuf), cbOutBuf, util.toPointer(pcbData), Flags, util.pwstrToFfi(pszDirectory));
}
...
export function RegLoadAppKeyA(
  ...
  return libADVAPI32.RegLoadAppKeyA(util.pstrToFfi(lpFile), util.toPointer(phkResult), samDesired, dwOptions, Reserved);
}
...
export function RegLoadAppKeyW(
  ...
  return libADVAPI32.RegLoadAppKeyW(util.pwstrToFfi(lpFile), util.toPointer(phkResult), samDesired, dwOptions, Reserved);
}
...
export function RegSaveKeyExA(
  ...
  return libADVAPI32.RegSaveKeyExA(util.toPointer(hKey), util.pstrToFfi(lpFile), util.toPointer(lpSecurityAttributes), Flags);
}
...
export function RegSaveKeyExW(
  ...
  return libADVAPI32.RegSaveKeyExW(util.toPointer(hKey), util.pwstrToFfi(lpFile), util.toPointer(lpSecurityAttributes), Flags);
}
...
export function GetRegistryValueWithFallbackW(
  ...
  return libapi_ms_win_core_state_helpers_l1_1_0.GetRegistryValueWithFallbackW(util.toPointer(hkeyPrimary), util.pwstrToFfi(pwszPrimarySubKey), util.toPointer(hkeyFallback), util.pwstrToFfi(pwszFallbackSubKey), util.pwstrToFfi(pwszValue), dwFlags, util.toPointer(pdwType), util.toPointer(pvData), cbDataIn, util.toPointer(pcbDataOut));
}
