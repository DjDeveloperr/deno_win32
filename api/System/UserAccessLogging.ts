...
export function allocUAL_DATA_BLOB(data?: Partial<UAL_DATA_BLOB>): Uint8Array {
  ...
  // 0x04: pad4
  // 0x08: pointer
  if (data?.RoleGuid !== undefined) view.setBigUint64(8, data.RoleGuid === null ? 0n : util.toBigInt(util.toPointer(data.RoleGuid)), true);
  // 0x10: pointer
  if (data?.TenantId !== undefined) view.setBigUint64(16, data.TenantId === null ? 0n : util.toBigInt(util.toPointer(data.TenantId)), true);
  // 0x18: pointer
  if (data?.Address !== undefined) view.setBigUint64(24, data.Address === null ? 0n : util.toBigInt(util.toPointer(data.Address)), true);
  // 0x20: pointer
  if (data?.UserName !== undefined) view.setBigUint64(32, data.UserName === null ? 0n : util.toBigInt(util.toPointer(data.UserName)), true);
  return buf;
}
...
export class UAL_DATA_BLOBView {
  ...
  // 0x08: pointer
  get RoleGuid(): Uint8Array | Deno.PointerValue | null {
    const ptr = this.view.getBigUint64(8, true);
    return util.pointerFromFfi(ptr);
  }

  // 0x10: pointer
  get TenantId(): Uint8Array | Deno.PointerValue | null {
  ...
  // 0x08: pointer
  set RoleGuid(value: Uint8Array | Deno.PointerValue | null) {
    this.view.setBigUint64(8, util.toBigInt(util.toPointer(value)), true);
  }

  // 0x10: pointer
  set TenantId(value: Uint8Array | Deno.PointerValue | null) {
...
export function UalStart(
  ...
  return util.pointerFromFfi(libualapi_dll.UalStart(util.toPointer(Data)));
}

export function UalStop(
  Data: Deno.PointerValue | Uint8Array | null /* ptr */,
): Deno.PointerValue | null /* Windows.Win32.Foundation.HRESULT */ {
  return util.pointerFromFfi(libualapi_dll.UalStop(util.toPointer(Data)));
}

export function UalInstrument(
  Data: Deno.PointerValue | Uint8Array | null /* ptr */,
): Deno.PointerValue | null /* Windows.Win32.Foundation.HRESULT */ {
  return util.pointerFromFfi(libualapi_dll.UalInstrument(util.toPointer(Data)));
}
