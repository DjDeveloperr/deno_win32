...
/**
 * Windows.Win32.System.SideShow.Apis (size: 168)
 */
export interface Apis {
  /** System.Guid */
  SIDESHOW_ENDPOINT_SIMPLE_CONTENT_FORMAT: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  SIDESHOW_ENDPOINT_ICAL: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  SIDESHOW_CAPABILITY_DEVICE_PROPERTIES: Uint8Array | Deno.PointerValue | null;
  /** Windows.Win32.UI.Shell.PropertiesSystem.PROPERTYKEY */
  SIDESHOW_CAPABILITY_DEVICE_ID: Uint8Array | Deno.PointerValue | null;
  /** Windows.Win32.UI.Shell.PropertiesSystem.PROPERTYKEY */
  SIDESHOW_CAPABILITY_SCREEN_TYPE: Uint8Array | Deno.PointerValue | null;
  /** Windows.Win32.UI.Shell.PropertiesSystem.PROPERTYKEY */
  SIDESHOW_CAPABILITY_SCREEN_WIDTH: Uint8Array | Deno.PointerValue | null;
  /** Windows.Win32.UI.Shell.PropertiesSystem.PROPERTYKEY */
  SIDESHOW_CAPABILITY_SCREEN_HEIGHT: Uint8Array | Deno.PointerValue | null;
  /** Windows.Win32.UI.Shell.PropertiesSystem.PROPERTYKEY */
  SIDESHOW_CAPABILITY_COLOR_DEPTH: Uint8Array | Deno.PointerValue | null;
  /** Windows.Win32.UI.Shell.PropertiesSystem.PROPERTYKEY */
  SIDESHOW_CAPABILITY_COLOR_TYPE: Uint8Array | Deno.PointerValue | null;
  /** Windows.Win32.UI.Shell.PropertiesSystem.PROPERTYKEY */
  SIDESHOW_CAPABILITY_DATA_CACHE: Uint8Array | Deno.PointerValue | null;
  /** Windows.Win32.UI.Shell.PropertiesSystem.PROPERTYKEY */
  SIDESHOW_CAPABILITY_SUPPORTED_LANGUAGES: Uint8Array | Deno.PointerValue | null;
  /** Windows.Win32.UI.Shell.PropertiesSystem.PROPERTYKEY */
  SIDESHOW_CAPABILITY_CURRENT_LANGUAGE: Uint8Array | Deno.PointerValue | null;
  /** Windows.Win32.UI.Shell.PropertiesSystem.PROPERTYKEY */
  SIDESHOW_CAPABILITY_SUPPORTED_THEMES: Uint8Array | Deno.PointerValue | null;
  /** Windows.Win32.UI.Shell.PropertiesSystem.PROPERTYKEY */
  SIDESHOW_CAPABILITY_SUPPORTED_IMAGE_FORMATS: Uint8Array | Deno.PointerValue | null;
  /** Windows.Win32.UI.Shell.PropertiesSystem.PROPERTYKEY */
  SIDESHOW_CAPABILITY_CLIENT_AREA_WIDTH: Uint8Array | Deno.PointerValue | null;
  /** Windows.Win32.UI.Shell.PropertiesSystem.PROPERTYKEY */
  SIDESHOW_CAPABILITY_CLIENT_AREA_HEIGHT: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_DEVINTERFACE_SIDESHOW: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  SIDESHOW_CONTENT_MISSING_EVENT: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  SIDESHOW_APPLICATION_EVENT: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  SIDESHOW_USER_CHANGE_REQUEST_EVENT: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  SIDESHOW_NEW_EVENT_DATA_AVAILABLE: Uint8Array | Deno.PointerValue | null;
}
...
export function allocApis(data?: Partial<Apis>): Uint8Array {
  ...
  const view = new DataView(buf.buffer);
  // 0x00: pointer
  if (data?.SIDESHOW_ENDPOINT_SIMPLE_CONTENT_FORMAT !== undefined) view.setBigUint64(0, data.SIDESHOW_ENDPOINT_SIMPLE_CONTENT_FORMAT === null ? 0n : BigInt(util.toPointer(data.SIDESHOW_ENDPOINT_SIMPLE_CONTENT_FORMAT)), true);
  // 0x08: pointer
  if (data?.SIDESHOW_ENDPOINT_ICAL !== undefined) view.setBigUint64(8, data.SIDESHOW_ENDPOINT_ICAL === null ? 0n : BigInt(util.toPointer(data.SIDESHOW_ENDPOINT_ICAL)), true);
  // 0x10: pointer
  if (data?.SIDESHOW_CAPABILITY_DEVICE_PROPERTIES !== undefined) view.setBigUint64(16, data.SIDESHOW_CAPABILITY_DEVICE_PROPERTIES === null ? 0n : BigInt(util.toPointer(data.SIDESHOW_CAPABILITY_DEVICE_PROPERTIES)), true);
  // 0x18: pointer
  if (data?.SIDESHOW_CAPABILITY_DEVICE_ID !== undefined) view.setBigUint64(24, data.SIDESHOW_CAPABILITY_DEVICE_ID === null ? 0n : BigInt(util.toPointer(data.SIDESHOW_CAPABILITY_DEVICE_ID)), true);
  // 0x20: pointer
  if (data?.SIDESHOW_CAPABILITY_SCREEN_TYPE !== undefined) view.setBigUint64(32, data.SIDESHOW_CAPABILITY_SCREEN_TYPE === null ? 0n : BigInt(util.toPointer(data.SIDESHOW_CAPABILITY_SCREEN_TYPE)), true);
  // 0x28: pointer
  if (data?.SIDESHOW_CAPABILITY_SCREEN_WIDTH !== undefined) view.setBigUint64(40, data.SIDESHOW_CAPABILITY_SCREEN_WIDTH === null ? 0n : BigInt(util.toPointer(data.SIDESHOW_CAPABILITY_SCREEN_WIDTH)), true);
  // 0x30: pointer
  if (data?.SIDESHOW_CAPABILITY_SCREEN_HEIGHT !== undefined) view.setBigUint64(48, data.SIDESHOW_CAPABILITY_SCREEN_HEIGHT === null ? 0n : BigInt(util.toPointer(data.SIDESHOW_CAPABILITY_SCREEN_HEIGHT)), true);
  // 0x38: pointer
  if (data?.SIDESHOW_CAPABILITY_COLOR_DEPTH !== undefined) view.setBigUint64(56, data.SIDESHOW_CAPABILITY_COLOR_DEPTH === null ? 0n : BigInt(util.toPointer(data.SIDESHOW_CAPABILITY_COLOR_DEPTH)), true);
  // 0x40: pointer
  if (data?.SIDESHOW_CAPABILITY_COLOR_TYPE !== undefined) view.setBigUint64(64, data.SIDESHOW_CAPABILITY_COLOR_TYPE === null ? 0n : BigInt(util.toPointer(data.SIDESHOW_CAPABILITY_COLOR_TYPE)), true);
  // 0x48: pointer
  if (data?.SIDESHOW_CAPABILITY_DATA_CACHE !== undefined) view.setBigUint64(72, data.SIDESHOW_CAPABILITY_DATA_CACHE === null ? 0n : BigInt(util.toPointer(data.SIDESHOW_CAPABILITY_DATA_CACHE)), true);
  // 0x50: pointer
  if (data?.SIDESHOW_CAPABILITY_SUPPORTED_LANGUAGES !== undefined) view.setBigUint64(80, data.SIDESHOW_CAPABILITY_SUPPORTED_LANGUAGES === null ? 0n : BigInt(util.toPointer(data.SIDESHOW_CAPABILITY_SUPPORTED_LANGUAGES)), true);
  // 0x58: pointer
  if (data?.SIDESHOW_CAPABILITY_CURRENT_LANGUAGE !== undefined) view.setBigUint64(88, data.SIDESHOW_CAPABILITY_CURRENT_LANGUAGE === null ? 0n : BigInt(util.toPointer(data.SIDESHOW_CAPABILITY_CURRENT_LANGUAGE)), true);
  // 0x60: pointer
  if (data?.SIDESHOW_CAPABILITY_SUPPORTED_THEMES !== undefined) view.setBigUint64(96, data.SIDESHOW_CAPABILITY_SUPPORTED_THEMES === null ? 0n : BigInt(util.toPointer(data.SIDESHOW_CAPABILITY_SUPPORTED_THEMES)), true);
  // 0x68: pointer
  if (data?.SIDESHOW_CAPABILITY_SUPPORTED_IMAGE_FORMATS !== undefined) view.setBigUint64(104, data.SIDESHOW_CAPABILITY_SUPPORTED_IMAGE_FORMATS === null ? 0n : BigInt(util.toPointer(data.SIDESHOW_CAPABILITY_SUPPORTED_IMAGE_FORMATS)), true);
  // 0x70: pointer
  if (data?.SIDESHOW_CAPABILITY_CLIENT_AREA_WIDTH !== undefined) view.setBigUint64(112, data.SIDESHOW_CAPABILITY_CLIENT_AREA_WIDTH === null ? 0n : BigInt(util.toPointer(data.SIDESHOW_CAPABILITY_CLIENT_AREA_WIDTH)), true);
  // 0x78: pointer
  if (data?.SIDESHOW_CAPABILITY_CLIENT_AREA_HEIGHT !== undefined) view.setBigUint64(120, data.SIDESHOW_CAPABILITY_CLIENT_AREA_HEIGHT === null ? 0n : BigInt(util.toPointer(data.SIDESHOW_CAPABILITY_CLIENT_AREA_HEIGHT)), true);
  // 0x80: pointer
  if (data?.GUID_DEVINTERFACE_SIDESHOW !== undefined) view.setBigUint64(128, data.GUID_DEVINTERFACE_SIDESHOW === null ? 0n : BigInt(util.toPointer(data.GUID_DEVINTERFACE_SIDESHOW)), true);
  // 0x88: pointer
  if (data?.SIDESHOW_CONTENT_MISSING_EVENT !== undefined) view.setBigUint64(136, data.SIDESHOW_CONTENT_MISSING_EVENT === null ? 0n : BigInt(util.toPointer(data.SIDESHOW_CONTENT_MISSING_EVENT)), true);
  // 0x90: pointer
  if (data?.SIDESHOW_APPLICATION_EVENT !== undefined) view.setBigUint64(144, data.SIDESHOW_APPLICATION_EVENT === null ? 0n : BigInt(util.toPointer(data.SIDESHOW_APPLICATION_EVENT)), true);
  // 0x98: pointer
  if (data?.SIDESHOW_USER_CHANGE_REQUEST_EVENT !== undefined) view.setBigUint64(152, data.SIDESHOW_USER_CHANGE_REQUEST_EVENT === null ? 0n : BigInt(util.toPointer(data.SIDESHOW_USER_CHANGE_REQUEST_EVENT)), true);
  // 0xa0: pointer
  if (data?.SIDESHOW_NEW_EVENT_DATA_AVAILABLE !== undefined) view.setBigUint64(160, data.SIDESHOW_NEW_EVENT_DATA_AVAILABLE === null ? 0n : BigInt(util.toPointer(data.SIDESHOW_NEW_EVENT_DATA_AVAILABLE)), true);
  return buf;
}
