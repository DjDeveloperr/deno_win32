...
/**
 * Windows.Win32.System.Ole.Apis (size: 240)
 */
export interface Apis {
  /** System.Guid */
  CLSID_CFontPropPage: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  CLSID_CColorPropPage: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  CLSID_CPicturePropPage: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  CLSID_PersistPropset: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  CLSID_ConvertVBX: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  CLSID_StdFont: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  CLSID_StdPicture: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_HIMETRIC: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_COLOR: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_XPOSPIXEL: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_YPOSPIXEL: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_XSIZEPIXEL: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_YSIZEPIXEL: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_XPOS: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_YPOS: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_XSIZE: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_YSIZE: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_TRISTATE: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_OPTIONVALUEEXCLUSIVE: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_CHECKVALUEEXCLUSIVE: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_FONTNAME: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_FONTSIZE: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_FONTBOLD: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_FONTITALIC: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_FONTUNDERSCORE: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_FONTSTRIKETHROUGH: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_HANDLE: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  SID_VariantConversion: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  SID_GetCaller: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  SID_ProvideRuntimeContext: Uint8Array | Deno.PointerValue | null;
}

export const sizeofApis = 240;

export function allocApis(data?: Partial<Apis>): Uint8Array {
  const buf = new Uint8Array(sizeofApis);
  const view = new DataView(buf.buffer);
  // 0x00: pointer
  if (data?.CLSID_CFontPropPage !== undefined) view.setBigUint64(0, data.CLSID_CFontPropPage === null ? 0n : BigInt(util.toPointer(data.CLSID_CFontPropPage)), true);
  // 0x08: pointer
  if (data?.CLSID_CColorPropPage !== undefined) view.setBigUint64(8, data.CLSID_CColorPropPage === null ? 0n : BigInt(util.toPointer(data.CLSID_CColorPropPage)), true);
  // 0x10: pointer
  if (data?.CLSID_CPicturePropPage !== undefined) view.setBigUint64(16, data.CLSID_CPicturePropPage === null ? 0n : BigInt(util.toPointer(data.CLSID_CPicturePropPage)), true);
  // 0x18: pointer
  if (data?.CLSID_PersistPropset !== undefined) view.setBigUint64(24, data.CLSID_PersistPropset === null ? 0n : BigInt(util.toPointer(data.CLSID_PersistPropset)), true);
  // 0x20: pointer
  if (data?.CLSID_ConvertVBX !== undefined) view.setBigUint64(32, data.CLSID_ConvertVBX === null ? 0n : BigInt(util.toPointer(data.CLSID_ConvertVBX)), true);
  // 0x28: pointer
  if (data?.CLSID_StdFont !== undefined) view.setBigUint64(40, data.CLSID_StdFont === null ? 0n : BigInt(util.toPointer(data.CLSID_StdFont)), true);
  // 0x30: pointer
  if (data?.CLSID_StdPicture !== undefined) view.setBigUint64(48, data.CLSID_StdPicture === null ? 0n : BigInt(util.toPointer(data.CLSID_StdPicture)), true);
  // 0x38: pointer
  if (data?.GUID_HIMETRIC !== undefined) view.setBigUint64(56, data.GUID_HIMETRIC === null ? 0n : BigInt(util.toPointer(data.GUID_HIMETRIC)), true);
  // 0x40: pointer
  if (data?.GUID_COLOR !== undefined) view.setBigUint64(64, data.GUID_COLOR === null ? 0n : BigInt(util.toPointer(data.GUID_COLOR)), true);
  // 0x48: pointer
  if (data?.GUID_XPOSPIXEL !== undefined) view.setBigUint64(72, data.GUID_XPOSPIXEL === null ? 0n : BigInt(util.toPointer(data.GUID_XPOSPIXEL)), true);
  // 0x50: pointer
  if (data?.GUID_YPOSPIXEL !== undefined) view.setBigUint64(80, data.GUID_YPOSPIXEL === null ? 0n : BigInt(util.toPointer(data.GUID_YPOSPIXEL)), true);
  // 0x58: pointer
  if (data?.GUID_XSIZEPIXEL !== undefined) view.setBigUint64(88, data.GUID_XSIZEPIXEL === null ? 0n : BigInt(util.toPointer(data.GUID_XSIZEPIXEL)), true);
  // 0x60: pointer
  if (data?.GUID_YSIZEPIXEL !== undefined) view.setBigUint64(96, data.GUID_YSIZEPIXEL === null ? 0n : BigInt(util.toPointer(data.GUID_YSIZEPIXEL)), true);
  // 0x68: pointer
  if (data?.GUID_XPOS !== undefined) view.setBigUint64(104, data.GUID_XPOS === null ? 0n : BigInt(util.toPointer(data.GUID_XPOS)), true);
  // 0x70: pointer
  if (data?.GUID_YPOS !== undefined) view.setBigUint64(112, data.GUID_YPOS === null ? 0n : BigInt(util.toPointer(data.GUID_YPOS)), true);
  // 0x78: pointer
  if (data?.GUID_XSIZE !== undefined) view.setBigUint64(120, data.GUID_XSIZE === null ? 0n : BigInt(util.toPointer(data.GUID_XSIZE)), true);
  // 0x80: pointer
  if (data?.GUID_YSIZE !== undefined) view.setBigUint64(128, data.GUID_YSIZE === null ? 0n : BigInt(util.toPointer(data.GUID_YSIZE)), true);
  // 0x88: pointer
  if (data?.GUID_TRISTATE !== undefined) view.setBigUint64(136, data.GUID_TRISTATE === null ? 0n : BigInt(util.toPointer(data.GUID_TRISTATE)), true);
  // 0x90: pointer
  if (data?.GUID_OPTIONVALUEEXCLUSIVE !== undefined) view.setBigUint64(144, data.GUID_OPTIONVALUEEXCLUSIVE === null ? 0n : BigInt(util.toPointer(data.GUID_OPTIONVALUEEXCLUSIVE)), true);
  // 0x98: pointer
  if (data?.GUID_CHECKVALUEEXCLUSIVE !== undefined) view.setBigUint64(152, data.GUID_CHECKVALUEEXCLUSIVE === null ? 0n : BigInt(util.toPointer(data.GUID_CHECKVALUEEXCLUSIVE)), true);
  // 0xa0: pointer
  if (data?.GUID_FONTNAME !== undefined) view.setBigUint64(160, data.GUID_FONTNAME === null ? 0n : BigInt(util.toPointer(data.GUID_FONTNAME)), true);
  // 0xa8: pointer
  if (data?.GUID_FONTSIZE !== undefined) view.setBigUint64(168, data.GUID_FONTSIZE === null ? 0n : BigInt(util.toPointer(data.GUID_FONTSIZE)), true);
  // 0xb0: pointer
  if (data?.GUID_FONTBOLD !== undefined) view.setBigUint64(176, data.GUID_FONTBOLD === null ? 0n : BigInt(util.toPointer(data.GUID_FONTBOLD)), true);
  // 0xb8: pointer
  if (data?.GUID_FONTITALIC !== undefined) view.setBigUint64(184, data.GUID_FONTITALIC === null ? 0n : BigInt(util.toPointer(data.GUID_FONTITALIC)), true);
  // 0xc0: pointer
  if (data?.GUID_FONTUNDERSCORE !== undefined) view.setBigUint64(192, data.GUID_FONTUNDERSCORE === null ? 0n : BigInt(util.toPointer(data.GUID_FONTUNDERSCORE)), true);
  // 0xc8: pointer
  if (data?.GUID_FONTSTRIKETHROUGH !== undefined) view.setBigUint64(200, data.GUID_FONTSTRIKETHROUGH === null ? 0n : BigInt(util.toPointer(data.GUID_FONTSTRIKETHROUGH)), true);
  // 0xd0: pointer
  if (data?.GUID_HANDLE !== undefined) view.setBigUint64(208, data.GUID_HANDLE === null ? 0n : BigInt(util.toPointer(data.GUID_HANDLE)), true);
  // 0xd8: pointer
  if (data?.SID_VariantConversion !== undefined) view.setBigUint64(216, data.SID_VariantConversion === null ? 0n : BigInt(util.toPointer(data.SID_VariantConversion)), true);
  // 0xe0: pointer
  if (data?.SID_GetCaller !== undefined) view.setBigUint64(224, data.SID_GetCaller === null ? 0n : BigInt(util.toPointer(data.SID_GetCaller)), true);
  // 0xe8: pointer
  if (data?.SID_ProvideRuntimeContext !== undefined) view.setBigUint64(232, data.SID_ProvideRuntimeContext === null ? 0n : BigInt(util.toPointer(data.SID_ProvideRuntimeContext)), true);
  return buf;
}
