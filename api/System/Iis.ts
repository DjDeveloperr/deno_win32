...
/**
 * Windows.Win32.System.Iis.Apis (size: 152)
 */
export interface Apis {
  /** System.Guid */
  CLSID_MSAdminBase_W: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  CLSID_IImgCtx: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  CLSID_IisServiceControl: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  LIBID_IISRSTALib: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  LIBID_WAMREGLib: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  CLSID_WamAdmin: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  LIBID_ASPTypeLibrary: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  CLSID_Request: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  CLSID_Response: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  CLSID_Session: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  CLSID_Server: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  CLSID_ScriptingContext: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_IIS_ALL_TRACE_PROVIDERS: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_IIS_WWW_SERVER_TRACE_PROVIDER: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_IIS_WWW_SERVER_V2_TRACE_PROVIDER: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_IIS_ASPNET_TRACE_PROVIDER: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_IIS_ASP_TRACE_TRACE_PROVIDER: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_IIS_WWW_GLOBAL_TRACE_PROVIDER: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_IIS_ISAPI_TRACE_PROVIDER: Uint8Array | Deno.PointerValue | null;
}
...
export function allocApis(data?: Partial<Apis>): Uint8Array {
  ...
  // 0x00: pointer
  if (data?.CLSID_MSAdminBase_W !== undefined) view.setBigUint64(0, data.CLSID_MSAdminBase_W === null ? 0n : BigInt(util.toPointer(data.CLSID_MSAdminBase_W)), true);
  // 0x08: pointer
  if (data?.CLSID_IImgCtx !== undefined) view.setBigUint64(8, data.CLSID_IImgCtx === null ? 0n : BigInt(util.toPointer(data.CLSID_IImgCtx)), true);
  // 0x10: pointer
  if (data?.CLSID_IisServiceControl !== undefined) view.setBigUint64(16, data.CLSID_IisServiceControl === null ? 0n : BigInt(util.toPointer(data.CLSID_IisServiceControl)), true);
  // 0x18: pointer
  if (data?.LIBID_IISRSTALib !== undefined) view.setBigUint64(24, data.LIBID_IISRSTALib === null ? 0n : BigInt(util.toPointer(data.LIBID_IISRSTALib)), true);
  // 0x20: pointer
  if (data?.LIBID_WAMREGLib !== undefined) view.setBigUint64(32, data.LIBID_WAMREGLib === null ? 0n : BigInt(util.toPointer(data.LIBID_WAMREGLib)), true);
  // 0x28: pointer
  if (data?.CLSID_WamAdmin !== undefined) view.setBigUint64(40, data.CLSID_WamAdmin === null ? 0n : BigInt(util.toPointer(data.CLSID_WamAdmin)), true);
  // 0x30: pointer
  if (data?.LIBID_ASPTypeLibrary !== undefined) view.setBigUint64(48, data.LIBID_ASPTypeLibrary === null ? 0n : BigInt(util.toPointer(data.LIBID_ASPTypeLibrary)), true);
  // 0x38: pointer
  if (data?.CLSID_Request !== undefined) view.setBigUint64(56, data.CLSID_Request === null ? 0n : BigInt(util.toPointer(data.CLSID_Request)), true);
  // 0x40: pointer
  if (data?.CLSID_Response !== undefined) view.setBigUint64(64, data.CLSID_Response === null ? 0n : BigInt(util.toPointer(data.CLSID_Response)), true);
  // 0x48: pointer
  if (data?.CLSID_Session !== undefined) view.setBigUint64(72, data.CLSID_Session === null ? 0n : BigInt(util.toPointer(data.CLSID_Session)), true);
  // 0x50: pointer
  if (data?.CLSID_Server !== undefined) view.setBigUint64(80, data.CLSID_Server === null ? 0n : BigInt(util.toPointer(data.CLSID_Server)), true);
  // 0x58: pointer
  if (data?.CLSID_ScriptingContext !== undefined) view.setBigUint64(88, data.CLSID_ScriptingContext === null ? 0n : BigInt(util.toPointer(data.CLSID_ScriptingContext)), true);
  // 0x60: pointer
  if (data?.GUID_IIS_ALL_TRACE_PROVIDERS !== undefined) view.setBigUint64(96, data.GUID_IIS_ALL_TRACE_PROVIDERS === null ? 0n : BigInt(util.toPointer(data.GUID_IIS_ALL_TRACE_PROVIDERS)), true);
  // 0x68: pointer
  if (data?.GUID_IIS_WWW_SERVER_TRACE_PROVIDER !== undefined) view.setBigUint64(104, data.GUID_IIS_WWW_SERVER_TRACE_PROVIDER === null ? 0n : BigInt(util.toPointer(data.GUID_IIS_WWW_SERVER_TRACE_PROVIDER)), true);
  // 0x70: pointer
  if (data?.GUID_IIS_WWW_SERVER_V2_TRACE_PROVIDER !== undefined) view.setBigUint64(112, data.GUID_IIS_WWW_SERVER_V2_TRACE_PROVIDER === null ? 0n : BigInt(util.toPointer(data.GUID_IIS_WWW_SERVER_V2_TRACE_PROVIDER)), true);
  // 0x78: pointer
  if (data?.GUID_IIS_ASPNET_TRACE_PROVIDER !== undefined) view.setBigUint64(120, data.GUID_IIS_ASPNET_TRACE_PROVIDER === null ? 0n : BigInt(util.toPointer(data.GUID_IIS_ASPNET_TRACE_PROVIDER)), true);
  // 0x80: pointer
  if (data?.GUID_IIS_ASP_TRACE_TRACE_PROVIDER !== undefined) view.setBigUint64(128, data.GUID_IIS_ASP_TRACE_TRACE_PROVIDER === null ? 0n : BigInt(util.toPointer(data.GUID_IIS_ASP_TRACE_TRACE_PROVIDER)), true);
  // 0x88: pointer
  if (data?.GUID_IIS_WWW_GLOBAL_TRACE_PROVIDER !== undefined) view.setBigUint64(136, data.GUID_IIS_WWW_GLOBAL_TRACE_PROVIDER === null ? 0n : BigInt(util.toPointer(data.GUID_IIS_WWW_GLOBAL_TRACE_PROVIDER)), true);
  // 0x90: pointer
  if (data?.GUID_IIS_ISAPI_TRACE_PROVIDER !== undefined) view.setBigUint64(144, data.GUID_IIS_ISAPI_TRACE_PROVIDER === null ? 0n : BigInt(util.toPointer(data.GUID_IIS_ISAPI_TRACE_PROVIDER)), true);
  return buf;
}
