...
/**
 * Windows.Win32.System.Power.Apis (size: 184)
 */
export interface Apis {
  /** Windows.Win32.UI.Shell.PropertiesSystem.PROPERTYKEY */
  PROCESSOR_NUMBER_PKEY: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_DEVICE_BATTERY: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_DEVICE_APPLICATIONLAUNCH_BUTTON: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_DEVICE_SYS_BUTTON: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_DEVICE_LID: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_DEVICE_THERMAL_ZONE: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_DEVICE_FAN: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_DEVICE_PROCESSOR: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_DEVICE_MEMORY: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_DEVICE_ACPI_TIME: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_DEVICE_MESSAGE_INDICATOR: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_CLASS_INPUT: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_DEVINTERFACE_THERMAL_COOLING: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_DEVINTERFACE_THERMAL_MANAGER: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  BATTERY_STATUS_WMI_GUID: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  BATTERY_RUNTIME_WMI_GUID: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  BATTERY_TEMPERATURE_WMI_GUID: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  BATTERY_FULL_CHARGED_CAPACITY_WMI_GUID: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  BATTERY_CYCLE_COUNT_WMI_GUID: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  BATTERY_STATIC_DATA_WMI_GUID: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  BATTERY_STATUS_CHANGE_WMI_GUID: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  BATTERY_TAG_CHANGE_WMI_GUID: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_DEVICE_ENERGY_METER: Uint8Array | Deno.PointerValue | null;
}
...
export function allocApis(data?: Partial<Apis>): Uint8Array {
  ...
  const view = new DataView(buf.buffer);
  // 0x00: pointer
  if (data?.PROCESSOR_NUMBER_PKEY !== undefined) view.setBigUint64(0, data.PROCESSOR_NUMBER_PKEY === null ? 0n : BigInt(util.toPointer(data.PROCESSOR_NUMBER_PKEY)), true);
  // 0x08: pointer
  if (data?.GUID_DEVICE_BATTERY !== undefined) view.setBigUint64(8, data.GUID_DEVICE_BATTERY === null ? 0n : BigInt(util.toPointer(data.GUID_DEVICE_BATTERY)), true);
  // 0x10: pointer
  if (data?.GUID_DEVICE_APPLICATIONLAUNCH_BUTTON !== undefined) view.setBigUint64(16, data.GUID_DEVICE_APPLICATIONLAUNCH_BUTTON === null ? 0n : BigInt(util.toPointer(data.GUID_DEVICE_APPLICATIONLAUNCH_BUTTON)), true);
  // 0x18: pointer
  if (data?.GUID_DEVICE_SYS_BUTTON !== undefined) view.setBigUint64(24, data.GUID_DEVICE_SYS_BUTTON === null ? 0n : BigInt(util.toPointer(data.GUID_DEVICE_SYS_BUTTON)), true);
  // 0x20: pointer
  if (data?.GUID_DEVICE_LID !== undefined) view.setBigUint64(32, data.GUID_DEVICE_LID === null ? 0n : BigInt(util.toPointer(data.GUID_DEVICE_LID)), true);
  // 0x28: pointer
  if (data?.GUID_DEVICE_THERMAL_ZONE !== undefined) view.setBigUint64(40, data.GUID_DEVICE_THERMAL_ZONE === null ? 0n : BigInt(util.toPointer(data.GUID_DEVICE_THERMAL_ZONE)), true);
  // 0x30: pointer
  if (data?.GUID_DEVICE_FAN !== undefined) view.setBigUint64(48, data.GUID_DEVICE_FAN === null ? 0n : BigInt(util.toPointer(data.GUID_DEVICE_FAN)), true);
  // 0x38: pointer
  if (data?.GUID_DEVICE_PROCESSOR !== undefined) view.setBigUint64(56, data.GUID_DEVICE_PROCESSOR === null ? 0n : BigInt(util.toPointer(data.GUID_DEVICE_PROCESSOR)), true);
  // 0x40: pointer
  if (data?.GUID_DEVICE_MEMORY !== undefined) view.setBigUint64(64, data.GUID_DEVICE_MEMORY === null ? 0n : BigInt(util.toPointer(data.GUID_DEVICE_MEMORY)), true);
  // 0x48: pointer
  if (data?.GUID_DEVICE_ACPI_TIME !== undefined) view.setBigUint64(72, data.GUID_DEVICE_ACPI_TIME === null ? 0n : BigInt(util.toPointer(data.GUID_DEVICE_ACPI_TIME)), true);
  // 0x50: pointer
  if (data?.GUID_DEVICE_MESSAGE_INDICATOR !== undefined) view.setBigUint64(80, data.GUID_DEVICE_MESSAGE_INDICATOR === null ? 0n : BigInt(util.toPointer(data.GUID_DEVICE_MESSAGE_INDICATOR)), true);
  // 0x58: pointer
  if (data?.GUID_CLASS_INPUT !== undefined) view.setBigUint64(88, data.GUID_CLASS_INPUT === null ? 0n : BigInt(util.toPointer(data.GUID_CLASS_INPUT)), true);
  // 0x60: pointer
  if (data?.GUID_DEVINTERFACE_THERMAL_COOLING !== undefined) view.setBigUint64(96, data.GUID_DEVINTERFACE_THERMAL_COOLING === null ? 0n : BigInt(util.toPointer(data.GUID_DEVINTERFACE_THERMAL_COOLING)), true);
  // 0x68: pointer
  if (data?.GUID_DEVINTERFACE_THERMAL_MANAGER !== undefined) view.setBigUint64(104, data.GUID_DEVINTERFACE_THERMAL_MANAGER === null ? 0n : BigInt(util.toPointer(data.GUID_DEVINTERFACE_THERMAL_MANAGER)), true);
  // 0x70: pointer
  if (data?.BATTERY_STATUS_WMI_GUID !== undefined) view.setBigUint64(112, data.BATTERY_STATUS_WMI_GUID === null ? 0n : BigInt(util.toPointer(data.BATTERY_STATUS_WMI_GUID)), true);
  // 0x78: pointer
  if (data?.BATTERY_RUNTIME_WMI_GUID !== undefined) view.setBigUint64(120, data.BATTERY_RUNTIME_WMI_GUID === null ? 0n : BigInt(util.toPointer(data.BATTERY_RUNTIME_WMI_GUID)), true);
  // 0x80: pointer
  if (data?.BATTERY_TEMPERATURE_WMI_GUID !== undefined) view.setBigUint64(128, data.BATTERY_TEMPERATURE_WMI_GUID === null ? 0n : BigInt(util.toPointer(data.BATTERY_TEMPERATURE_WMI_GUID)), true);
  // 0x88: pointer
  if (data?.BATTERY_FULL_CHARGED_CAPACITY_WMI_GUID !== undefined) view.setBigUint64(136, data.BATTERY_FULL_CHARGED_CAPACITY_WMI_GUID === null ? 0n : BigInt(util.toPointer(data.BATTERY_FULL_CHARGED_CAPACITY_WMI_GUID)), true);
  // 0x90: pointer
  if (data?.BATTERY_CYCLE_COUNT_WMI_GUID !== undefined) view.setBigUint64(144, data.BATTERY_CYCLE_COUNT_WMI_GUID === null ? 0n : BigInt(util.toPointer(data.BATTERY_CYCLE_COUNT_WMI_GUID)), true);
  // 0x98: pointer
  if (data?.BATTERY_STATIC_DATA_WMI_GUID !== undefined) view.setBigUint64(152, data.BATTERY_STATIC_DATA_WMI_GUID === null ? 0n : BigInt(util.toPointer(data.BATTERY_STATIC_DATA_WMI_GUID)), true);
  // 0xa0: pointer
  if (data?.BATTERY_STATUS_CHANGE_WMI_GUID !== undefined) view.setBigUint64(160, data.BATTERY_STATUS_CHANGE_WMI_GUID === null ? 0n : BigInt(util.toPointer(data.BATTERY_STATUS_CHANGE_WMI_GUID)), true);
  // 0xa8: pointer
  if (data?.BATTERY_TAG_CHANGE_WMI_GUID !== undefined) view.setBigUint64(168, data.BATTERY_TAG_CHANGE_WMI_GUID === null ? 0n : BigInt(util.toPointer(data.BATTERY_TAG_CHANGE_WMI_GUID)), true);
  // 0xb0: pointer
  if (data?.GUID_DEVICE_ENERGY_METER !== undefined) view.setBigUint64(176, data.GUID_DEVICE_ENERGY_METER === null ? 0n : BigInt(util.toPointer(data.GUID_DEVICE_ENERGY_METER)), true);
  return buf;
}
