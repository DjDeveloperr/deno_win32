...
/**
 * Windows.Win32.Graphics.Printing.Apis (size: 120)
 */
export interface Apis {
  /** System.Guid */
  CLSID_OEMRENDER: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  CLSID_OEMUI: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  CLSID_OEMUIMXDC: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  CLSID_OEMPTPROVIDER: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  CLSID_PTPROVIDER: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  PRINTER_EXTENSION_DETAILEDREASON_PRINTER_STATUS: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  PRINTER_EXTENSION_REASON_PRINT_PREFERENCES: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  PRINTER_EXTENSION_REASON_DRIVER_EVENT: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  FMTID_PrinterPropertyBag: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  NOTIFICATION_RELEASE: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  PRINT_APP_BIDI_NOTIFY_CHANNEL: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  PRINT_PORT_MONITOR_NOTIFY_CHANNEL: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_DEVINTERFACE_USBPRINT: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  GUID_DEVINTERFACE_IPPUSB_PRINT: Uint8Array | Deno.PointerValue | null;
  /** System.Guid */
  CLSID_XPSRASTERIZER_FACTORY: Uint8Array | Deno.PointerValue | null;
}

export const sizeofApis = 120;

export function allocApis(data?: Partial<Apis>): Uint8Array {
  const buf = new Uint8Array(sizeofApis);
  const view = new DataView(buf.buffer);
  // 0x00: pointer
  if (data?.CLSID_OEMRENDER !== undefined) view.setBigUint64(0, data.CLSID_OEMRENDER === null ? 0n : BigInt(util.toPointer(data.CLSID_OEMRENDER)), true);
  // 0x08: pointer
  if (data?.CLSID_OEMUI !== undefined) view.setBigUint64(8, data.CLSID_OEMUI === null ? 0n : BigInt(util.toPointer(data.CLSID_OEMUI)), true);
  // 0x10: pointer
  if (data?.CLSID_OEMUIMXDC !== undefined) view.setBigUint64(16, data.CLSID_OEMUIMXDC === null ? 0n : BigInt(util.toPointer(data.CLSID_OEMUIMXDC)), true);
  // 0x18: pointer
  if (data?.CLSID_OEMPTPROVIDER !== undefined) view.setBigUint64(24, data.CLSID_OEMPTPROVIDER === null ? 0n : BigInt(util.toPointer(data.CLSID_OEMPTPROVIDER)), true);
  // 0x20: pointer
  if (data?.CLSID_PTPROVIDER !== undefined) view.setBigUint64(32, data.CLSID_PTPROVIDER === null ? 0n : BigInt(util.toPointer(data.CLSID_PTPROVIDER)), true);
  // 0x28: pointer
  if (data?.PRINTER_EXTENSION_DETAILEDREASON_PRINTER_STATUS !== undefined) view.setBigUint64(40, data.PRINTER_EXTENSION_DETAILEDREASON_PRINTER_STATUS === null ? 0n : BigInt(util.toPointer(data.PRINTER_EXTENSION_DETAILEDREASON_PRINTER_STATUS)), true);
  // 0x30: pointer
  if (data?.PRINTER_EXTENSION_REASON_PRINT_PREFERENCES !== undefined) view.setBigUint64(48, data.PRINTER_EXTENSION_REASON_PRINT_PREFERENCES === null ? 0n : BigInt(util.toPointer(data.PRINTER_EXTENSION_REASON_PRINT_PREFERENCES)), true);
  // 0x38: pointer
  if (data?.PRINTER_EXTENSION_REASON_DRIVER_EVENT !== undefined) view.setBigUint64(56, data.PRINTER_EXTENSION_REASON_DRIVER_EVENT === null ? 0n : BigInt(util.toPointer(data.PRINTER_EXTENSION_REASON_DRIVER_EVENT)), true);
  // 0x40: pointer
  if (data?.FMTID_PrinterPropertyBag !== undefined) view.setBigUint64(64, data.FMTID_PrinterPropertyBag === null ? 0n : BigInt(util.toPointer(data.FMTID_PrinterPropertyBag)), true);
  // 0x48: pointer
  if (data?.NOTIFICATION_RELEASE !== undefined) view.setBigUint64(72, data.NOTIFICATION_RELEASE === null ? 0n : BigInt(util.toPointer(data.NOTIFICATION_RELEASE)), true);
  // 0x50: pointer
  if (data?.PRINT_APP_BIDI_NOTIFY_CHANNEL !== undefined) view.setBigUint64(80, data.PRINT_APP_BIDI_NOTIFY_CHANNEL === null ? 0n : BigInt(util.toPointer(data.PRINT_APP_BIDI_NOTIFY_CHANNEL)), true);
  // 0x58: pointer
  if (data?.PRINT_PORT_MONITOR_NOTIFY_CHANNEL !== undefined) view.setBigUint64(88, data.PRINT_PORT_MONITOR_NOTIFY_CHANNEL === null ? 0n : BigInt(util.toPointer(data.PRINT_PORT_MONITOR_NOTIFY_CHANNEL)), true);
  // 0x60: pointer
  if (data?.GUID_DEVINTERFACE_USBPRINT !== undefined) view.setBigUint64(96, data.GUID_DEVINTERFACE_USBPRINT === null ? 0n : BigInt(util.toPointer(data.GUID_DEVINTERFACE_USBPRINT)), true);
  // 0x68: pointer
  if (data?.GUID_DEVINTERFACE_IPPUSB_PRINT !== undefined) view.setBigUint64(104, data.GUID_DEVINTERFACE_IPPUSB_PRINT === null ? 0n : BigInt(util.toPointer(data.GUID_DEVINTERFACE_IPPUSB_PRINT)), true);
  // 0x70: pointer
  if (data?.CLSID_XPSRASTERIZER_FACTORY !== undefined) view.setBigUint64(112, data.CLSID_XPSRASTERIZER_FACTORY === null ? 0n : BigInt(util.toPointer(data.CLSID_XPSRASTERIZER_FACTORY)), true);
  return buf;
}
